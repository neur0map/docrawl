...
fn main() {
    ...
    // Test current html2md implementation
    println!("Testing current html2md implementation...\n");
    ...
    for (name, html) in TEST_HTML_SAMPLES {
        ...
        let output_file = output_dir.join(format!("{}_html2md.md", name));
        fs::write(&output_file, result).ok();
