...
* [Nmap 3.999 [2006-1-26]](https://nmap.org/changelog.html#3.999)
...
* [[GH#2954]](https://issues.nmap.org/2954)Fix 2 potential crashes in parsing IPv6 extension headers
...
* We ceased creating the Nmap win32 binary zipfile. It was useful back when
  ...
  ([https://nmap.org/oem](https://nmap.org/oem)) for companies building Nmap into their own
...
* [NSE][[GH#2237]](https://issues.nmap.org/2237)Prevent the ssl-\* NSE scripts from probing ports that were
...
* [NSE][[GH#2192]](https://issues.nmap.org/2192)XML decoding in library citrixxml no longer crashes when
...
* [NSE][[GH#1665]](https://issues.nmap.org/1665)The HTTP library no longer crashes when code requests digest
...
* [[GH#1371]](https://issues.nmap.org/1371)The macOS installer is now built for x86\_64 architecture, not i386.
...
* [NSE]Completely removed the bit.lua NSE library. All of its functions are
  ...
  Miller]
* [NSE][[GH#1571]](https://nmap.org/changelog.html#1571)The HTTP library is now enforcing a size limit on the
...
* [Ncat][[GH#1214]](https://issues.nmap.org/1214)[[GH#1230]](https://issues.nmap.org/1230)[[GH#1439]](https://issues.nmap.org/1439)New ncat option provides control over
...
* [NSE]Added 9 NSE scripts, from 8 authors, bringing the total up to 588!
  They are all listed at [https://nmap.org/nsedoc/](https://nmap.org/nsedoc/), and the summaries are
  below:
  * [deluge-rpc-brute](https://nmap.org/nsedoc/scripts/deluge-rpc-brute.html) performs brute-force credential testing against Deluge
...
* [NSE]Added 14 NSE scripts from 12 authors, bringing the total up to 566!
  ...
  * [[GH#876]](https://issues.nmap.org/876)[http-vuln-cve2017-5689](https://nmap.org/nsedoc/scripts/http-vuln-cve2017-5689.html) detects a privilege escalation
    vulnerability (INTEL-SA-00075) in Intel Active Management Technology (AMT)
    capable systems. [Andrew Orr]
  * [http-vuln-cve2017-1001000](https://nmap.org/nsedoc/scripts/http-vuln-cve2017-1001000.html) detects a privilege escalation vulnerability in
    Wordpress 4.7.0 and 4.7.1 (CVE-2017-1001000) [Vinamra Bhatia]
  * [[GH#713]](https://issues.nmap.org/713)[impress-remote-discover](https://nmap.org/nsedoc/scripts/impress-remote-discover.html) attempts to pair with the LibreOffice
  ...
  * [[GH#854]](https://issues.nmap.org/854)[smb-double-pulsar-backdoor](https://nmap.org/nsedoc/scripts/smb-double-pulsar-backdoor.html) detects the Shadow Brokers-leaked
    Double Pulsar backdoor in Windows SMB servers. [Andrew Orr]
  * [smb-vuln-cve-2017-7494](https://nmap.org/nsedoc/scripts/smb-vuln-cve-2017-7494.html) detects a remote code execution vulnerability
    affecting Samba versions 3.5.0 and greater with writable shares.
    [Wong Wai Tuck]
  * [smb-vuln-ms17-010](https://nmap.org/nsedoc/scripts/smb-vuln-ms17-010.html) detects a critical remote code execution vulnerability
    affecting SMBv1 servers in Microsoft Windows systems (ms17-010). The
    script also reports patched systems. [Paulino Calderon]
  * [[GH#686]](https://issues.nmap.org/686)[tls-ticketbleed](https://nmap.org/nsedoc/scripts/tls-ticketbleed.html) checks for the Ticketbleed vulnerability
    (CVE-2016-9244) in F5 BIG-IP appliances. [Mak Kolybabi]
  * [vmware-version](https://nmap.org/nsedoc/scripts/vmware-version.html) queries VMWare SOAP API for version and product information.
...
* [Ncat]A series of changes and fixes based on feedback from the Red Hat community:
  * [[GH#157]](https://issues.nmap.org/157)Ncat will now continue trying to connect to each resolved address
  ...
  * [[GH#773]](https://issues.nmap.org/773)Ncat in server mode properly handles TLS renegotiations and other
    situations where SSL\_read returns a non-fatal error. This was causing
...
* [NSE]New fingerprints for [http-enum](https://nmap.org/nsedoc/scripts/http-enum.html):
  ...
  * [[GH#620]](https://issues.nmap.org/620)[[GH#715]](https://issues.nmap.org/715)8 fingerprints for Hadoop infrastructure components
    [Thomas Debize, Varunram Ganesh]

* [NSE][[GH#266]](https://issues.nmap.org/266)[[GH#704]](https://issues.nmap.org/704)[[GH#238]](https://issues.nmap.org/238)[[GH#883]](https://issues.nmap.org/883)NSE libraries smb and msrpc now use
  fully qualified paths. SMB scripts now work against all modern versions
  of Microsoft Windows. [Paulino Calderon]
* [NSE][smb](https://nmap.org/nsedoc/lib/smb.html) library's share\_get\_list now properly uses anonymous connections
...
* Extended Memcached service probe and added match for Apache ZooKeeper.
  [Paulino Calderon]
* [NSE]New script argument "vulns.short" will reduce [vulns](https://nmap.org/nsedoc/lib/vulns.html) library script
...
* [NSE][[GH#862]](https://issues.nmap.org/862)SNMP scripts will now take a community string provided like
...
* [NSE]Resolved several issues in the default HTTP redirect rules:
  * [[GH#826]](https://issues.nmap.org/826)A redirect is now cancelled if the original URL contains
    embedded credentials
  * [[GH#829]](https://issues.nmap.org/829)A redirect test is now more careful in determining whether
    a redirect destination is related to the original host
  * [[GH#830]](https://issues.nmap.org/830)A redirect is now more strict in avoiding possible redirect
    loops

  [nnposter]
* [NSE][[GH#766]](https://issues.nmap.org/766)The HTTP Host header will now include the port unless it is
...
* [NSE]The HTTP response object has a new member, fragment, which contains
  ...
  complete. [nnposter]
* [NSE][[GH#866]](https://issues.nmap.org/866)NSE now allows cookies to have arbitrary attributes, which
...
* [NSE][[GH#844]](https://issues.nmap.org/844)NSE now correctly parses a Set-Cookie header that has unquoted
  whitespace in the cookie value (which is allowed per RFC 6265). [nnposter]
* [NSE][[GH#731]](https://issues.nmap.org/731)NSE is now able to process HTTP responses with a Set-Cookie
  header that has an extraneous trailing semicolon. [nnposter]
* [NSE][[GH#708]](https://issues.nmap.org/708)TLS SNI now works correctly for NSE HTTP requests initiated
  with option any\_af. As an added benefit, option any\_af is now available for
  all connections via [comm.lua](https://nmap.org/nsedoc/lib/comm.html), not just HTTP requests. [nnposter]
* [NSE][[GH#781]](https://issues.nmap.org/781)There is a new common function, url.get\_default\_port(),
  to obtain the default port number for a given scheme. [nnposter]
* [NSE][[GH#833]](https://issues.nmap.org/833)Function url.parse() now returns the port part as a number,
...
* [NSE][[GH#807]](https://issues.nmap.org/807)Fixed a JSON library issue that was causing long integers
  to be expressed in the scientific/exponent notation. [nnposter]
* [NSE]Fixed several potential hangs in NSE scripts that used
  receive\_buf(pattern), which will not return if the service continues to send
  data that does not match pattern. A new function in [match.lua](https://nmap.org/nsedoc/lib/match.html), pattern\_limit,
...
* [NSE]Added several commands to [redis-info](https://nmap.org/nsedoc/scripts/redis-info.html) to extract listening addresses,
  connected clients, active channels, and cluster nodes. [Vasiliy Kulikov]
* [NSE][[GH#679]](https://issues.nmap.org/679)[[GH#681]](https://issues.nmap.org/681)Refreshed script [http-robtex-reverse-ip](https://nmap.org/nsedoc/scripts/http-robtex-reverse-ip.html), reflecting
  changes at the source site (www.robtex.com). [aDoN]
* [NSE][[GH#629]](https://issues.nmap.org/629)Added two new fingerprints to [http-default-accounts](https://nmap.org/nsedoc/scripts/http-default-accounts.html)(APC Management Card, older NetScreen ScreenOS) [Steve Benson, nnposter]
* [NSE][[GH#716]](https://issues.nmap.org/716)Fix for [oracle-tns-version](https://nmap.org/nsedoc/scripts/oracle-tns-version.html) which was sending an invalid TNS
  probe due to a string escaping mixup. [Alexandr Savca]
* [NSE][[GH#694]](https://issues.nmap.org/694)[ike-version](https://nmap.org/nsedoc/scripts/ike-version.html) now outputs information about supported attributes
  and unknown vendor ids. Also, a new fingerprint for FortiGate VPNs was
  submitted by Alexis La Goutte. [Daniel Miller]
* [[GH#700]](https://issues.nmap.org/700)Enabled support for TLS SNI on the Windows platform. [nnposter]
* [[GH#649]](https://issues.nmap.org/649)New service probe and match lines for the JMON and RSE services of
...
* [Zenmap][[GH#639]](https://issues.nmap.org/639)Zenmap will no longer crash when no suitable temporary
  directory is found. Patches contributed by [Varunram Ganesh] and [Sai Sundhar]
* [Zenmap][[GH#626]](https://issues.nmap.org/626)Zenmap now properly handles the -v0 (no output) option,
  which was added in Nmap 7.10. Previously, this was treated the same as not
  specifying -v at all. [lymanZerga11]
* [[GH#630]](https://issues.nmap.org/630)Updated or removed some OpenSSL library calls that were deprecated
  in OpenSSL 1.1. [eroen]
* [NSE]Script [ssh-hostkey](https://nmap.org/nsedoc/scripts/ssh-hostkey.html) now recognizes and reports Ed25519 keys [nnposter]
* [NSE][[GH#627]](https://issues.nmap.org/627)Fixed script hang in several brute scripts due to the "threads"
...
* Integrated all of your IPv4 OS fingerprint submissions from April to
  ...
  Highlights: [http://seclists.org/nmap-dev/2016/q4/110](http://seclists.org/nmap-dev/2016/q4/110) [Daniel Miller]
* Integrated all of your service/version detection fingerprints submitted from
  ...
  nutcracker, rhpp, and usher. Highlights: [http://seclists.org/nmap-dev/2016/q4/115](http://seclists.org/nmap-dev/2016/q4/115)[Daniel Miller]
* Fix reverse DNS on Windows which was failing with the message "mass\_dns:
...
* [NSE]Added 12 NSE scripts from 4 authors, bringing the total up to 552!
  They are all listed at [https://nmap.org/nsedoc/](https://nmap.org/nsedoc/), and the summaries are below:
  * [cics-enum](https://nmap.org/nsedoc/scripts/cics-enum.html) enumerates CICS transaction IDs, mapping to screens in TN3270
    services. [Soldier of Fortran]
  * [cics-user-enum](https://nmap.org/nsedoc/scripts/cics-user-enum.html) brute-forces usernames for CICS users on TN3270 services.
    [Soldier of Fortran]
  * [fingerprint-strings](https://nmap.org/nsedoc/scripts/fingerprint-strings.html) will print the ASCII strings it finds in the service
    fingerprints that Nmap shows for unidentified services. [Daniel Miller]
  * [[GH#606]](https://issues.nmap.org/606)[ip-geolocation-map-bing](https://nmap.org/nsedoc/scripts/ip-geolocation-map-bing.html) renders IP geolocation data as an image
    via Bing Maps API. [Mak Kolybabi]
  * [[GH#606]](https://nmap.org/changelog.html#606)[ip-geolocation-map-google](https://nmap.org/nsedoc/scripts/ip-geolocation-map-google.html) renders IP geolocation data as an image
    via Google Maps API. [Mak Kolybabi]
  * [[GH#606]](https://nmap.org/changelog.html#606)[ip-geolocation-map-kml](https://nmap.org/nsedoc/scripts/ip-geolocation-map-kml.html) records IP geolocation data in a KML file
    for import into other mapping software [Mak Kolybabi]
  * [nje-pass-brute](https://nmap.org/nsedoc/scripts/nje-pass-brute.html) brute-forces the password to a NJE node, given a valid RHOST
    and OHOST. Helpfully, [nje-node-brute](https://nmap.org/nsedoc/scripts/nje-node-brute.html) can now brute force both of those
    values. [Soldier of Fortran]
  * [[GH#557]](https://issues.nmap.org/557)[ssl-cert-intaddr](https://nmap.org/nsedoc/scripts/ssl-cert-intaddr.html) will search for private IP addresses in TLS
    certificate fields and extensions. [Steve Benson]
  * [tn3270-screen](https://nmap.org/nsedoc/scripts/tn3270-screen.html) shows the login screen from mainframe TN3270 Telnet services,
    including any hidden fields. The script is accompanied by the new [tn3270](https://nmap.org/nsedoc/lib/tn3270.html)library. [Soldier of Fortran]
  * [tso-enum](https://nmap.org/nsedoc/scripts/tso-enum.html) enumerates usernames for TN3270 Telnet services. [Soldier of Fortran]
  * [tso-brute](https://nmap.org/nsedoc/scripts/tso-brute.html) brute-forces passwords for TN3270 Telnet services. [Soldier of Fortran]
  * [vtam-enum](https://nmap.org/nsedoc/scripts/vtam-enum.html) brute-forces VTAM application IDs for TN3270 services.
    [Soldier of Fortran]

* [NSE][[GH#518]](https://issues.nmap.org/518)Brute scripts are faster and more accurate. New feedback and
  adaptivity mechanisms in [brute.lua](https://nmap.org/nsedoc/lib/brute.html) help brute scripts use resources more
  ...
  [Sergey Khegay]
* [[GH#353]](https://issues.nmap.org/353)New option --defeat-icmp-ratelimit dramatically reduces UDP scan
...
* [NSE][[GH#533]](https://issues.nmap.org/533)Removed ssl-google-cert-catalog, since Google shut off that
  service at some point. Reported by Brian Morin.
* [NSE][[GH#606]](https://nmap.org/changelog.html#606)New NSE library, [geoip.lua](https://nmap.org/nsedoc/lib/geoip.html), provides a common framework for
...
* [[GH#316]](https://issues.nmap.org/316)Added scan resume from Nmap's XML output. Now you can --resume a
  canceled scan from all 3 major output formats: -oN, -oG, and -oX.
  [Tudor Emil Coman]
* [Ndiff][[GH#591]](https://issues.nmap.org/591)Fix a bug where hosts with the same IP but different
  hostnames were shown as changing hostnames between scans. Made sort stable
  with regard to hostnames. [Daniel Miller]
* [NSE][[GH#540]](https://issues.nmap.org/540)Add tls.servername script-arg for forcing a name to be used for
...
* [[GH#505]](https://issues.nmap.org/505)Updated Russian translation of Zenmap by Alexander Kozlov.
* [NSE][[GH#588]](https://issues.nmap.org/588)Fix a crash in [smb.lua](https://nmap.org/nsedoc/lib/smb.html) when using [smb-ls](https://nmap.org/nsedoc/scripts/smb-ls.html) due to a
  floating-point number being passed to os.time ("bad argument").
  [Dallas Winger]
* [NSE][[GH#596]](https://issues.nmap.org/596)Fix a bug in [mysql.lua](https://nmap.org/nsedoc/lib/mysql.html) that caused authentication failures in[mysql-brute](https://nmap.org/nsedoc/scripts/mysql-brute.html) and other scripts due to including a null terminator in the salt
...
* [NSE]Added known Diffie-Hellman parameters for haproxy, postfix, and
  IronPort to [ssl-dh-params](https://nmap.org/nsedoc/scripts/ssl-dh-params.html). [Frank Bergmann]
...
* [NSE]Enabled [resolveall](https://nmap.org/nsedoc/scripts/resolveall.html) to run against any target provided as a hostname, so
  the [resolveall](https://nmap.org/nsedoc/scripts/resolveall.html).hosts script-arg is no longer required. [Daniel Miller]
* [NSE]Revised script [http-default-accounts](https://nmap.org/nsedoc/scripts/http-default-accounts.html) in several ways [nnposter]:
  * Added 21 new fingerprints, plus broadened 5 to cover more variants.
  * [[GH#577]](https://issues.nmap.org/577)It can now can test systems that return status 200 for
    non-existent pages.
  * [[GH#604]](https://issues.nmap.org/604)Implemented XML output. Layout of the classic text output has also
...
* [NSE][[GH#573]](https://issues.nmap.org/573)Updated [http.lua](https://nmap.org/nsedoc/lib/http.html) to allow processing of HTTP responses with
  malformed header names. Such header lines are still captured in the rawheader
  list but skipped otherwise. [nnposter]
* [[GH#416]](https://issues.nmap.org/416)New service probe and match line for iperf3. [Eric Gershman]
* [NSE][[GH#555]](https://issues.nmap.org/555)Add Drupal to the set of web apps brute forced by[http-form-brute](https://nmap.org/nsedoc/scripts/http-form-brute.html). [Nima Ghotbi]
...
* [Windows]Updated the bundled Npcap from 0.10r2 to 0.10r9, bringing
  ...
  by Nmap). Further details on these changes can be found at[https://github.com/nmap/npcap/releases](https://github.com/nmap/npcap/releases). [Yang Luo]
* Fixed the way Nmap handles scanning names that resolve to the same IP. Due to
  ...
  [Tudor Emil Coman]
* [Nping][[GH#559]](https://issues.nmap.org/559)Fix Nping's ability to use Npcap on Windows. A privilege
  check was performed too late, so the Npcap loading code assumed the user had no
  rights. [Yang Luo, Daniel Miller]
* [[GH#350]](https://issues.nmap.org/350)Fix an assertion failure due to floating point error in equality
...
* [Zenmap]Fix a crash in the About page in the Spanish translation due to a
  ...
  [Daniel Miller]
* [Zenmap][[GH#556]](https://issues.nmap.org/556)Better visual indication that display of hostname is tied to
...
* [NSE]Added 7 NSE scripts, from 3 authors, bringing the total up to 541!
  ...
  * [[GH#369]](https://issues.nmap.org/369)[coap-resources](https://nmap.org/nsedoc/scripts/coap-resources.html) grabs the list of available resources from CoAP
    endpoints. [Mak Kolybabi]
  * [fox-info](https://nmap.org/nsedoc/scripts/fox-info.html) retrieves detailed version and configuration info from Tridium
    Niagara Fox services. [Stephen Hilt]
  * [ipmi-brute](https://nmap.org/nsedoc/scripts/ipmi-brute.html) performs authentication brute-forcing on IPMI services.
    [Claudiu Perta]
  * [ipmi-cipher-zero](https://nmap.org/nsedoc/scripts/ipmi-cipher-zero.html) checks IPMI services for Cipher Zero support, which allows
    connection without a password. [Claudiu Perta]
  * [ipmi-version](https://nmap.org/nsedoc/scripts/ipmi-version.html) retrieves protocol version and authentication options from
    ASF-RMCP (IPMI) services. [Claudiu Perta]
  * [[GH#352]](https://issues.nmap.org/352)[mqtt-subscribe](https://nmap.org/nsedoc/scripts/mqtt-subscribe.html) connects to a MQTT broker, subscribes to topics,
    and lists the messages received. [Mak Kolybabi]
  * [pcworx-info](https://nmap.org/nsedoc/scripts/pcworx-info.html) retrieves PLC model, firmware version, and date from Phoenix
...
* Upgraded Npcap, our new Windows packet capturing driver/library,
  ...
  from [https://github.com/nmap/npcap/releases](https://github.com/nmap/npcap/releases). [Yang Luo, Daniel
  Miller, Fyodor]
...
* [[GH#543]](https://issues.nmap.org/543)Restored compatibility with LibreSSL, which was lost in adding
...
* [NSE]Fixed a bug in [ssl-enum-ciphers](https://nmap.org/nsedoc/scripts/ssl-enum-ciphers.html) and [ssl-dh-params](https://nmap.org/nsedoc/scripts/ssl-dh-params.html) which caused them to
  not output TLSv1.2 info with DHE ciphersuites or others involving
  ServerKeyExchange messages. [Daniel Miller]
* [NSE]Added X509v3 extension parsing to NSE's sslcert code. [ssl-cert](https://nmap.org/nsedoc/scripts/ssl-cert.html) now
  shows the Subject Alternative Name extension; all extensions are shown in the
  XML output. [Daniel Miller]

### Nmap 7.25BETA2 [2016-09-01] [§](https://nmap.org/changelog.html#7.25BETA2) ###

* [[GH#376]](https://issues.nmap.org/376)Windows binaries are now code-signed with our "Insecure.Com LLC"
...
* [NSE]Upgraded NSE to Lua 5.3, adding bitwise operators, integer data type, a
  utf8 library, and native binary packing and unpacking functions. Removed bit
  library, added [bits.lua](https://nmap.org/nsedoc/lib/bits.html), replaced base32, base64, and [bin](https://nmap.org/nsedoc/lib/bin.html) libraries. [Patrick
  Donnelly]
* [NSE]Added 2 NSE scripts, bringing the total up to 534! They are both listed
  at [https://nmap.org/nsedoc/](https://nmap.org/nsedoc/), and the summaries are below:
  * [oracle-tns-version](https://nmap.org/nsedoc/scripts/oracle-tns-version.html) decodes the version number from Oracle Database Server's
    TNS listener. [Daniel Miller]
  * [clock-skew](https://nmap.org/nsedoc/scripts/clock-skew.html) analyzes and reports clock skew between Nmap and services that
...
* Upgraded Npcap, our new Windows packet capturing driver/library,
  ...
  read about at [https://github.com/nmap/npcap/releases](https://github.com/nmap/npcap/releases).
* [Nsock][[GH#148]](https://issues.nmap.org/148)Added the new IOCP Nsock engine which uses the Windows
  Overlapped I/O API to improve performance of version scan and NSE against
  many targets on Windows. [Tudor Emil Coman]
* [[GH#376]](https://nmap.org/changelog.html#376)Windows binaries are now code-signed with our "Insecure.Com LLC"
  SHA256 certificate. This should give our users extra peace-of-mind and avoid
  triggering Microsoft's ever-increasing security warnings.
...
* [Zenmap]Long-overdue Spanish language translation has been added! Muy bien!
  [Vincent Dumont, Marta Garcia De La Paz, Paulino Calderon, Patricio Castagnaro]
* [Zenmap][[GH#449]](https://issues.nmap.org/449)Fix a crash when closing Zenmap due to a read-only
...
* [NSE]Fix a crash when parsing TLS certificates that OpenSSL doesn't support,
  like DH certificates or corrupted certs. When this happens, [ssl-enum-ciphers](https://nmap.org/nsedoc/scripts/ssl-enum-ciphers.html)will label the ciphersuite strength as "unknown." Reported by Bertrand
  Bonnefoy-Claudet. [Daniel Miller]
* [NSE][[GH#531]](https://issues.nmap.org/531)Fix two issues in [sslcert.lua](https://nmap.org/nsedoc/lib/sslcert.html) that prevented correct operations
  against LDAP services when version detection or STARTTLS were used.
  [Tom Sellers]
* [[GH#426]](https://issues.nmap.org/426)Remove a workaround for lack of selectable pcap file descriptors on
...
* [NSE][[GH#234]](https://issues.nmap.org/234)Added a --script-timeout option for limiting run time for
  every individual NSE script. [Abhishek Singh]
* [Ncat][[GH#444]](https://issues.nmap.org/444)Added a -z option to Ncat. Just like the -z option in
...
* [NSE][ssl-enum-ciphers](https://nmap.org/nsedoc/scripts/ssl-enum-ciphers.html) will now warn about 64-bit block ciphers in CBC mode,
  which are vulnerable to the SWEET32 attack.
* [NSE][[GH#117]](https://issues.nmap.org/117)[tftp-enum](https://nmap.org/nsedoc/scripts/tftp-enum.html) now only brute-forces IP-address-based Cisco filenames when
...
* [[GH#472]](https://issues.nmap.org/472)Avoid an unnecessary assert failure in timing.cc when printing estimated
...
* [NSE][[GH#519]](https://issues.nmap.org/519)Removed the obsolete script ip-geolocation-geobytes. [Paulino Calderon]
* [NSE]Added 9 new fingerprints for script [http-default-accounts](https://nmap.org/nsedoc/scripts/http-default-accounts.html).
...
* [NSE]Completed a refresh and validation of almost all fingerprints for
  script [http-default-accounts](https://nmap.org/nsedoc/scripts/http-default-accounts.html). Also improved the script speed. [nnposter]
* [[GH#98]](https://issues.nmap.org/98)Added support for decoys in IPv6. Earlier we supported decoys only in
  IPv4. [Abhishek Singh]
* Various performance improvements for large-scale high-rate scanning,
  including increased ping host groups, faster probe matching, and ensuring
  data types can handle an Internet's-worth of targets. [Tudor Emil Coman]
* [[GH#484]](https://issues.nmap.org/484)Allow Nmap to compile on some older Red Hat distros that disable EC
  crypto support in OpenSSL. [Jeroen Roovers, Vincent Dumont]
* [[GH#439]](https://issues.nmap.org/439)Nmap now supports OpenSSL 1.1.0-pre5 and previous versions. [Vincent Dumont]
* [Ncat]Fix a crash ("add\_fdinfo() failed.") when --exec was used with --ssl
...
* [[GH#140]](https://issues.nmap.org/140)Allow target DNS names up to 254 bytes. We previously imposed an
...
* [NSE]Added the [datetime](https://nmap.org/nsedoc/lib/datetime.html) library for performing date and time calculations,
  and as a helper to the [clock-skew](https://nmap.org/nsedoc/scripts/clock-skew.html) script.
* [[GH#103]](https://issues.nmap.org/103)[[GH#364]](https://issues.nmap.org/364)Made Nmap's parallel reverse DNS resolver more robust, fully
...
* [Zenmap][[GH#279]](https://issues.nmap.org/279)Added a legend for the Topography window. [Suraj Hande]

### Nmap 7.25BETA1 [2016-07-15] [§](https://nmap.org/changelog.html#7.25BETA1) ###
...
* Nmap now ships with and uses Npcap, our new packet sniffing library
  ...
  security improvements and many bug fixes. See [https://npcap.com](https://npcap.com/). And
...
* [NSE]Added 6 NSE scripts, from 5 authors, bringing the total up to 533!
  They are all listed at [https://nmap.org/nsedoc/](https://nmap.org/nsedoc/), and the summaries are below
  (authors are listed in brackets):
  * [clamav-exec](https://nmap.org/nsedoc/scripts/clamav-exec.html) detects ClamAV servers vulnerable to unauthorized clamav
    command execution. [Paulino Calderon]
  * [http-aspnet-debug](https://nmap.org/nsedoc/scripts/http-aspnet-debug.html) detects ASP.NET applications with debugging enabled.
    [Josh Amishav-Zlatin]
  * [http-internal-ip-disclosure](https://nmap.org/nsedoc/scripts/http-internal-ip-disclosure.html) determines if the web server leaks its internal
    IP address when sending an HTTP/1.0 request without a Host header. [Josh
    Amishav-Zlatin]
  * [[GH#304]](https://issues.nmap.org/304)[http-mcmp](https://nmap.org/nsedoc/scripts/http-mcmp.html) detects mod\_cluster Management Protocol (MCMP) and dumps
    its configuration. [Frank Spierings]
  * [[GH#365]](https://issues.nmap.org/365)[sslv2-drown](https://nmap.org/nsedoc/scripts/sslv2-drown.html) detects vulnerability to the DROWN attack, including
    CVE-2016-0703 and CVE-2016-0704 that enable fast attacks on OpenSSL.
    [Bertrand Bonnefoy-Claudet]
  * [vnc-title](https://nmap.org/nsedoc/scripts/vnc-title.html) logs in to VNC servers and grabs the desktop title, geometry, and
...
* Update oldest supported Windows version to Vista (Windows 6.0). This enables
  ...
  accuracy advantages. Windows XP users can still use Nmap 7.12, available from[https://nmap.org/dist/?C=M&O=D](https://nmap.org/dist/?C=M&O=D) [Daniel Miller]
...
* [[GH#283]](https://issues.nmap.org/283)[Nsock]Avoid "unknown protocol:0" debug messages and an "Unknown
  address family 0" crash on Windows and other platforms that do not set the
  src\_addr argument to recvfrom for TCP sockets. [Daniel Miller]
...
* Changed libdnet-stripped to avoid bailing completely when an interface is
  ...
  types. [Daniel Miller]
* Improved service detection of Docker and fixed a bug in the output of[docker-version](https://nmap.org/nsedoc/scripts/docker-version.html) script. [Tom Sellers]
* Fix detection of Microsoft Terminal Services (RDP). Our improved TLS service
  ...
  Amishav-Zlatin.
* [NSE]Update to enable [smb-os-discovery](https://nmap.org/nsedoc/scripts/smb-os-discovery.html) to augment version detection
...
* Improved version detection and descriptions for Microsoft and Samba
  ...
  [Tom Sellers]
* [NSE][ssl-enum-ciphers](https://nmap.org/nsedoc/scripts/ssl-enum-ciphers.html) will give a failing score to any server with an RSA
...
* [NSE]Refactored some SSLv2 functionality into a new library, [sslv2.lua](https://nmap.org/nsedoc/lib/sslv2.html) .
  [Daniel Miller]
* [[GH#399]](https://issues.nmap.org/399)Zenmap's authorization wrapper now uses an AppleScript method for
...
* [[GH#454]](https://issues.nmap.org/454)The OS X binary package is distributed in a .dmg disk image that now
  features an instructive background image. [Vincent Dumont]
* [[GH#420]](https://issues.nmap.org/420)Our OS X build system now uses gtk-mac-bundler and jhbuild to
  provide all dependencies. We no longer use Macports for this purpose.
  [Vincent Dumont]
* [[GH#345]](https://issues.nmap.org/345)[Zenmap]On Windows, save Zenmap's stderr output to a writeable
...
* [[GH#379]](https://issues.nmap.org/379)[NSE]Fix [http-iis-short-name-brute](https://nmap.org/nsedoc/scripts/http-iis-short-name-brute.html) to report non vulnerable hosts.
  Reported by alias1. [Paulino Calderon]
* [NSE][[GH#371]](https://issues.nmap.org/371)Fix [mysql-audit](https://nmap.org/nsedoc/scripts/mysql-audit.html) by adding needed library requires to the
  mysql-cis.audit file. The script would fail with "Failed to load rulebase"
  message. [Paolo Perego]
* [NSE][[GH#362]](https://issues.nmap.org/362)Added support for LDAP over udp to [ldap-rootdse](https://nmap.org/nsedoc/scripts/ldap-rootdse.html).nse.
...
* [[GH#354]](https://issues.nmap.org/354)Added new version detection Probes for LDAP services, LDAPSearchReq
  and LDAPSearchReqUDP. The second is Microsoft Active Directory specific. The
  Probes will elicit responses from target services that allow better [finger](https://nmap.org/nsedoc/scripts/finger.html)-printing and information extraction. Also added nmap-payload entry for
  detecting LDAP on udp. [Tom Sellers]
* [NSE]More VNC updates: Support for VeNCrypt and Tight auth types, output of
  authentication sub-types in [vnc-info](https://nmap.org/nsedoc/scripts/vnc-info.html), and all zero-authentication types are
...
* [NSE]VNC updates including [vnc-brute](https://nmap.org/nsedoc/scripts/vnc-brute.html) support for TLS security type and
...
* [NSE][[GH#341]](https://issues.nmap.org/341)Added support for diffie-hellman-group-exchange-\* SSH key
  exchange methods to [ssh2.lua](https://nmap.org/nsedoc/lib/ssh2.html), allowing [ssh-hostkey](https://nmap.org/nsedoc/scripts/ssh-hostkey.html) to run on servers that
  only support custom Diffie-Hellman groups. [Sergey Khegay]
* [NSE]Added support in [sslcert.lua](https://nmap.org/nsedoc/lib/sslcert.html) for Microsoft SQL Server's TDS protocol,
  so you can now grab certs with [ssl-cert](https://nmap.org/nsedoc/scripts/ssl-cert.html) or check ciphers with[ssl-enum-ciphers](https://nmap.org/nsedoc/scripts/ssl-enum-ciphers.html). [Daniel Miller]
...
* [NSE]Added 12 NSE scripts from 7 authors, bringing the total up to 527!
  They are all listed at [https://nmap.org/nsedoc/](https://nmap.org/nsedoc/), and the summaries are below
  (authors are listed in brackets):
  * [[GH#322]](https://issues.nmap.org/322)[http-apache-server-status](https://nmap.org/nsedoc/scripts/http-apache-server-status.html) parses the server status page of
    Apache's mod\_status. [Eric Gershman]
  * [http-vuln-cve2013-6786](https://nmap.org/nsedoc/scripts/http-vuln-cve2013-6786.html) detects a XSS and URL redirection vulnerability in
  ...
  * [[GH#226]](https://issues.nmap.org/226)[http-vuln-cve2014-3704](https://nmap.org/nsedoc/scripts/http-vuln-cve2014-3704.html) detects and exploits the "Drupalgeddon"
    pre-auth SQL Injection vulnerability in Drupal. [Mariusz Ziulek]
  * [imap-ntlm-info](https://nmap.org/nsedoc/scripts/imap-ntlm-info.html) extracts hostname and sometimes OS version from
    NTLM-auth-enabled IMAP services. [Justin Cacak]
  * [ipv6-multicast-mld-list](https://nmap.org/nsedoc/scripts/ipv6-multicast-mld-list.html) discovers IPv6 multicast listeners with MLD probes.
    The discovery is the same as [targets-ipv6-multicast-mld](https://nmap.org/nsedoc/scripts/targets-ipv6-multicast-mld.html), but the subscribed
    addresses are decoded and listed. [Alexandru Geana, Daniel Miller]
  * [ms-sql-ntlm-info](https://nmap.org/nsedoc/scripts/ms-sql-ntlm-info.html) extracts OS version and sometimes hostname from MS SQL
    Server instances via the NTLM challenge message. [Justin Cacak]
  * [nntp-ntlm-info](https://nmap.org/nsedoc/scripts/nntp-ntlm-info.html) extracts hostname and sometimes OS version from
    NTLM-auth-enabled NNTP services. [Justin Cacak]
  * [pop3-ntlm-info](https://nmap.org/nsedoc/scripts/pop3-ntlm-info.html) extracts hostname and sometimes OS version from
    NTLM-auth-enabled POP3 services. [Justin Cacak]
  * [rusers](https://nmap.org/nsedoc/scripts/rusers.html) retrieves information about logged-on users from the rusersd RPC
    service. [Daniel Miller]
  * [[GH#333]](https://issues.nmap.org/333)[shodan-api](https://nmap.org/nsedoc/scripts/shodan-api.html) queries the Shodan API ([https://www.shodan.io](https://www.shodan.io/)) and
    retrieves open port and service info from their Internet-wide scan data.
    [Glenn Wilkinson]
  * [smtp-ntlm-info](https://nmap.org/nsedoc/scripts/smtp-ntlm-info.html) extracts hostname and sometimes OS version from
    NTLM-auth-enabled SMTP and submission services. [Justin Cacak]
  * [telnet-ntlm-info](https://nmap.org/nsedoc/scripts/telnet-ntlm-info.html) extracts hostname and sometimes OS version from
...
* Integrated all of your IPv4 OS fingerprint submissions from October to
  ...
  Highlights: [http://seclists.org/nmap-dev/2016/q1/270](http://seclists.org/nmap-dev/2016/q1/270) [Daniel Miller]
* Integrated all of your service/version detection fingerprints submitted from
  October to January (508 of them). The signature count went up 2.2% to 10532.
  We now detect 1108 protocols, from icy, [finger](https://nmap.org/nsedoc/scripts/finger.html), and rtsp to ipfs,
  basestation, and minecraft-pe. Highlights:[http://seclists.org/nmap-dev/2016/q1/271](http://seclists.org/nmap-dev/2016/q1/271) [Daniel Miller]
* Integrated all 12 of your IPv6 OS fingerprint submissions from October to
  ...
  for OS X, bringing the new total to 96. Highlights:[http://seclists.org/nmap-dev/2016/q1/273](http://seclists.org/nmap-dev/2016/q1/273) [Daniel Miller]
* [NSE]Upgrade to [http-form-brute](https://nmap.org/nsedoc/scripts/http-form-brute.html) allowing correct handling of token-based
...
* [Zenmap][[GH#247]](https://issues.nmap.org/247)Remember window geometry (position and size) from the
...
* [[GH#284]](https://issues.nmap.org/284)Fix retrieval of route netmasks on FreeBSD. IPv6 routes were given
  /32 netmasks regardless of actual netmask configured, resulting in failed
  routing. Reported by Martin Gysi. [Daniel Miller]
* [[GH#272]](https://issues.nmap.org/272)[[GH#269]](https://issues.nmap.org/269)Give option parsing errors after the usage statement, or
...
* [[GH#249]](https://issues.nmap.org/249)[Nsock]Avoid a crash on Windows reported by users using Zenmap's
  Slow Comprehensive Scan profile. In the case of unknown OpenSSL errors,
  ERR\_reason\_error\_string would return NULL, which could not be printed with
  the "%s" format string. Reported by Dan Baxter. [Gisle Vanem, Daniel Miller]
* [[GH#293]](https://issues.nmap.org/293)[Zenmap]Fix a regression in our build that caused copy-and-paste to
...
* Allow the -4 option for Nmap to indicate IPv4 address family. This is the
  ...
  [Daniel Miller]
* [[GH#265]](https://issues.nmap.org/265)When provided a verbosity of 0 (-v0), Nmap will not output any text to the
  screen. This happens at the time of argument parsing, so the usual meaning of
  "verbosity 0" is preserved. [isjing]
* [NSE][[GH#314]](https://issues.nmap.org/314)Fix naming of SSL2\_RC2\_128\_CBC\_WITH\_MD5 and
  SSL2\_RC2\_128\_CBC\_EXPORT40\_WITH\_MD5 ciphers in [sslv2](https://nmap.org/nsedoc/scripts/sslv2.html) in order to match the
  draft specification from Mozilla. [Bertrand Bonnefoy-Claudet]
* [NSE][[GH#320]](https://issues.nmap.org/320)Add STARTTLS support to [sslv2](https://nmap.org/nsedoc/scripts/sslv2.html) to enable SSLv2 detection
...
* [NSE][[GH#301]](https://issues.nmap.org/301)Added default credential checks for RICOH Web Image Monitor and
  BeEF to [http-default-accounts](https://nmap.org/nsedoc/scripts/http-default-accounts.html). [nnposter]
...
* [NSE]Added support for DHCP options "TFTP server name" and "Bootfile name"
  to [dhcp.lua](https://nmap.org/nsedoc/lib/dhcp.html) and enabled checking for options with a code above 61 by default.
  [Mike Rykowski]
* [NSE][whois-ip](https://nmap.org/nsedoc/scripts/whois-ip.html): Don't request a remote IANA assignments data file when the
  local filesystem will not permit the file to cached in a local file. [jah]
* [NSE]Updated [http-php-version](https://nmap.org/nsedoc/scripts/http-php-version.html) hash database to cover all versions from PHP
  4.1.0 to PHP 5.4.45. Based on scans of a few thousand PHP web servers pulled
  from Shodan API ([https://www.shodan.io/](https://www.shodan.io/)) [Daniel Miller]
...
* [[GH#274]](https://issues.nmap.org/274)Use a shorter pcap\_select timeout on OpenBSD, just as we do for OS
...
* Print service info in grepable output for ports which are not listed in
  ...
  tunnel was positively identified. [http://seclists.org/nmap-dev/2015/q4/260](http://seclists.org/nmap-dev/2015/q4/260)[Daniel Miller]
* [NSE][[GH#242]](https://issues.nmap.org/242)Fix multiple false-positive sources in http-backup-agent.
  [Tom Sellers]
...
* Updated the OpenSSL shipped with our binary builds (Windows, OS X, and RPM)
  to 1.0.2e.
* [Zenmap][[GH#235]](https://issues.nmap.org/235)Fix several failures to launch Zenmap on OS X. The new
...
* [NSE][[GH#254]](https://issues.nmap.org/254)Update the TLSSessionRequest probe in [ssl-enum-ciphers](https://nmap.org/nsedoc/scripts/ssl-enum-ciphers.html) to
  match the one in nmap-service-probes, which was fixed previously to correct a
  length calculation error. [Daniel Miller]
* [NSE][[GH#251]](https://issues.nmap.org/251)Correct false positives and unexpected behavior in http-\*
  scripts which used http.identify\_404 to determine when a file was not found
  on the target. The function was following redirects, which could be an
  indication of a soft-404 response. [Tom Sellers]
* [NSE][[GH#241]](https://issues.nmap.org/241)Fix a false-positive in [hnap-info](https://nmap.org/nsedoc/scripts/hnap-info.html) when the target responds
  with 200 OK to any request. [Tom Sellers]
* [NSE][[GH#244]](https://issues.nmap.org/244)Fix an error response in [xmlrpc-methods](https://nmap.org/nsedoc/scripts/xmlrpc-methods.html) when run against a
  non-HTTP service. The expected behavior is no output. [Niklaus Schiess]
* [NSE]Fix SSN validation function in [http-grep](https://nmap.org/nsedoc/scripts/http-grep.html), reported by Bruce Barnett.
...
* This is the most important release since Nmap 6.00 back in May 2012!
  ...
  see the announcement at: [https://nmap.org/7/](https://nmap.org/7/)
* [NSE]Added 6 NSE scripts from 6 authors, bringing the total up to 515!
  They are all listed at [https://nmap.org/nsedoc/](https://nmap.org/nsedoc/), and the summaries are below
  (authors are listed in brackets):
  * [targets-xml](https://nmap.org/nsedoc/scripts/targets-xml.html) extracts target addresses from previous Nmap XML results files.
    [Daniel Miller]
  * [[GH#232]](https://issues.nmap.org/232)[ssl-dh-params](https://nmap.org/nsedoc/scripts/ssl-dh-params.html) checks for problems with weak, non-safe, and
    export-grade Diffie-Hellman parameters in TLS handshakes. This includes the
    LOGJAM vulnerability (CVE-2015-4000). [Jacob Gajek]
  * [nje-node-brute](https://nmap.org/nsedoc/scripts/nje-node-brute.html) does brute-forcing of z/OS JES Network Job Entry node names.
    [Soldier of Fortran]
  * [ip-https-discover](https://nmap.org/nsedoc/scripts/ip-https-discover.html) detectings support for Microsoft's IP over HTTPS
    tunneling protocol. [Niklaus Schiess]
  * [[GH#165]](https://issues.nmap.org/165)[broadcast-sonicwall-discover](https://nmap.org/nsedoc/scripts/broadcast-sonicwall-discover.html) detects and extracts information from
    SonicWall firewalls. [Raphael Hoegger]
  * [[GH#38]](https://issues.nmap.org/38)[http-vuln-cve2014-8877](https://nmap.org/nsedoc/scripts/http-vuln-cve2014-8877.html) checks for and optionally exploits a
    vulnerability in CM Download Manager plugin for Wordpress. [Mariusz Ziulek]

* [Ncat][[GH#151]](https://issues.nmap.org/151)[[GH#142]](https://issues.nmap.org/142)New option --no-shutdown prevents Ncat from shutting
  down when it reads EOF on stdin. This is the same as traditional netcat's
  "-d" option. [Adam Saponara]
* [NSE][[GH#229]](https://issues.nmap.org/229)Improve parsing in [http.lua](https://nmap.org/nsedoc/lib/http.html) for multiple Set-Cookie headers in
  a single response. [nnposter]

### Nmap 6.49BETA6 [2015-11-03] [§](https://nmap.org/changelog.html#6.49BETA6) ###
...
* Integrated all of your IPv6 OS fingerprint submissions from April to October
  ...
  to 93. Highlights: [http://seclists.org/nmap-dev/2015/q4/61](http://seclists.org/nmap-dev/2015/q4/61) [Daniel Miller]
* Integrated all of your IPv4 OS fingerprint submissions from February to
  ...
  11.0, Android 5.1, and more. Highlights:[http://seclists.org/nmap-dev/2015/q4/60](http://seclists.org/nmap-dev/2015/q4/60) [Daniel Miller]
* Integrated all of your service/version detection fingerprints submitted from
  ...
  xml-rpc, yiff, and zebra. Highlights: [http://seclists.org/nmap-dev/2015/q4/62](http://seclists.org/nmap-dev/2015/q4/62)[Daniel Miller]
* [NSE]Added 10 NSE scripts from 5 authors, bringing the total up to 509!
  They are all listed at [https://nmap.org/nsedoc/](https://nmap.org/nsedoc/), and the summaries are below
  (authors are listed in brackets):
  * [knx-gateway-discover](https://nmap.org/nsedoc/scripts/knx-gateway-discover.html) and [knx-gateway-info](https://nmap.org/nsedoc/scripts/knx-gateway-info.html) scripts gather information from
    multicast and unicast KNX gateways, which connect home automation systems
    to IP networks. [Niklaus Schiess, Dominik Schneider]
  * [http-ls](https://nmap.org/nsedoc/scripts/http-ls.html) parses web server directory index pages with optional recursion.
    [Pierre Lalet]
  * [xmlrpc-methods](https://nmap.org/nsedoc/scripts/xmlrpc-methods.html) perfoms introspection of xmlrpc services and lists methods
    and their descriptions. [Gyanendra Mishra]
  * [http-fetch](https://nmap.org/nsedoc/scripts/http-fetch.html) can be used like wget or curl to fetch all files, specific
    filenames, or files that match a given pattern. [Gyanendra Mishra]
  * [http-svn-enum](https://nmap.org/nsedoc/scripts/http-svn-enum.html) enumerates users of a Subversion repository by examining
    commit logs. [Gyanendra Mishra]
  * [http-svn-info](https://nmap.org/nsedoc/scripts/http-svn-info.html) requests information from a Subversion repository, similar to
    the "svn info" command. [Gyanendra Mishra]
  * [hnap-info](https://nmap.org/nsedoc/scripts/hnap-info.html) detects and outputs info for Home Network Administration Protocol
    devices. [Gyanendra Mishra]
  * [http-webdav-scan](https://nmap.org/nsedoc/scripts/http-webdav-scan.html) detects WebDAV servers and reports allowed methods and
    directory listing. [Gyanendra Mishra]
  * [tor-consensus-checker](https://nmap.org/nsedoc/scripts/tor-consensus-checker.html) checks the target's address with the Tor directory
    authorities to determine if a target is a known Tor node. [Jiayi Ye]

* [NSE]Several scripts have been split, combined, or renamed:
  * [[GH#171]](https://issues.nmap.org/171)smb-check-vulns has been split into:
    * [smb-vuln-conficker](https://nmap.org/nsedoc/scripts/smb-vuln-conficker.html)
    * [smb-vuln-cve2009-3103](https://nmap.org/nsedoc/scripts/smb-vuln-cve2009-3103.html)
    * [smb-vuln-ms06-025](https://nmap.org/nsedoc/scripts/smb-vuln-ms06-025.html)
    * [smb-vuln-ms07-029](https://nmap.org/nsedoc/scripts/smb-vuln-ms07-029.html)
    * [smb-vuln-regsvc-dos](https://nmap.org/nsedoc/scripts/smb-vuln-regsvc-dos.html)
    * [smb-vuln-ms08-067](https://nmap.org/nsedoc/scripts/smb-vuln-ms08-067.html)

    The scripts now use the [vulns](https://nmap.org/nsedoc/lib/vulns.html) library, and the "unsafe" script-arg has been
    replaced by putting the scripts into the "dos" category. [Paulino Calderon]
  * http-email-harvest was removed, as the new [http-grep](https://nmap.org/nsedoc/scripts/http-grep.html) does email address
    scraping by default. [Gyanendra Mishra]
  * http-drupal-modules was renamed to [http-drupal-enum](https://nmap.org/nsedoc/scripts/http-drupal-enum.html). Extended to enumerate
    both themes and modules of Drupal installaions. [Gyanendra Mishra]

* [Ncat][[GH#193]](https://issues.nmap.org/193)Fix Ncat listen mode over Unix sockets (named pipes) on OS X.
...
* [Zenmap]Fix a crash in Zenmap when using Compare Results:
  ...
  [Daniel Miller]
* [NSE][[GH#194]](https://issues.nmap.org/194)Add support for reading fragmented TLS messages to[ssl-enum-ciphers](https://nmap.org/nsedoc/scripts/ssl-enum-ciphers.html). [Jacob Gajek]
* [[GH#51]](https://issues.nmap.org/51)Added IPv6 support to nmap\_mass\_rdns, improved reverse DNS cache,
...
* [NSE]Added NTLM brute support to [http-brute](https://nmap.org/nsedoc/scripts/http-brute.html). [Gyanendra Mishra]
* [NSE]Added NTLM authentication support to [http.lua](https://nmap.org/nsedoc/lib/http.html) and a related function to create
  an ntlm v2 session response in [smbauth.lua](https://nmap.org/nsedoc/lib/smbauth.html). [Gyanendra Mishra]
* [NSE][[GH#106]](https://issues.nmap.org/106)Added a new NSE module, [ls.lua](https://nmap.org/nsedoc/lib/ls.html), for accumulating and
  outputting file and directory listings. The [afp-ls](https://nmap.org/nsedoc/scripts/afp-ls.html), [nfs-ls](https://nmap.org/nsedoc/scripts/nfs-ls.html), and [smb-ls](https://nmap.org/nsedoc/scripts/smb-ls.html)scripts have been converted to use this module. [Pierre Lalet]
* [NSE][bacnet-info](https://nmap.org/nsedoc/scripts/bacnet-info.html).nse and [s7-info](https://nmap.org/nsedoc/scripts/s7-info.html).nse were added to the version category.
  [Paulino Calderon]
* [NSE]Added 124 new identifiers to [bacnet-info](https://nmap.org/nsedoc/scripts/bacnet-info.html).nse vendor database.
  [Paulino Calderon]
* [NSE]Fixed [bacnet-info](https://nmap.org/nsedoc/scripts/bacnet-info.html).nse to bind to the service port detected
  during scan instead of fixed port. [Paulino Calderon]
* [NSE]Enhanced reporting of elliptic curve names and strengths in[ssl-enum-ciphers](https://nmap.org/nsedoc/scripts/ssl-enum-ciphers.html). The name of the curve is now reported instead of just "ec"
  [Brandon Paulsen]
* [[GH#75]](https://issues.nmap.org/75)Normalize Makefile targets to use the same verb-project format, e.g.
  build-ncat, check-zenmap, install-nping, clean-nsock [Gioacchino Mazzurco]
* [NSE]Added builtin pattern and multiple pattern search to [http-grep](https://nmap.org/nsedoc/scripts/http-grep.html). [Gyanendra Mishra]
* [NSE]http-crossdomainxml is now [http-cross-domain-policy](https://nmap.org/nsedoc/scripts/http-cross-domain-policy.html) and supports client
  access policies and uses the new SLAXML parser. [Gyanendra Mishra]
* [NSE]Added a patch for [vulns](https://nmap.org/nsedoc/lib/vulns.html) lib that allows list of tables to be submitted
  to fields in the vulns report. [Jacob Gajek]
* [NSE]Added additional checks for successful PUT request in [http-put](https://nmap.org/nsedoc/scripts/http-put.html).
  [Oleg Mitrofanov]
* [NSE]Added an update for [http-methods](https://nmap.org/nsedoc/scripts/http-methods.html) that checks all possible methods not in
...
* [NSE][[GH#122]](https://issues.nmap.org/122)Update the [snmp-brute](https://nmap.org/nsedoc/scripts/snmp-brute.html) and other snmp-\* scripts to use the[creds](https://nmap.org/nsedoc/lib/creds.html) library to store brute-forced snmp community strings. This allows Nmap
...
* Several improvements to TLS/SSL detection in nmap-service-probes. A new
  ...
  up -sV scans. [http://seclists.org/nmap-dev/2015/q2/17](http://seclists.org/nmap-dev/2015/q2/17) [Daniel Miller]
* [Nsock]Clean up the API so that nsp\_\* calls are now nsock\_pool\_\* and nsi\_\*
  are nsock\_iod\_\*. Simplify Nsock SSL init API, and make logging global to the
  library instead of associated with a nspool. [Henri Doreau]
* [[GH#181]](https://issues.nmap.org/181)The configure script now prints a summary of configured options.
...
* [[GH#51]](https://nmap.org/changelog.html#51)Nmap's parallel reverse-DNS resolver now handles IPv6 addresses. This
...
* [NSE][[GH#113]](https://issues.nmap.org/113)[http-form-fuzzer](https://nmap.org/nsedoc/scripts/http-form-fuzzer.html) will now stop increasing the size of a
  request when an HTTP 413 or 414 error indicates the web server will not
  accept a larger request. [Gioacchino Mazzurco]
* [NSE][[GH#159]](https://issues.nmap.org/159)Add the ability to tag credentials in the [creds](https://nmap.org/nsedoc/lib/creds.html) library with
...
### Nmap 6.49BETA5 [2015-09-25] [§](https://nmap.org/changelog.html#6.49BETA5) ###
...
* [[GH#212]](https://issues.nmap.org/212)[NSE]Fix http.get\_url function which was wrongly attempting
  non-SSL HTTP requests first when passed https URLs. [jah]
* [[GH#201]](https://issues.nmap.org/201)Fix Ndiff interpreter path problems in the OS X .dmg
...
* [[GH#172]](https://issues.nmap.org/172)[NSE]Fix reporting of DH parameter sizes by[ssl-enum-ciphers](https://nmap.org/nsedoc/scripts/ssl-enum-ciphers.html). The number shown was the length in bytes, not bits
...
* Our Windows Nmap packages are now compiled with the older platform
  toolset (v120\_xp rather than v120) and so they may work with Windows
  XP again for the dwindling number of users still on that operating
  system.
* [[GH#34]](https://nmap.org/changelog.html#34)Disable TPACKET\_V3 in our included libpcap. This version of
  the Linux kernel packet ring API has problems that result in lots of
  lost packets. This patch falls back to TPACKET\_V2 or earlier
  versions if available. [nnposter]
* [NSE]Check for socket errors in [iscsi.lua](https://nmap.org/nsedoc/lib/iscsi.html). This was causing the[iscsi-info](https://nmap.org/nsedoc/scripts/iscsi-info.html) script to crash against some services. [Daniel Miller]
* [NSE]Fix [http-useragent-tester](https://nmap.org/nsedoc/scripts/http-useragent-tester.html), which was using cached HTTP
...
* Add a fatal error for options like -oG- which is interpreted as the
  ...
  Miller]
* [[GH#196]](https://issues.nmap.org/196)Fix raw packet sending on FreeBSD 10.0 and later. FreeBSD
  ...
  [GH#50] by Olli Hauer.
* [[GH#183]](https://issues.nmap.org/183)Fix compilation on Visual Studio 2010, which failed with
  error: "service\_scan.cc(2559): error C2065: 'EOPNOTSUPP' :
  undeclared identifier" [Daniel Miller]
* [[GH#115]](https://issues.nmap.org/115)[NSE][ssl-enum-ciphers](https://nmap.org/nsedoc/scripts/ssl-enum-ciphers.html) will still produce output if OpenSSL
...
### Nmap 6.49BETA4 [2015-07-06] [§](https://nmap.org/changelog.html#6.49BETA4) ###
...
* Fix a hang on OS X in Zenmap's Topology page with error
  ...
  [http://seclists.org/nmap-dev/2015/q3/8](http://seclists.org/nmap-dev/2015/q3/8) [Daniel Miller]
...
* Allow 'make check' to succeed when Nmap is configured without OpenSSL
  support. This was broken due to our NSE [unittest](https://nmap.org/nsedoc/scripts/unittest.html) library expecting to be able
  to load every library without error. [Daniel Miller]
* [NSE]Enable [ssl-enum-ciphers](https://nmap.org/nsedoc/scripts/ssl-enum-ciphers.html) to safely scan servers with a long handshake
...
* [NSE][[GH#168]](https://issues.nmap.org/168)Allow [ssl-enum-ciphers](https://nmap.org/nsedoc/scripts/ssl-enum-ciphers.html) to run on non-typical ports when it is
...
### Nmap 6.49BETA3 [2015-06-25] [§](https://nmap.org/changelog.html#6.49BETA3) ###

* [[GH#166]](https://issues.nmap.org/166)Fix Ncat listen mode on Solaris and other platforms where struct sockaddr
  does not have a sa\_len member. This also affected use of the -p and -s
  options. Brandon Haberfeld reported the crash. [Daniel Miller]
* [[GH#164]](https://issues.nmap.org/164)Fix a Zenmap failure ot open on OS X with the error:
  "dyld: Symbol not found: \_iconv Referenced from: /usr/lib/libcups.2.dylib"
  We had to remove the DYLD\_LIBRARY\_PATH environment variable from
  zenmap\_wrapper.py. Reported by Robert Strom. [Daniel Miller]
* Report our https URL ([Home page](https://nmap.org/)) in more places rather than
  our non-SSL one. [David Fifield]
* [NSE]Fix Diffie-Hellman parameter extraction in [tls.lua](https://nmap.org/nsedoc/lib/tls.html). [Jacob Gajek]

### Nmap 6.49BETA2 [2015-06-16] [§](https://nmap.org/changelog.html#6.49BETA2) ###

* [[GH#154]](https://issues.nmap.org/154)Fix a crash (assertion error) when Nmap receives an ICMP Host
  Unreachable message.
* [[GH#158]](https://issues.nmap.org/158)Fix a configure failure when Python is not present, but no Python
  projects were requested. [Gioacchino Mazzurco]
* [[GH#161]](https://issues.nmap.org/161)[Zenmap]Fix Zenmap on OS X which was failing with
  zipimport.ZipImportError due to architecture mismatch.
* [NSE]Remove ahbl.org checks from [dnsbl.lua](https://nmap.org/nsedoc/lib/dnsbl.html), since the service was shut down.
  [Forrest B.]

### Nmap 6.49BETA1 [2015-06-03] [§](https://nmap.org/changelog.html#6.49BETA1) ###
...
* Integrated all of your IPv4 OS fingerprint submissions from May 2014 to
  ...
  FreeBSD 10.1, OpenBSD 5.6, and more. Highlights:[http://seclists.org/nmap-dev/2015/q2/169](http://seclists.org/nmap-dev/2015/q2/169) [Daniel Miller]
* Integrated all of your service/version detection fingerprints submitted from
  ...
  telnet, and ftp to jute, bgp, and slurm. Highlights:[http://seclists.org/nmap-dev/2015/q2/171](http://seclists.org/nmap-dev/2015/q2/171) [Daniel Miller]
* Integrated all of your IPv6 OS fingerprint submissions from June 2013 to
  ...
  new total to 90. Highlights: [http://seclists.org/nmap-dev/2015/q2/170](http://seclists.org/nmap-dev/2015/q2/170) [Daniel
  Miller]
* Nmap now has an official bug tracker! We are using Github Issues, which you
  can reach from [http://issues.nmap.org/](http://issues.nmap.org/). We welcome your bug reports,
  enhancement requests, and code submissions via the Issues and Pull Request
  features of Github ([https://github.com/nmap/nmap](https://github.com/nmap/nmap)), though the repository
...
* Enhance Nmap's tcpwrapped service detection by using a shorter timeout for
  ...
  discussion: [http://issues.nmap.org/39](http://issues.nmap.org/39) [nnposter, Daniel Miller]
* All nmap.org pages are now available SSL-secured to improve privacy
  ...
  sure to download from [https://nmap.org/download.html](https://nmap.org/download.html) . We will soon
  remove the non-SSL version of the site. We still offer GPG-signed
  binaries as well: [https://nmap.org/book/install.html#inst-integrity](https://nmap.org/book/install.html#inst-integrity)
* [NSE]Added 25 NSE scripts from 17 authors, bringing the total up to 494!
  They are all listed at [https://nmap.org/nsedoc/](https://nmap.org/nsedoc/), and the summaries are below
  (authors are listed in brackets):
  * [bacnet-info](https://nmap.org/nsedoc/scripts/bacnet-info.html) gets device information from SCADA/ICS devices via BACnet
    (Building Automation and Control Networks) [Stephen Hilt, Michael Toecker]
  * [docker-version](https://nmap.org/nsedoc/scripts/docker-version.html) detects and fingerprints Docker [Claudio Criscione]
  * [enip-info](https://nmap.org/nsedoc/scripts/enip-info.html) gets device information from SCADA/ICS devices via EtherNet/IP
    [Stephen Hilt]
  * [fcrdns](https://nmap.org/nsedoc/scripts/fcrdns.html) performs a Forward-confirmed Reverse DNS lookup and reports
    anomalous results. [Daniel Miller]
  * [http-avaya-ipoffice-users](https://nmap.org/nsedoc/scripts/http-avaya-ipoffice-users.html) enumerates users in Avaya IP Office 7.x systems.
    [Paulino Calderon]
  * [http-cisco-anyconnect](https://nmap.org/nsedoc/scripts/http-cisco-anyconnect.html) gets version and tunnel information from Cisco SSL
  ...
  * [http-shellshock](https://nmap.org/nsedoc/scripts/http-shellshock.html) detects web applications vulnerable to Shellshock
    (CVE-2014-6271). [Paulino Calderon]
  * [http-vuln-cve2006-3392](https://nmap.org/nsedoc/scripts/http-vuln-cve2006-3392.html) exploits a file disclosure vulnerability in Webmin.
    [Paul AMAR]
  * [http-vuln-cve2014-2126](https://nmap.org/nsedoc/scripts/http-vuln-cve2014-2126.html), [http-vuln-cve2014-2127](https://nmap.org/nsedoc/scripts/http-vuln-cve2014-2127.html), [http-vuln-cve2014-2128](https://nmap.org/nsedoc/scripts/http-vuln-cve2014-2128.html) and[http-vuln-cve2014-2129](https://nmap.org/nsedoc/scripts/http-vuln-cve2014-2129.html) detect specific vulnerabilities in Cisco AnyConnect
    SSL VPNs. [Patrik Karlsson]
  * [http-vuln-cve2015-1427](https://nmap.org/nsedoc/scripts/http-vuln-cve2015-1427.html) detects Elasticsearch servers vulnerable to remote
    code execution. [Gyanendra Mishra]
  * [http-vuln-cve2015-1635](https://nmap.org/nsedoc/scripts/http-vuln-cve2015-1635.html) detects Microsoft Windows systems vulnerable to
    MS15-034. [Paulino Calderon]
  * [http-vuln-misfortune-cookie](https://nmap.org/nsedoc/scripts/http-vuln-misfortune-cookie.html) detects the "Misfortune Cookie" vulnerability
    in Allegro RomPager 4.07, commonly used in SOHO routers for TR-069 access.
    [Andrew Orr]
  * http-wordpress-plugins was renamed [http-wordpress-enum](https://nmap.org/nsedoc/scripts/http-wordpress-enum.html) and extended to
    enumerate both plugins and themes of Wordpress installations and their
    versions. [http-wordpress-enum](https://nmap.org/nsedoc/scripts/http-wordpress-enum.html) is now [http-wordpress-users](https://nmap.org/nsedoc/scripts/http-wordpress-users.html). [Paulino Calderon]
  * [mikrotik-routeros-brute](https://nmap.org/nsedoc/scripts/mikrotik-routeros-brute.html) performs password auditing attacks against
    Mikrotik's RouterOS API. [Paulino Calderon]
  * [omron-info](https://nmap.org/nsedoc/scripts/omron-info.html) gets device information from Omron PLCs via the FINS service.
    [Stephen Hilt]
  * [s7-info](https://nmap.org/nsedoc/scripts/s7-info.html) gets device information from Siemens PLCs via the S7 service,
    tunneled over ISO-TSAP on TCP port 102. [Stephen Hilt]
  * [snmp-info](https://nmap.org/nsedoc/scripts/snmp-info.html) gets the enterprise number and other information from the
    snmpEngineID in an SNMPv3 response packet. [Daniel Miller]
  * [ssl-ccs-injection](https://nmap.org/nsedoc/scripts/ssl-ccs-injection.html) detects whether a server is vulnerable to the SSL/TLS
    CCS Injection vulnerability (CVE-2014-0224) [Claudiu Perta]
  * [ssl-poodle](https://nmap.org/nsedoc/scripts/ssl-poodle.html) detects the POODLE bug in SSLv3 (CVE-2014-3566) [Daniel Miller]
  * [supermicro-ipmi-conf](https://nmap.org/nsedoc/scripts/supermicro-ipmi-conf.html) exploits Supermicro IPMI/BMC controllers. [Paulino
    Calderon]
  * [targets-ipv6-map4to6](https://nmap.org/nsedoc/scripts/targets-ipv6-map4to6.html) generates target IPv6 addresses which correspond to
    IPv4 addresses mapped within a particular IPv6 subnet. [Raúl Fuentes]
  * [targets-ipv6-wordlist](https://nmap.org/nsedoc/scripts/targets-ipv6-wordlist.html) generates target IPv6 addresses from a wordlist made
...
* Fix a bug in libdnet-stripped on Solaris that resulted in the wrong MAC
  address being detected for all interfaces.[http://seclists.org/nmap-dev/2015/q2/1](http://seclists.org/nmap-dev/2015/q2/1) [Daniel Miller]
...
* [NSE]Rework [ssl-enum-ciphers](https://nmap.org/nsedoc/scripts/ssl-enum-ciphers.html) to actually score the strength of the SSL/TLS
...
* [NSE]Improved [http-form-brute](https://nmap.org/nsedoc/scripts/http-form-brute.html) autodetection and behavior to handle more
...
* [NSE]Remove db2-discover, as its functionality was performed by service
  version detection since the broadcast portion was separated into[broadcast-db2-discover](https://nmap.org/nsedoc/scripts/broadcast-db2-discover.html). [http://seclists.org/nmap-dev/2014/q3/415](http://seclists.org/nmap-dev/2014/q3/415) [Daniel
  Miller]
...
* [NSE]Make [smb-ls](https://nmap.org/nsedoc/scripts/smb-ls.html) able to leverage results from [smb-enum-shares](https://nmap.org/nsedoc/scripts/smb-enum-shares.html) or list of
...
* Handle a bunch of socket errors that can result from odd ICMP Type 3
  ...
  reported was "Unexpected error in NSE\_TYPE\_READ callback. Error code: 92
...
* Change the URI for the fingerprint submitter to its new location at[https://nmap.org/cgi-bin/submit.cgi](https://nmap.org/cgi-bin/submit.cgi)
* [NSE]Added a check for Cisco ASA version disclosure, CVE-2014-3398, to[http-enum](https://nmap.org/nsedoc/scripts/http-enum.html) in the 'security' category [Daniel Miller]
* Fixed a bug that caused Nmap to fail to find any network interface when a
  ...
  ARP\_HRD\_IEEE80211\_PRISM header identifier in the libdnet-stripped code.
  [Brad Johnson]
* Added a version probe for Tor. [David Fifield]
* [NSE]Add support to [citrix-enum-apps-xml](https://nmap.org/nsedoc/scripts/citrix-enum-apps-xml.html) for reporting if Citrix
  ...
  [Tom Sellers]
* [NSE]Updated our Wordpress plugin list to improve the[http-wordpress-enum](https://nmap.org/nsedoc/scripts/http-wordpress-enum.html) NSE script. We can now detect 34,077 plugins,
  up from 18,570. [Danila Poyarkov]
* [NSE]Add the signature algorithm that was used to sign the target port's
  x509 certificate to the output of [ssl-cert](https://nmap.org/nsedoc/scripts/ssl-cert.html).nse [Tom Sellers]
* [NSE]Fixed a bug in the [sslcert.lua](https://nmap.org/nsedoc/lib/sslcert.html) library that was triggered against
  certain services when version detection was used. [Tom Sellers]
* [NSE]vulns.Report:make\_output() now generates XML structured output
  reports automatically. [Paulino Calderon]
* [NSE]Add port.reason\_ttl, host.reason, host.reason\_ttl for use in scripts
  [Jay Bosamiya]
* [NSE]If a version script is run by name, nmap.version\_intensity() returns
  the maximum value (9) for it [Jay Bosamiya]
* [NSE]shortport.version\_port\_or\_service() takes an optional rarity parameter
  now to run only when version intensity \> rarity [Jay Bosamiya]
* [NSE]Added nmap.version\_intensity() function so that NSE version scripts
...
* Improvements to [whois-ip](https://nmap.org/nsedoc/scripts/whois-ip.html).nse: fix an unhandled error when a referred-to
...
* Integrated all of your IPv4 OS fingerprint submissions since June 2013
  ...
  Highlights: [http://seclists.org/nmap-dev/2014/q3/325](http://seclists.org/nmap-dev/2014/q3/325) [Daniel Miller]
...
* [Ndiff]Fixed the ndiff.bat wrapper in the zipfile Windows distribution,
  which was giving the error, "\\Microsoft was unexpected at this time." See[https://support.microsoft.com/kb/2524009](https://support.microsoft.com/kb/2524009) [Daniel Miller]
...
* Handle ICMP admin-prohibited messages when doing service version detection.
  Crash reported by Nathan Stocks was: Unexpected error in NSE\_TYPE\_READ
...
* [NSE]Made numerous improvements to [ssl-heartbleed](https://nmap.org/nsedoc/scripts/ssl-heartbleed.html) to provide
...
* [NSE]Fix some bugs which could cause [snmp-ios-config](https://nmap.org/nsedoc/scripts/snmp-ios-config.html) and[snmp-sysdescr](https://nmap.org/nsedoc/scripts/snmp-sysdescr.html) scripts to crash
  ([http://seclists.org/nmap-dev/2014/q2/120](http://seclists.org/nmap-dev/2014/q2/120)) [Patrik Karlsson]
...
* Fixed some syntax problems in nmap-os-db that were caused by some automated
  merging of fingerprints ([http://seclists.org/nmap-dev/2013/q4/68](http://seclists.org/nmap-dev/2013/q4/68)) [Daniel
  Miller]
...
* [NSE]Convert many more scripts to emit structured XML output
  ([https://nmap.org/book/nse-api.html#nse-structured-output](https://nmap.org/book/nse-api.html#nse-structured-output)) [Daniel Miller]
* [NSE]Added 24 NSE scripts from 12 authors, bringing the total up to 470.
  They are all listed at [https://nmap.org/nsedoc/](https://nmap.org/nsedoc/), and the summaries are
  below (authors are listed in brackets):
  * [allseeingeye-info](https://nmap.org/nsedoc/scripts/allseeingeye-info.html) gathers information from games using this query protocol.
    A version detection probe was also added. [Marin Maržić]
  * [freelancer-info](https://nmap.org/nsedoc/scripts/freelancer-info.html) gathers information about the Freelancer game server. Also
    added a related version detection probe and UDP protocol payload for
    detecting the service. [Marin Maržić]
  * [http-csrf](https://nmap.org/nsedoc/scripts/http-csrf.html) detects Cross Site Request Forgeries (CSRF) vulnerabilities by
    searching for CSRF tokens in HTML forms. [George Chatzisofroniou]
  * [http-devframework](https://nmap.org/nsedoc/scripts/http-devframework.html) finds out the technology behind the target website based
    on HTTP headers, static URLs, and other content and resources. [George
    Chatzisofroniou]
  * [http-dlink-backdoor](https://nmap.org/nsedoc/scripts/http-dlink-backdoor.html) detects DLink routers with firmware backdoor allowing
    admin access over HTTP interface. [Patrik Karlsson]
  * [http-dombased-xss](https://nmap.org/nsedoc/scripts/http-dombased-xss.html) finds potential DOM-based Cross-site Scripting (XSS)
    vulnerabilities by searching for specific patterns in JavaScript resources.
    [George Chatzisofroniou]
  * [http-errors](https://nmap.org/nsedoc/scripts/http-errors.html) crawls for URIs that return error status codes (HTTP 400 and
    above). [George Chatzisofroniou]
  * [http-feed](https://nmap.org/nsedoc/scripts/http-feed.html) crawls a web site for Atom and RSS feeds. [George Chatzisofroniou]
  * [http-iis-short-name-brute](https://nmap.org/nsedoc/scripts/http-iis-short-name-brute.html) detects Microsoft IIS servers vulnerable to a
  ...
  * [http-mobileversion-checker](https://nmap.org/nsedoc/scripts/http-mobileversion-checker.html) checks for mobile versions of web pages by
    setting an Android User-Agent header and checking for HTTP redirects.
    [George Chatzisofroniou]
  * [http-ntlm-info](https://nmap.org/nsedoc/scripts/http-ntlm-info.html) gets server information from Web servers that require NTLM
    authentication. [Justin Cacak]
  * [http-referer-checker](https://nmap.org/nsedoc/scripts/http-referer-checker.html) finds JavaScript resources that are included from other
    domains, increasing a website's attack surface. [George Chatzisofroniou]
  * [http-server-header](https://nmap.org/nsedoc/scripts/http-server-header.html) grabs the Server header as a last-ditch effort to get a
  ...
  * [http-useragent-tester](https://nmap.org/nsedoc/scripts/http-useragent-tester.html) checks for sites that redirect common Web spider
    User-Agents to a different page than browsers get. [George Chatzisofroniou]
  * [http-vuln-cve2013-7091](https://nmap.org/nsedoc/scripts/http-vuln-cve2013-7091.html) (released as http-vuln-zimbra-lfi) looks for
    CVE-2013-7091, a LFI vulnerability in Zimbra. [Paul AMAR, Ron Bowes]
  * [http-xssed](https://nmap.org/nsedoc/scripts/http-xssed.html) searches the xssed.com database of Cross-site Scripting
    vulnerabilities for previously-reported XSS vulnerabilities in the target.
    [George Chatzisofroniou]
  * [qconn-exec](https://nmap.org/nsedoc/scripts/qconn-exec.html) tests the QNX QCONN service for remote command execution.
    [Brendan Coles]
  * [quake1-info](https://nmap.org/nsedoc/scripts/quake1-info.html) retrieves server and player information from Quake 1 game
    servers. Reports potential DoS amplification factor. [Ulrik Haugen]
  * [rfc868-time](https://nmap.org/nsedoc/scripts/rfc868-time.html) gets the date and time from an RFC 868 Time server. [Daniel
    Miller]
  * [ssl-heartbleed](https://nmap.org/nsedoc/scripts/ssl-heartbleed.html) detects the Heartbleed bug in OpenSSL CVE-2014-0160 [Patrik
    Karlsson]
  * [sstp-discover](https://nmap.org/nsedoc/scripts/sstp-discover.html) discovers Microsoft's Secure Socket Tunnelling Protocol
    ([http://msdn.microsoft.com/en-us/library/cc247338.aspx](http://msdn.microsoft.com/en-us/library/cc247338.aspx)) [Niklaus Schiess]
  * [unittest](https://nmap.org/nsedoc/scripts/unittest.html) runs unit tests found in NSE libraries. The corresponding[unittest.lua](https://nmap.org/nsedoc/lib/unittest.html) library has examples. Run `nmap --script=[unittest](https://nmap.org/nsedoc/scripts/unittest.html)--script-args=[unittest](https://nmap.org/nsedoc/scripts/unittest.html).run -d` to run the tests. [Daniel Miller]
  * [weblogic-t3-info](https://nmap.org/nsedoc/scripts/weblogic-t3-info.html) detects the T3 RMI protocol used by Oracle/BEA Weblogic
    and extracts the Weblogic version. [Alessandro Zanni, Daniel Miller]
  * [whois-ip](https://nmap.org/nsedoc/scripts/whois-ip.html) and [whois-domain](https://nmap.org/nsedoc/scripts/whois-domain.html) replace the whois script, which previously could
    only collect whois info for IP addresses. [George Chatzisofroniou]

* [NSE]Fixed an error-handling bug in [socks-open-proxy](https://nmap.org/nsedoc/scripts/socks-open-proxy.html) that caused it to fail
  when scanning a SOCKS4-only proxy. Reported on IRC by Husky. [Daniel Miller]
* [NSE]Improved [ntp-info](https://nmap.org/nsedoc/scripts/ntp-info.html) script to handle underscores in returned
  data. [nnposter]
* [NSE]Add [unicode](https://nmap.org/nsedoc/lib/unicode.html) library for decoding and encoding UTF-8, UTF-16, CP437 and
...
* Added TCP support to [dns.lua](https://nmap.org/nsedoc/lib/dns.html). [John Bond]
* Added safe fd\_set operations. This makes nmap fail gracefully instead of
  crashing when the number of file descriptors grows over FD\_SETSIZE. Jacek
  Wielemborek reported the crash. [Henri Doreau]
* [NSE]Added [tls](https://nmap.org/nsedoc/lib/tls.html) library for functions related to SSLv3 and TLS messages.
  Existing [ssl-enum-ciphers](https://nmap.org/nsedoc/scripts/ssl-enum-ciphers.html), [ssl-date](https://nmap.org/nsedoc/scripts/ssl-date.html), and [tls-nextprotoneg](https://nmap.org/nsedoc/scripts/tls-nextprotoneg.html) scripts were
  updated to use this library. [Daniel Miller]
* Added NSE and Zenmap unit tests to "make check" [Daniel Miller]
* [NSE]Enable [http-enum](https://nmap.org/nsedoc/scripts/http-enum.html) to use the large Nikto fingerprint database at runtime
...
* Fixed a bug in libdnet with handling interfaces with AF\_LINK addresses on
...
* [NSE]Removed a fixed value (28428) which was being set for the Request ID in
  the snmpWalk library function; a value based on nmap.clock\_ms will now be set
  instead. [jah]
...
* [NSE]Made [telnet-brute](https://nmap.org/nsedoc/scripts/telnet-brute.html) support multiple parallel guessing threads,
  reuse connections, and support password-only logins. [nnposter]
* [NSE]Made the table returned by ssh1.fetch\_host\_key contain a "key"
  element, like that of ssh2.fetch\_host\_key. This fixed a crash in the[ssh-hostkey](https://nmap.org/nsedoc/scripts/ssh-hostkey.html) script reported by Dan Farmer and Florian Pelgrim. The
  "key" element of ssh2.fetch\_host\_key now is base64-encoded, to match
  the format used by the known\_hosts file. [David Fifield]
...
* [NSE]Update [dns-cache-snoop](https://nmap.org/nsedoc/scripts/dns-cache-snoop.html) script to use a new list of top 50
...
* [Zenmap]Fixed a crash that would happen when you entered a search
  ...
  'FilteredNetworkInventory' object has no attribute 'match\_'".
  Reported by Kris Paernell. [David Fifield]
* [Ncat]Added NCAT\_PROTO, NCAT\_REMOTE\_ADDR, NCAT\_REMOTE\_PORT, NCAT\_LOCAL\_ADDR
  and NCAT\_LOCAL\_PORT environment variables being set in all --\*-exec child
  processes.
...
* [Ncat]Added --lua-exec. This feature is basically the equivalent of 'ncat
  ...
  redirecting all stdin and stdout operations to the socket connection. See[https://nmap.org/book/ncat-man-command-options.html](https://nmap.org/book/ncat-man-command-options.html) [Jacek Wielemborek]
* Integrated all of your IPv4 OS fingerprint submissions since January
  ...
  Many existing fingerprints were improved. Highlights:[http://seclists.org/nmap-dev/2013/q2/518](http://seclists.org/nmap-dev/2013/q2/518). [David Fifield]
* Integrated all of your service/version detection fingerprints submitted
  ...
  enemyterritory. Highlights:[http://seclists.org/nmap-dev/2013/q3/80](http://seclists.org/nmap-dev/2013/q3/80). [David Fifield]
* Integrated your latest IPv6 OS submissions and corrections. We're still
  ...
  administer and submit them to [https://nmap.org/submit/](https://nmap.org/submit/). Both new
...
* [Nsock]Added initial proxy support to Nsock. Nmap version detection
  ...
  chain of one or more proxies as the argument (example:[http://localhost:8080](http://localhost:8080/),socks4://someproxy.example.com). Note that
...
* [NSE]Added 14 NSE scripts from 6 authors, bringing the total up to 446.
  ...
  * hostmap-ip2hosts finds hostnames that resolve to the target's IP address
    by querying the online database at [http://www.ip2hosts.com](http://www.ip2hosts.com/) (uses Bing
    search results) [Paulino Calderon]
  * [http-adobe-coldfusion-apsa1301](https://nmap.org/nsedoc/scripts/http-adobe-coldfusion-apsa1301.html) attempts to exploit an authentication
    bypass vulnerability in Adobe Coldfusion servers (APSA13-01:[http://www.adobe.com/support/security/advisories/apsa13-01.html](http://www.adobe.com/support/security/advisories/apsa13-01.html)) to
    retrieve a valid administrator's session cookie. [Paulino Calderon]
  * [http-coldfusion-subzero](https://nmap.org/nsedoc/scripts/http-coldfusion-subzero.html) attempts to retrieve version, absolute path of
  ...
  * [http-comments-displayer](https://nmap.org/nsedoc/scripts/http-comments-displayer.html) extracts and outputs HTML and JavaScript
    comments from HTTP responses. [George Chatzisofroniou]
  * [http-fileupload-exploiter](https://nmap.org/nsedoc/scripts/http-fileupload-exploiter.html) exploits insecure file upload forms in web
  ...
  * [http-phpmyadmin-dir-traversal](https://nmap.org/nsedoc/scripts/http-phpmyadmin-dir-traversal.html) exploits a directory traversal
  ...
  * [http-stored-xss](https://nmap.org/nsedoc/scripts/http-stored-xss.html) posts specially crafted strings to every form it
  ...
  * [http-vuln-cve2013-0156](https://nmap.org/nsedoc/scripts/http-vuln-cve2013-0156.html) detects Ruby on Rails servers vulnerable to
    object injection, remote command executions and denial of service
    attacks. (CVE-2013-0156) [Paulino Calderon]
  * [ike-version](https://nmap.org/nsedoc/scripts/ike-version.html) obtains information (such as vendor and device type where
  ...
  * [murmur-version](https://nmap.org/nsedoc/scripts/murmur-version.html) detects the Murmur service (server for the Mumble voice
    communication client) versions 1.2.X. [Marin Maržić]
  * [mysql-enum](https://nmap.org/nsedoc/scripts/mysql-enum.html) performs valid-user enumeration against MySQL server using a
    bug discovered and published by Kingcope
    ([http://seclists.org/fulldisclosure/2012/Dec/9](http://seclists.org/fulldisclosure/2012/Dec/9)). [Aleksandar Nikolic]
  * [teamspeak2-version](https://nmap.org/nsedoc/scripts/teamspeak2-version.html) detects the TeamSpeak 2 voice communication server
    and attempts to determine version and configuration information. [Marin
    Maržić]
  * [ventrilo-info](https://nmap.org/nsedoc/scripts/ventrilo-info.html) detects the Ventrilo voice communication server service
    versions 2.1.2 and above and tries to determine version and
    configuration information. [Marin Maržić]

* Updated the Nmap license agreement to close some loopholes and stop some
  ...
  year--[http://insecure.org/news/download-com-fiasco.html](http://insecure.org/news/download-com-fiasco.html) . The updated
  license is in the all the normal places, including[https://svn.nmap.org/nmap/COPYING](https://svn.nmap.org/nmap/COPYING).
* [NSE][SECURITY]Oops, there was a vulnerability in one of our 437 NSE scripts. If
  you ran the (fortunately non-default) [http-domino-enum-passwords](https://nmap.org/nsedoc/scripts/http-domino-enum-passwords.html) script
  ...
  stdnse.filename\_escape function for extra safety. This breaks our record
...
* [Ncat]Ncat now support chained certificates with the --[ssl-cert](https://nmap.org/nsedoc/scripts/ssl-cert.html)option. [Greg Bailey]
...
* Stop parsing TCP options after reaching EOL in libnetutil. Bug reported by
  Gustavo Moreira. [Henri Doreau]
* [NSE]The [dns-ip6-arpa-scan](https://nmap.org/nsedoc/scripts/dns-ip6-arpa-scan.html) script now optionally accepts "/" syntax for a
  network mask. Based on a patch by Indula Nayanamith.
* [Ncat]Reduced the default --max-conns limit from 100 to 60 on Windows, to
  stay within platform limitations. Suggested by Andrey Olkhin.
* Fixed IPv6 routing table alignment on NetBSD.
* Fixed our NSEDoc system so the author field uses UTF-8 and we can spell
  people's name properly, even if they use crazy non-ASCII characters like
  Marin Maržić. [David Fifield]
* UDP protocol payloads were added for detecting the Murmer service (a
  server for the Mumble voice communication client) and TeamSpeak 2 VoIP
  software.
* [NSE]Added [http-phpmyadmin-dir-traversal](https://nmap.org/nsedoc/scripts/http-phpmyadmin-dir-traversal.html) by Alexey Meshcheryakov.
* Updated libdnet to not SIOCIFNETMASK before SIOCIFADDR on OpenBSD. This
...
* [Zenmap]Fixed internationalization files. Running in a language other
  than the default English would result in the error "ValueError: too many
  values to unpack". [David Fifield]
* [NSE]Updated the included Liblua from version 5.2.1 to 5.2.2. [Patrick
  Donnelly]
* [Nsock]Added a minimal regression test suite for Nsock. [Henri Doreau]
* [NSE]Updated the [redis-brute](https://nmap.org/nsedoc/scripts/redis-brute.html) and [redis-info](https://nmap.org/nsedoc/scripts/redis-info.html) scripts to work against the
  latest versions of redis server. [Henri Doreau]
* [Ncat]Fixed errors in connecting to IPv6 proxies. [Joachim Henke]
* [NSE]Updated [hostmap-bfk](https://nmap.org/nsedoc/scripts/hostmap-bfk.html) to work with the latest version of their website
  (bfk.de). [Paulino Calderon]
* [NSE]Added XML structured output support to:
  * [xmpp-info](https://nmap.org/nsedoc/scripts/xmpp-info.html), [irc-info](https://nmap.org/nsedoc/scripts/irc-info.html), [sslv2](https://nmap.org/nsedoc/scripts/sslv2.html), [address-info](https://nmap.org/nsedoc/scripts/address-info.html) [Daniel Miller]
  * [hostmap-bfk](https://nmap.org/nsedoc/scripts/hostmap-bfk.html), [hostmap-robtex](https://nmap.org/nsedoc/scripts/hostmap-robtex.html), hostmap-ip2hosts. [Paulino Calderon]
  * [http-git](https://nmap.org/nsedoc/scripts/http-git.html).nse. [Alex Weber]
...
* [NSE]Rewrote [telnet-brute](https://nmap.org/nsedoc/scripts/telnet-brute.html) for better compatibility with a variety of
  telnet servers. [nnposter]
* Fixed a regression that changed the number of delimiters in machine
  output. [Daniel Miller]
* Fixed a regression in [broadcast-dropbox-listener](https://nmap.org/nsedoc/scripts/broadcast-dropbox-listener.html) which prevented it from
...
* Add new decoders (BROWSER, DHCP6 and LLMNR) to [broadcast-listener](https://nmap.org/nsedoc/scripts/broadcast-listener.html) and
...
* Namespace the pipes used to communicate with subprocesses by PID, to avoid
  ...
  Andrey Olkhin.
* [NSE]Changed [ip-geolocation-geoplugin](https://nmap.org/nsedoc/scripts/ip-geolocation-geoplugin.html) to use the web service's new output
  format. Reported by Robin Wood.
* Limited the number of open sockets in ultra\_scan to FD\_SETSIZE. Very fast
  connect scans could write past the end of an fd\_set and cause a variety of
  crashes:
...
* Fixed a bug that prevented Nmap from finding any interfaces when one of
  them had the type ARP\_HDR\_APPLETALK; this was the case for AppleTalk
  ...
  '--send-ip' switch and to the following thread:[http://seclists.org/nmap-dev/2013/q1/214](http://seclists.org/nmap-dev/2013/q1/214). This bug was reported by Steven
...
* [Zenmap]Zenmap now understands the NMAP\_PRIVILEGED and NMAP\_UNPRIVILEGED
  environment variables. [Tyler Wagner]
* Added an ncat\_assert macro. This is similar to assert(), but remains even
...
* Changed the --webxml XSL stylesheet to point to the new location of
  nmap.xsl in the new repository ([https://svn.nmap.org/nmap/docs/nmap.xsl](https://svn.nmap.org/nmap/docs/nmap.xsl)).
  It still may not work in web browsers due to same origin policy (see[http://seclists.org/nmap-dev/2013/q1/58](http://seclists.org/nmap-dev/2013/q1/58)). [David Fifield, Simon John]
...
* [Nsock]Reworked the logging infrastructure to make it more flexible and
  ...
  Fifield]
* [NSE]Fixed scripts using unconnected UDP sockets. The bug was reported by
  Dhiru Kholia at [http://seclists.org/nmap-dev/2012/q4/422](http://seclists.org/nmap-dev/2012/q4/422). [David Fifield]
...
* Clean up the source code a bit to resolve some false positive issues
  ...
  runs this on programs (including Nmap) that they ship with Solaris. See[http://seclists.org/nmap-dev/2012/q4/504](http://seclists.org/nmap-dev/2012/q4/504). [David Fifield]
...
* [Ncat]Made test-addrset.sh exit with nonzero status if any tests
  ...
  [Andreas Stieger]
* Fixed compilation with --without-liblua. The bug was reported by Rick
...
* [NSE]Added multicast group name output to[broadcast-igmp-discovery](https://nmap.org/nsedoc/scripts/broadcast-igmp-discovery.html).nse. [Vasily Kulikov]
* [NSE]Added new fingerprints for [http-enum](https://nmap.org/nsedoc/scripts/http-enum.html): Sitecore, Moodle, typo3,
  SquirrelMail, RoundCube. [Jesper Kückelhahn]

### Nmap 6.25 [2012-11-29] [§](https://nmap.org/changelog.html#6.25) ###

* [NSE]Added CPE to [smb-os-discovery](https://nmap.org/nsedoc/scripts/smb-os-discovery.html) output.
...
### Nmap 6.20BETA1 [2012-11-16] [§](https://nmap.org/changelog.html#6.20BETA1) ###
...
* Integrated your latest IPv6 OS submissions and corrections. We're
  ...
  own or administer and submit them to [https://nmap.org/submit/](https://nmap.org/submit/). Both
...
* Scripts can now return a structured name-value table so that results
  ...
  See [https://nmap.org/book/nse-api.html#nse-structured-output](https://nmap.org/book/nse-api.html#nse-structured-output) [Daniel
...
* Moved some Windows dependencies, including OpenSSL, libsvn, and the
  ...
  /nmap-mswin32-aux along with /nmap as described at[https://nmap.org/book/inst-windows.html#inst-win-source](https://nmap.org/book/inst-windows.html#inst-win-source).
* Many of the great features in this release were created by college
  ...
  of five developers is introduced at[http://seclists.org/nmap-dev/2012/q2/204](http://seclists.org/nmap-dev/2012/q2/204) and their successes
  documented at [http://seclists.org/nmap-dev/2012/q4/138](http://seclists.org/nmap-dev/2012/q4/138)
* [NSE]Replaced old RPC grinder (RPC enumeration, performed as part
  ...
  allowed us to remove the crufty old pos\_scan scan engine. [Hani
  Benhabiles]
* Updated our Nmap Scripting Engine to use Lua 5.2 (and then 5.2.1)
  rather than 5.1. See [http://seclists.org/nmap-dev/2012/q2/34](http://seclists.org/nmap-dev/2012/q2/34) for
  details. [Patrick Donnelly]
* [NSE]Added 85(!) NSE scripts, bringing the total up to 433. They
  are all listed at [https://nmap.org/nsedoc/](https://nmap.org/nsedoc/), and the summaries are
  below (authors are listed in brackets):
  * [ajp-auth](https://nmap.org/nsedoc/scripts/ajp-auth.html) retrieves the authentication scheme and realm of an AJP
  ...
  * [ajp-brute](https://nmap.org/nsedoc/scripts/ajp-brute.html) performs brute force passwords auditing against the
    Apache JServ protocol. [Patrik Karlsson]
  * [ajp-headers](https://nmap.org/nsedoc/scripts/ajp-headers.html) performs a HEAD or GET request against either the root
  ...
  * [ajp-methods](https://nmap.org/nsedoc/scripts/ajp-methods.html) discovers which options are supported by the AJP
    (Apache JServ Protocol) server by sending an OPTIONS request and
    lists potentially risky methods. [Patrik Karlsson]
  * [ajp-request](https://nmap.org/nsedoc/scripts/ajp-request.html) requests a URI over the Apache JServ Protocol and
  ...
  * [bjnp-discover](https://nmap.org/nsedoc/scripts/bjnp-discover.html) retrieves printer or scanner information from a
  ...
  * [broadcast-ataoe-discover](https://nmap.org/nsedoc/scripts/broadcast-ataoe-discover.html) discovers servers supporting the ATA over
    ...
    Karlsson]
  * [broadcast-bjnp-discover](https://nmap.org/nsedoc/scripts/broadcast-bjnp-discover.html) attempts to discover Canon devices
  ...
  * [broadcast-eigrp-discovery](https://nmap.org/nsedoc/scripts/broadcast-eigrp-discovery.html) performs network discovery and routing
    information gathering through Cisco's EIGRP protocol. [Hani
    Benhabiles]
  * [broadcast-igmp-discovery](https://nmap.org/nsedoc/scripts/broadcast-igmp-discovery.html) discovers targets that have IGMP
    Multicast memberships and grabs interesting information. [Hani
    Benhabiles]
  * [broadcast-pim-discovery](https://nmap.org/nsedoc/scripts/broadcast-pim-discovery.html) discovers routers that are running PIM
    (Protocol Independent Multicast). [Hani Benhabiles]
  * [broadcast-tellstick-discover](https://nmap.org/nsedoc/scripts/broadcast-tellstick-discover.html) discovers Telldus Technologies
  ...
  * [cassandra-brute](https://nmap.org/nsedoc/scripts/cassandra-brute.html) performs brute force password auditing against the
    Cassandra database. [Vlatko Kosturjak]
  * [cassandra-info](https://nmap.org/nsedoc/scripts/cassandra-info.html) attempts to get basic info and server status from a
    Cassandra database. [Vlatko Kosturjak]
  * [cups-info](https://nmap.org/nsedoc/scripts/cups-info.html) lists printers managed by the CUPS printing
    service. [Patrik Karlsson]
  * [cups-queue-info](https://nmap.org/nsedoc/scripts/cups-queue-info.html) Lists currently queued print jobs of the remote
    CUPS service grouped by printer. [Patrik Karlsson]
  * [dict-info](https://nmap.org/nsedoc/scripts/dict-info.html) Connects to a dictionary server using the DICT protocol,
    runs the SHOW SERVER command, and displays the result. [Patrik
    Karlsson]
  * [distcc-cve2004-2687](https://nmap.org/nsedoc/scripts/distcc-cve2004-2687.html) detects and exploits a remote code execution
    vulnerability in the distributed compiler daemon distcc. [Patrik
    Karlsson]
  * [dns-check-zone](https://nmap.org/nsedoc/scripts/dns-check-zone.html) checks DNS zone configuration against best
  ...
  * [dns-ip6-arpa-scan](https://nmap.org/nsedoc/scripts/dns-ip6-arpa-scan.html) performs a quick reverse DNS lookup of an IPv6
  ...
  * [dns-nsec3-enum](https://nmap.org/nsedoc/scripts/dns-nsec3-enum.html) tries to enumerate domain names from the DNS server
    that supports DNSSEC NSEC3 records. [Aleksandar Nikolic, John
    Bond]
  * [eppc-enum-processes](https://nmap.org/nsedoc/scripts/eppc-enum-processes.html) attempts to enumerate process info over the
  ...
  * [firewall-bypass](https://nmap.org/nsedoc/scripts/firewall-bypass.html) detects a vulnerability in Netfilter and other
    firewalls that use helpers to dynamically open ports for protocols
    such as ftp and sip. [Hani Benhabiles]
  * [flume-master-info](https://nmap.org/nsedoc/scripts/flume-master-info.html) retrieves information from Flume master HTTP
    pages. [John R. Bond]
  * [gkrellm-info](https://nmap.org/nsedoc/scripts/gkrellm-info.html) queries a GKRellM service for monitoring
    information. A single round of collection is made, showing a
    snapshot of information at the time of the request. [Patrik
    Karlsson]
  * [gpsd-info](https://nmap.org/nsedoc/scripts/gpsd-info.html) retrieves GPS time, coordinates and speed from the GPSD
    network daemon. [Patrik Karlsson]
  * [hostmap-robtex](https://nmap.org/nsedoc/scripts/hostmap-robtex.html) discovers hostnames that resolve to the target's IP
    address by querying the Robtex service at[http://www.robtex.com/dns/](http://www.robtex.com/dns/). [Arturo Busleiman]
  * [http-drupal-enum-users](https://nmap.org/nsedoc/scripts/http-drupal-enum-users.html) enumerates Drupal users by exploiting a an
  ...
  * [http-exif-spider](https://nmap.org/nsedoc/scripts/http-exif-spider.html) spiders a site's images looking for interesting
  ...
  * [http-form-fuzzer](https://nmap.org/nsedoc/scripts/http-form-fuzzer.html) performs a simple form fuzzing against forms
    ...
    Olma]
  * [http-frontpage-login](https://nmap.org/nsedoc/scripts/http-frontpage-login.html) checks whether target machines are vulnerable
    to anonymous Frontpage login. [Aleksandar Nikolic]
  * [http-git](https://nmap.org/nsedoc/scripts/http-git.html) checks for a Git repository found in a website's document
    ...
    Weber]
  * [http-gitweb-projects-enum](https://nmap.org/nsedoc/scripts/http-gitweb-projects-enum.html) retrieves a list of Git projects, owners
    and descriptions from a gitweb (web interface to the Git revision
    control system). [riemann]
  * [http-huawei-hg5xx-vuln](https://nmap.org/nsedoc/scripts/http-huawei-hg5xx-vuln.html) detects Huawei modems models HG530x,
  ...
  * [http-icloud-findmyiphone](https://nmap.org/nsedoc/scripts/http-icloud-findmyiphone.html) retrieves the locations of all "Find my
    iPhone" enabled iOS devices by querying the MobileMe web service
    (authentication required). [Patrik Karlsson]
  * [http-icloud-sendmsg](https://nmap.org/nsedoc/scripts/http-icloud-sendmsg.html) sends a message to a iOS device through the
    Apple MobileMe web service. The device has to be registered with
    an Apple ID using the Find My iPhone application. [Patrik
    Karlsson]
  * [http-phpself-xss](https://nmap.org/nsedoc/scripts/http-phpself-xss.html) crawls a web server and attempts to find PHP
    files vulnerable to reflected cross site scripting via the
    variable $\_SERVER["PHP\_SELF"]. [Paulino Calderon]
  * [http-rfi-spider](https://nmap.org/nsedoc/scripts/http-rfi-spider.html) crawls webservers in search of RFI (remote file
    inclusion) vulnerabilities. It tests every form field it finds and
    every parameter of a URL containing a query. [Piotr Olma]
  * [http-robtex-shared-ns](https://nmap.org/nsedoc/scripts/http-robtex-shared-ns.html) Finds up to 100 domain names which use the
    same name server as the target by querying the Robtex service at[http://www.robtex.com/dns/](http://www.robtex.com/dns/). [Arturo Busleiman]
  * [http-sitemap-generator](https://nmap.org/nsedoc/scripts/http-sitemap-generator.html) spiders a web server and displays its
    ...
    Olma]
  * [http-slowloris-check](https://nmap.org/nsedoc/scripts/http-slowloris-check.html) tests a web server for vulnerability to the
    Slowloris DoS attack without actually launching a DoS
    attack. [Aleksandar Nikolic]
  * [http-slowloris](https://nmap.org/nsedoc/scripts/http-slowloris.html) tests a web server for vulnerability to the
    Slowloris DoS attack by launching a Slowloris attack. [Aleksandar
    Nikolic, Ange Gutek]
  * [http-tplink-dir-traversal](https://nmap.org/nsedoc/scripts/http-tplink-dir-traversal.html) exploits a directory traversal
  ...
  * [http-traceroute](https://nmap.org/nsedoc/scripts/http-traceroute.html) exploits the Max-Forwards HTTP header to detect
    the presence of reverse proxies. [Hani Benhabiles]
  * [http-virustotal](https://nmap.org/nsedoc/scripts/http-virustotal.html) checks whether a file has been determined as
  ...
  * [http-vlcstreamer-ls](https://nmap.org/nsedoc/scripts/http-vlcstreamer-ls.html) connects to a VLC Streamer helper service and
    ...
    Karlsson]
  * [http-vuln-cve2010-0738](https://nmap.org/nsedoc/scripts/http-vuln-cve2010-0738.html) tests whether a JBoss target is vulnerable
    to jmx console authentication bypass (CVE-2010-0738). [Hani
    Benhabiles]
  * [http-waf-fingerprint](https://nmap.org/nsedoc/scripts/http-waf-fingerprint.html) Tries to detect the presence of a web
    application firewall and its type and version. [Hani Benhabiles]
  * [icap-info](https://nmap.org/nsedoc/scripts/icap-info.html) tests a list of known ICAP service names and prints
  ...
  * [ip-forwarding](https://nmap.org/nsedoc/scripts/ip-forwarding.html) detects whether the remote device has ip forwarding
  ...
  * [ipv6-ra-flood](https://nmap.org/nsedoc/scripts/ipv6-ra-flood.html) generates a flood of Router Advertisements (RA) with
  ...
  * [irc-sasl-brute](https://nmap.org/nsedoc/scripts/irc-sasl-brute.html) performs brute force password auditing against IRC
    (Internet Relay Chat) servers supporting SASL
    authentication. [Piotr Olma]
  * [isns-info](https://nmap.org/nsedoc/scripts/isns-info.html) lists portals and iSCSI nodes registered with the
    Internet Storage Name Service (iSNS). [Patrik Karlsson]
  * [jdwp-exec](https://nmap.org/nsedoc/scripts/jdwp-exec.html) attempts to exploit java's remote debugging port. When
    ...
    Nikolic]
  * [jdwp-info](https://nmap.org/nsedoc/scripts/jdwp-info.html) attempts to exploit java's remote debugging port. When
    remote debugging port is left open, it is possible to inject java
  ...
  * [jdwp-inject](https://nmap.org/nsedoc/scripts/jdwp-inject.html) attempts to exploit java's remote debugging port.
  ...
  * [llmnr-resolve](https://nmap.org/nsedoc/scripts/llmnr-resolve.html) resolves a hostname by using the LLMNR (Link-Local
    Multicast Name Resolution) protocol. [Hani Benhabiles]
  * [mcafee-epo-agent](https://nmap.org/nsedoc/scripts/mcafee-epo-agent.html) check if ePO agent is running on port 8081 or
    port identified as ePO Agent port. [Didier Stevens and Daniel
    Miller]
  * [metasploit-info](https://nmap.org/nsedoc/scripts/metasploit-info.html) gathers info from the Metasploit RPC service. It
  ...
  * [metasploit-msgrpc-brute](https://nmap.org/nsedoc/scripts/metasploit-msgrpc-brute.html) performs brute force username and password
    auditing against Metasploit msgrpc interface. [Aleksandar Nikolic]
  * [mmouse-brute](https://nmap.org/nsedoc/scripts/mmouse-brute.html) performs brute force password auditing against the
    RPA Tech Mobile Mouse servers. [Patrik Karlsson]
  * [mmouse-exec](https://nmap.org/nsedoc/scripts/mmouse-exec.html) connects to an RPA Tech Mobile Mouse server, starts an
    ...
    Karlsson]
  * [mrinfo](https://nmap.org/nsedoc/scripts/mrinfo.html) queries targets for multicast routing information. [Hani
    Benhabiles]
  * [msrpc-enum](https://nmap.org/nsedoc/scripts/msrpc-enum.html) queries an MSRPC endpoint mapper for a list of mapped
    ...
    Nikolic]
  * [ms-sql-dac](https://nmap.org/nsedoc/scripts/ms-sql-dac.html) queries the Microsoft SQL Browser service for the DAC
  ...
  * [mtrace](https://nmap.org/nsedoc/scripts/mtrace.html) queries for the multicast path from a source to a
    destination host. [Hani Benhabiles]
  * [mysql-dump-hashes](https://nmap.org/nsedoc/scripts/mysql-dump-hashes.html) dumps the password hashes from an MySQL server
    in a format suitable for cracking by tools such as John the
    Ripper. Appropriate DB privileges (root) are required. [Patrik
    Karlsson]
  * [mysql-query](https://nmap.org/nsedoc/scripts/mysql-query.html) runs a query against a MySQL database and returns the
    results as a table. [Patrik Karlsson]
  * [mysql-vuln-cve2012-2122](https://nmap.org/nsedoc/scripts/mysql-vuln-cve2012-2122.html) attempts to bypass authentication in MySQL
  ...
  * [oracle-brute-stealth](https://nmap.org/nsedoc/scripts/oracle-brute-stealth.html) exploits the CVE-2012-3137 vulnerability, a
  ...
  * [pcanywhere-brute](https://nmap.org/nsedoc/scripts/pcanywhere-brute.html) performs brute force password auditing against
    the pcAnywhere remote access protocol. [Aleksandar Nikolic]
  * [rdp-enum-encryption](https://nmap.org/nsedoc/scripts/rdp-enum-encryption.html) determines which Security layer and Encryption
    level is supported by the RDP service. It does so by cycling
    through all existing protocols and ciphers. [Patrik Karlsson]
  * [rmi-vuln-classloader](https://nmap.org/nsedoc/scripts/rmi-vuln-classloader.html) tests whether Java rmiregistry allows class
  ...
  * [rpc-grind](https://nmap.org/nsedoc/scripts/rpc-grind.html) fingerprints the target RPC port to extract the target
    service, RPC number and version. [Hani Benhabiles]
  * [sip-call-spoof](https://nmap.org/nsedoc/scripts/sip-call-spoof.html) spoofs a call to a SIP phone and detects the action
    taken by the target (busy, declined, hung up, etc.) [Hani
    Benhabiles]
  * [sip-methods](https://nmap.org/nsedoc/scripts/sip-methods.html) enumerates a SIP Server's allowed methods (INVITE,
    OPTIONS, SUBSCRIBE, etc.) [Hani Benhabiles]
  * [smb-ls](https://nmap.org/nsedoc/scripts/smb-ls.html) attempts to retrieve useful information about files shared
    on SMB volumes. The output is intended to resemble the output of
    the UNIX \<code\>ls\</code\> command. [Patrik Karlsson]
  * [smb-print-text](https://nmap.org/nsedoc/scripts/smb-print-text.html) attempts to print text on a shared printer by
    calling Print Spooler Service RPC functions. [Aleksandar Nikolic]
  * [smb-vuln-ms10-054](https://nmap.org/nsedoc/scripts/smb-vuln-ms10-054.html) tests whether target machines are vulnerable to
    the ms10-054 SMB remote memory corruption
    vulnerability. [Aleksandar Nikolic]
  * [smb-vuln-ms10-061](https://nmap.org/nsedoc/scripts/smb-vuln-ms10-061.html) tests whether target machines are vulnerable to
    ms10-061 Printer Spooler impersonation vulnerability. [Aleksandar
    Nikolic]
  * [snmp-hh3c-logins](https://nmap.org/nsedoc/scripts/snmp-hh3c-logins.html) attempts to enumerate Huawei / HP/H3C Locally
    Defined Users through the hh3c-user.mib OID [Kurt Grutzmacher]
  * [ssl-date](https://nmap.org/nsedoc/scripts/ssl-date.html) retrieves a target host's time and date from its TLS
    ServerHello response. [Aleksandar Nikolic]
  * [tls-nextprotoneg](https://nmap.org/nsedoc/scripts/tls-nextprotoneg.html) enumerates a TLS server's supported protocols by
    using the next protocol negotiation extension. [Hani Benhabiles]
  * [traceroute-geolocation](https://nmap.org/nsedoc/scripts/traceroute-geolocation.html) lists the geographic locations of each hop
...
* Scans that use OS sockets (including TCP connect scan, version
  detection, and script scan) now use the SO\_BINDTODEVICE sockopt on
...
* [NSE]Added changes to brute and [unpwdb](https://nmap.org/nsedoc/lib/unpwdb.html) libraries to allow more
...
* Fixed a bug that prevented Nmap from finding any interfaces when one
  of them had the type ARPHDR\_INFINIBAND; this was the case for
  ...
  the '--send-ip' switch and to the following thread:[http://seclists.org/nmap-dev/2012/q3/642](http://seclists.org/nmap-dev/2012/q3/642)This bug was reported by starlight.2012q3. [Djalal Harouni]
* Fixed a bug that prevented Nmap from finding any interfaces when one
  of them had the type ARPHDR\_IEEE80211; this was the case for wireless
...
* Fixed a bug that prevented Nmap from finding any interfaces when any
  interface had the type ARPHRD\_VOID; this was the case for OpenVZ
...
* Added Dan Miller as an Nmap committer. He has done a ton of great
  ...
  or reading the Nmap committers list at[https://svn.nmap.org/nmap/docs/committers.txt](https://svn.nmap.org/nmap/docs/committers.txt) .
...
* [NSE]Rewrote [ftp-brute](https://nmap.org/nsedoc/scripts/ftp-brute.html) script to use the [brute](https://nmap.org/nsedoc/lib/brute.html) library for
  performing password auditing. [Aleksandar Nikolic]
* Reduced the size of Port structures by about two thirds (from 176 to
  64 bytes on x86\_64). They had accidentally grown during the IPv6
...
* [NSE]Added support for ECDSA keys to [ssh-hostkey](https://nmap.org/nsedoc/scripts/ssh-hostkey.html).nse. [Adam Števko]
* Changed the CPE for Linux from cpe:/o:linux:kernel to
  cpe:/o:linux:linux\_kernel to reflect deprecation in the official CPE
  dictionary.
...
* Fixed protocol number-to-name mapping. A patch was contributed by
  hejianet.
* [NSE]The nmap.ip\_send function now takes a second argument, the
  ...
  ip\_send without a destination address will continue to use the old
...
* [NSE]Fixed a bug in [rpc-grind](https://nmap.org/nsedoc/scripts/rpc-grind.html).nse that would cause unresponsive UDP
...
* [NSE]Updated [mssql.lua](https://nmap.org/nsedoc/lib/mssql.html) library to support additional data types,
...
* [NSE]Added spoolss functions and constants to [msrpc.lua](https://nmap.org/nsedoc/lib/msrpc.html). [Aleksandar Nikolic]
* [NSE]Reduced the number of names tried by [http-vhosts](https://nmap.org/nsedoc/scripts/http-vhosts.html) by default.
  [Vlatko Kosturjak]
* [Zenmap]Fixed a crash when using the en\_NG locale: "ValueError:
  unknown locale: en\_NG" [David Fifield]
* [NSE]Fixed some bugs in [snmp-interfaces](https://nmap.org/nsedoc/scripts/snmp-interfaces.html) which prevented the script from
  outputting discovered interface info and caused it to abort in the
  pre-scanning phase. [jah]
* [NSE]Do a connect on [rpc-grind](https://nmap.org/nsedoc/scripts/rpc-grind.html) ([rpc.lua](https://nmap.org/nsedoc/lib/rpc.html)) UDP sockets so that socket\_lock
...
* [NSE][lltd-discovery](https://nmap.org/nsedoc/scripts/lltd-discovery.html) scripts now parses for hostnames and outputs network
...
* [NSE]Added support for decoding OSPF Hello packets to [broadcast-listener](https://nmap.org/nsedoc/scripts/broadcast-listener.html).
  [Hani Benhabiles]
* [NSE]Fixed a false positive in [http-vuln-cve2011-3192](https://nmap.org/nsedoc/scripts/http-vuln-cve2011-3192.html).nse, which detected
...
* Added support for log type bitmasks in log\_vwrite(). Also replaced a fatal()
...
* [NSE]Added default values for Expires, Call-ID, Allow and Content-Length
  headers in SIP requests and removed redundant code in [sip](https://nmap.org/nsedoc/lib/sip.html) library.
  [Hani Benhabiles]
...
* [NSE]Added AUTH\_UNIX support to the [rpc](https://nmap.org/nsedoc/lib/rpc.html) library and NFS scripts.
  [Daniel Miller]
...
* [NSE]More Windows 7 and Windows 2008 fixes for the [smb](https://nmap.org/nsedoc/lib/smb.html) library and [smb-ls](https://nmap.org/nsedoc/scripts/smb-ls.html)scripts. [Patrik Karlsson]
* [NSE]Added SPNEGO authentication supporting Windows 7 and Windows 2008 to
  the [smb](https://nmap.org/nsedoc/lib/smb.html) library. [Patrik Karlsson]
* [NSE]Changed [http-brute](https://nmap.org/nsedoc/scripts/http-brute.html) so that it works against the root path
  ("/") by default rather than always requiring the [http-brute](https://nmap.org/nsedoc/scripts/http-brute.html).path
  script argument. [Fyodor]
* [NSE]Applied patch from Daniel Miller that fixes bug in several scripts and
  libraries [http://seclists.org/nmap-dev/2012/q2/593](http://seclists.org/nmap-dev/2012/q2/593) [Daniel Miller]
...
* [NSE]Rewrote [mysql-brute](https://nmap.org/nsedoc/scripts/mysql-brute.html) to use [brute](https://nmap.org/nsedoc/lib/brute.html) library [Aleksandar Nikolic]
* Improved the [mysql](https://nmap.org/nsedoc/lib/mysql.html) library to handle multiple columns with the same name,
...
* The message "nexthost: failed to determine route to ..." is now a
  ...
  Fifield]
* [NSE][targets-sniffer](https://nmap.org/nsedoc/scripts/targets-sniffer.html) now is capable of sniffing IPv6 addresses.
  [Daniel Miller]
* [NSE]Ported the [pop3-brute](https://nmap.org/nsedoc/scripts/pop3-brute.html) script to use the [brute](https://nmap.org/nsedoc/lib/brute.html) library.
  [Piotr Olma]
...
* Fixed a bug that caused Nmap to fail to find any network interface when
  ...
  ARP\_HRD\_IEEE80211\_RADIOTAP 802.11 radiotap header identifier in the
  ...
  reported by Tom Eichstaedt and Henri Doreau.[http://seclists.org/nmap-dev/2012/q2/449](http://seclists.org/nmap-dev/2012/q2/449)[http://seclists.org/nmap-dev/2012/q2/478](http://seclists.org/nmap-dev/2012/q2/478)[Djalal Harouni, Henri Doreau]
...
* Most important release since Nmap 5.00 in July 2009! For a list of
  ...
  announcement at: [https://nmap.org/6/](https://nmap.org/6/)
...
* Added a new "target" element to XML output that indicates when a
  ...
  [David Fifield]
* [NSE]Added the script [samba-vuln-cve-2012-1182](https://nmap.org/nsedoc/scripts/samba-vuln-cve-2012-1182.html) which detects the
  SAMBA pre-auth remote root vulnerability (CVE-2012-1182).
  [Aleksandar Nikolic]
* [NSE]Added [http-vuln-cve2012-1823](https://nmap.org/nsedoc/scripts/http-vuln-cve2012-1823.html).nse, which checks for PHP CGI
...
* [NSE]Added [rdp-vuln-ms12-020](https://nmap.org/nsedoc/scripts/rdp-vuln-ms12-020.html).nse by Aleksandar Nikolic. This tests
...
* [NSE]Added a [stun](https://nmap.org/nsedoc/lib/stun.html) library and the scripts [stun-version](https://nmap.org/nsedoc/scripts/stun-version.html) and [stun-info](https://nmap.org/nsedoc/scripts/stun-info.html), which
  extract version information and the external NAT:ed address.
  [Patrik Karlsson]
* [NSE]Added the script [duplicates](https://nmap.org/nsedoc/scripts/duplicates.html) which attempts to determine duplicate
...
* [NSE]Added ciphers from RFC 5932 and Fortezza-based ciphers to[ssl-enum-ciphers](https://nmap.org/nsedoc/scripts/ssl-enum-ciphers.html).nse. The patch was submitted by Darren McDonald.
* [NSE]Renamed hostmap.nse to [hostmap-bfk](https://nmap.org/nsedoc/scripts/hostmap-bfk.html).nse.
* Fixed a compilation problem on Solaris 9 caused by a missing
  definition of IPV6\_V6ONLY. Reported by Dagobert Michelsen.
...
* [NSE]Added new script [http-chrono](https://nmap.org/nsedoc/scripts/http-chrono.html), which measures min, max and average
...
* Fixed a bug that could cause Nsock timers to fire too early. This
  ...
  incorrect measurement of the TCP\_ISR feature. [David Fifield]
...
### Nmap 5.61TEST5 [2012-03-09] [§](https://nmap.org/changelog.html#5.61TEST5) ###
...
* Integrated all of your IPv4 OS fingerprint submissions since June
  ...
  see [http://seclists.org/nmap-dev/2012/q1/431](http://seclists.org/nmap-dev/2012/q1/431) [David Fifield]
* Integrated all of your service/version detection fingerprints
  submitted since November 2010--more than 2,500 of them! Our
  signature count increased more than 10% to 7,423 covering 862
  protocols. Some amusing and bizarre new services are described at[http://seclists.org/nmap-dev/2012/q1/359](http://seclists.org/nmap-dev/2012/q1/359) [David Fifield]
* Integrated your latest IPv6 OS submissions and corrections. We're
  still low on IPv6 fingerprints, so please scan any IPv6 systems you
  own or administer and submit them to [https://nmap.org/submit/](https://nmap.org/submit/). Both
  new fingerprints (if Nmap doesn't find a good match) and corrections
...
* [NSE]Added a host-based registry which only persists (for the given
  ...
  can. See [https://nmap.org/book/nse-api.html#nse-api-registry](https://nmap.org/book/nse-api.html#nse-api-registry). [Patrik
  Karlsson]
...
* [NSE]Added 43(!) NSE scripts, bringing the total up to 340. They
  are all listed at [https://nmap.org/nsedoc/](https://nmap.org/nsedoc/), and the summaries are
  below (authors are listed in brackets):
  * [acarsd-info](https://nmap.org/nsedoc/scripts/acarsd-info.html) retrieves information from a listening acarsd
  ...
  * [broadcast-dhcp6-discover](https://nmap.org/nsedoc/scripts/broadcast-dhcp6-discover.html) sends a DHCPv6 request (Solicit) to the
  ...
  * [broadcast-networker-discover](https://nmap.org/nsedoc/scripts/broadcast-networker-discover.html) discovers the EMC Networker backup
    software server on a LAN by using network broadcasts. [Patrik Karlsson]
  * [broadcast-pppoe-discover](https://nmap.org/nsedoc/scripts/broadcast-pppoe-discover.html) discovers PPPoE servers using the PPPoE
    Discovery protocol (PPPoED). [Patrik Karlsson]
  * [broadcast-ripng-discover](https://nmap.org/nsedoc/scripts/broadcast-ripng-discover.html) discovers hosts and routing information
  ...
  * [broadcast-versant-locate](https://nmap.org/nsedoc/scripts/broadcast-versant-locate.html) discovers Versant object databases using
    the srvloc protocol. [Patrik Karlsson]
  * [broadcast-xdmcp-discover](https://nmap.org/nsedoc/scripts/broadcast-xdmcp-discover.html) discovers servers running the X Display
    Manager Control Protocol (XDMCP) by sending a XDMCP broadcast
    request to the LAN. [Patrik Karlsson]
  * [cccam-version](https://nmap.org/nsedoc/scripts/cccam-version.html) detects the CCcam service (software for sharing
    subscription TV among multiple receivers). [David Fifield]
  * [dns-client-subnet-scan](https://nmap.org/nsedoc/scripts/dns-client-subnet-scan.html) performs a domain lookup using the
  ...
  * [dns-srv-enum](https://nmap.org/nsedoc/scripts/dns-srv-enum.html) enumerates various common service (SRV) records for a
  ...
  * [eap-info](https://nmap.org/nsedoc/scripts/eap-info.html) enumerates the authentication methods offered by an EAP
    authenticator for a given identity or for the anonymous identity
    if no argument is passed. [Riccardo Cecolin]
  * [http-auth-finder](https://nmap.org/nsedoc/scripts/http-auth-finder.html) spiders a web site to find web pages requiring
    form-based or HTTP-based authentication. [Patrik Karlsson]
  * [http-config-backup](https://nmap.org/nsedoc/scripts/http-config-backup.html) checks for backups and swap files of common
    content management system and web server configuration
    files. [Riccardo Cecolin]
  * [http-generator](https://nmap.org/nsedoc/scripts/http-generator.html) displays the contents of the "generator" meta tag
    of a web page (default: /) if there is one. [Michael Kohl]
  * [http-proxy-brute](https://nmap.org/nsedoc/scripts/http-proxy-brute.html) performs brute force password guessing against a
    HTTP proxy server. [Patrik Karlsson]
  * [http-qnap-nas-info](https://nmap.org/nsedoc/scripts/http-qnap-nas-info.html) attempts to retrieve the model, firmware
    version, and enabled services from a QNAP Network Attached Storage
    (NAS) device. [Brendan Coles]
  * [http-vuln-cve2009-3960](https://nmap.org/nsedoc/scripts/http-vuln-cve2009-3960.html) exploits cve-2009-3960 also known as Adobe
    XML External Entity Injection. [Hani Benhabiles]
  * [http-vuln-cve2010-2861](https://nmap.org/nsedoc/scripts/http-vuln-cve2010-2861.html) executes a directory traversal attack
  ...
  * [iax2-brute](https://nmap.org/nsedoc/scripts/iax2-brute.html) performs brute force password auditing against the
    Asterisk IAX2 protocol. [Patrik Karlsson]
  * [membase-brute](https://nmap.org/nsedoc/scripts/membase-brute.html) performs brute force password auditing against
    Couchbase Membase servers. [Patrik Karlsson]
  * [membase-http-info](https://nmap.org/nsedoc/scripts/membase-http-info.html) retrieves information (hostname, OS, uptime,
    etc.) from the CouchBase Web Administration port. [Patrik
    Karlsson]
  * [memcached-info](https://nmap.org/nsedoc/scripts/memcached-info.html) retrieves information (including system
    architecture, process ID, and server time) from distributed memory
    object caching system memcached. [Patrik Karlsson]
  * [mongodb-brute](https://nmap.org/nsedoc/scripts/mongodb-brute.html) performs brute force password auditing against the
    MongoDB database. [Patrik Karlsson]
  * [nat-pmp-mapport](https://nmap.org/nsedoc/scripts/nat-pmp-mapport.html) maps a WAN port on the router to a local port on
    the client using the NAT Port Mapping Protocol (NAT-PMP). [Patrik
    Karlsson]
  * [ndmp-fs-info](https://nmap.org/nsedoc/scripts/ndmp-fs-info.html) lists remote file systems by querying the remote
    device using the Network Data Management Protocol (ndmp). [Patrik
    Karlsson]
  * [ndmp-version](https://nmap.org/nsedoc/scripts/ndmp-version.html) retrieves version information from the remote Network
    Data Management Protocol (NDMP) service. [Patrik Karlsson]
  * [nessus-xmlrpc-brute](https://nmap.org/nsedoc/scripts/nessus-xmlrpc-brute.html) performs brute force password auditing against
    a Nessus vulnerability scanning daemon using the XMLRPC
    protocol. [Patrik Karlsson]
  * [redis-brute](https://nmap.org/nsedoc/scripts/redis-brute.html) performs brute force passwords auditing against a
    Redis key-value store. [Patrik Karlsson]
  * [redis-info](https://nmap.org/nsedoc/scripts/redis-info.html) retrieves information (such as version number and
    architecture) from a Redis key-value store. [Patrik Karlsson]
  * [riak-http-info](https://nmap.org/nsedoc/scripts/riak-http-info.html) retrieves information (such as node name and
    architecture) from a Basho Riak distributed database using the
    HTTP protocol. [Patrik Karlsson]
  * [rpcap-brute](https://nmap.org/nsedoc/scripts/rpcap-brute.html) performs brute force password auditing against the
    WinPcap Remote Capture Daemon (rpcap). [Patrik Karlsson]
  * [rpcap-info](https://nmap.org/nsedoc/scripts/rpcap-info.html) connects to the rpcap service (provides remote sniffing
    capabilities through WinPcap) and retrieves interface
    information. [Patrik Karlsson]
  * [rsync-brute](https://nmap.org/nsedoc/scripts/rsync-brute.html) performs brute force password auditing against the
    rsync remote file syncing protocol. [Patrik Karlsson]
  * [rsync-list-modules](https://nmap.org/nsedoc/scripts/rsync-list-modules.html) lists modules available for rsync (remote file
    sync) synchronization. [Patrik Karlsson]
  * [socks-auth-info](https://nmap.org/nsedoc/scripts/socks-auth-info.html) determines the supported authentication mechanisms
    of a remote SOCKS 5 proxy server. [Patrik Karlsson]
  * [socks-brute](https://nmap.org/nsedoc/scripts/socks-brute.html) performs brute force password auditing against SOCKS 5
  ...
  * [versant-info](https://nmap.org/nsedoc/scripts/versant-info.html) extracts information, including file paths, version
    and database names from a Versant object database. [Patrik
    Karlsson]
  * [vmauthd-brute](https://nmap.org/nsedoc/scripts/vmauthd-brute.html) performs brute force password auditing against the
    VMWare Authentication Daemon (vmware-authd). [Patrik Karlsson]
  * [voldemort-info](https://nmap.org/nsedoc/scripts/voldemort-info.html) retrieves cluster and store information from the
    Voldemort distributed key-value store using the Voldemort Native
    Protocol. [Patrik Karlsson]
  * [xdmcp-discover](https://nmap.org/nsedoc/scripts/xdmcp-discover.html) requests an XDMCP (X display manager control
...
* [NSE]The host.os table is now a structured array of table that
  include OS class information and CPE. See[https://nmap.org/book/nse-api.html](https://nmap.org/book/nse-api.html) for documentation of the new
...
* [NSE]Added support to [broadcast-listener](https://nmap.org/nsedoc/scripts/broadcast-listener.html) for extracting address, native VLAN
...
* [NSE]Modified the [ssl-cert](https://nmap.org/nsedoc/scripts/ssl-cert.html) and ssl-google-cert-catalog scripts to
  take advantage of the new [sslcert](https://nmap.org/nsedoc/lib/sslcert.html) library which retrieves and caches
  SSL certificates in the registry.
* [NSE]Patch our [bitcoin](https://nmap.org/nsedoc/lib/bitcoin.html) library to support recent changes in the
  BitCoin protocol. [Andrew Orr, Patrik Karlsson]
* Fixed an error where very long messages could cause an
  assertion failure: "log\_vwrite: vsnprintf failed. Even after
...
* Fixed an assertion failure that was printed when a fatal error
  occurred while an XML tag was incomplete: "!xml.tag\_open, file
...
* [NSE]Added support for decoding EIGRP broadcasts from Cisco routers
  to [broadcast-listener](https://nmap.org/nsedoc/scripts/broadcast-listener.html). [Tom Sellers]
* [NSE]Added redirect support to the [http](https://nmap.org/nsedoc/lib/http.html) library. All calls to
...
* [NSE]Modified the sql-injection script to use the [httpspider](https://nmap.org/nsedoc/lib/httpspider.html) library.
  [Lauri Kokkonen]
...
* [NSE]Fixed a bunch of global access errors in various libraries reported by
  the nse\_check\_globals script. [Patrik Karlsson]
* Fixed an assertion failure which could occur when connecting to an
  SSL server:
  nsock\_core.c:186: update\_events: Assertion `(ev\_inc & ev\_dec) == 0' failed.
...
* [NSE]Added support to the DNS library for the CHAOS class and NSID
  requests. [John Bond]
* [NSE]Changed the [dnsbl](https://nmap.org/nsedoc/lib/dnsbl.html) library to take a much faster threaded
...
* [NSE]Fixed a memory leak in PortList::setServiceProbeResults()
  ...
  triggered by set\_port\_version calls from NSE. [Henri Doreau]
* [NSE]Fixed a race condition in [broadcast-dhcp-discover](https://nmap.org/nsedoc/scripts/broadcast-dhcp-discover.html).nse that
...
* Allow overriding the AR variable to use a different version of the
  ...
  Gonçalves]
* Added vcredist2008\_x86.exe to the Windows zip file. This installer
...
* The [packet](https://nmap.org/nsedoc/lib/packet.html) library now uses consistent naming of the address fields
  for IPv4 and IPv6 packets (ip\_bin\_src, ip\_bin\_dst, ip\_src, and
  ip\_dst). [Henri Doreau]
...
* Fixed building on Arch Linux. The PCAP\_IS\_SUITABLE test had to be
  modified to ensure that -lnl was passed on the build line. See the
  r28202 svn log for further information. [David Fifield]
* Include net/if.h before net/if\_arp.h in netutil.cc and tcpip.cc to
  hopefully fix some build problems on AIX 5.3.
* [NSE]Added IPv6 support to [firewalk](https://nmap.org/nsedoc/scripts/firewalk.html).nse. [Henri Doreau]

### Nmap 5.61TEST4 [2012-01-02] [§](https://nmap.org/changelog.html#5.61TEST4) ###

* [NSE]Added a new [httpspider](https://nmap.org/nsedoc/lib/httpspider.html) library which is used for recursively
  crawling web sites for information. New scripts using this
  functionality include [http-backup-finder](https://nmap.org/nsedoc/scripts/http-backup-finder.html), http-email-harvest,[http-grep](https://nmap.org/nsedoc/scripts/http-grep.html), [http-open-redirect](https://nmap.org/nsedoc/scripts/http-open-redirect.html), and [http-unsafe-output-escaping](https://nmap.org/nsedoc/scripts/http-unsafe-output-escaping.html). See[https://nmap.org/nsedoc/](https://nmap.org/nsedoc/) or the list later in this file for details
  on these. [Patrik]
* Our Mac OS X packages are now x86-only (rather than universal),
  ...
  2006), you can use Nmap 5.51 or 5.61TEST2 from[https://nmap.org/dist/?C=M&O=D](https://nmap.org/dist/?C=M&O=D).
* We set up a new SVN server for the Nmap codebase. This one uses SSL
  ...
  need for the special "guest" username. The new server is at[https://svn.nmap.org](https://svn.nmap.org/). More information:[http://seclists.org/nmap-dev/2011/q4/504](http://seclists.org/nmap-dev/2011/q4/504).
* [NSE]Added a vulnerability management library ([vulns.lua](https://nmap.org/nsedoc/lib/vulns.html)) to store and to
  report discovered vulnerabilities. Modified these scripts to use
  the new library:
  * [ftp-libopie](https://nmap.org/nsedoc/scripts/ftp-libopie.html).nse
  * [http-vuln-cve2011-3192](https://nmap.org/nsedoc/scripts/http-vuln-cve2011-3192.html).nse
  * [ftp-vuln-cve2010-4221](https://nmap.org/nsedoc/scripts/ftp-vuln-cve2010-4221.html).nse
  * [ftp-vsftpd-backdoor](https://nmap.org/nsedoc/scripts/ftp-vsftpd-backdoor.html).nse
  * [smtp-vuln-cve2011-1720](https://nmap.org/nsedoc/scripts/smtp-vuln-cve2011-1720.html).nse
  * [smtp-vuln-cve2011-1764](https://nmap.org/nsedoc/scripts/smtp-vuln-cve2011-1764.html).nse
  * [afp-path-vuln](https://nmap.org/nsedoc/scripts/afp-path-vuln.html).nse
...
* [NSE]Added a new script force feature. You can force scripts to
  ...
  See[https://nmap.org/book/nse-usage.html#nse-script-selection](https://nmap.org/book/nse-usage.html#nse-script-selection). [Martin
  Swende]
* [NSE]Added 51(!) NSE scripts, bringing the total up to 297. They
  are all listed at [https://nmap.org/nsedoc/](https://nmap.org/nsedoc/), and the summaries are
  below (authors listed in brackets):
  * [amqp-info](https://nmap.org/nsedoc/scripts/amqp-info.html) gathers information (a list of all server properties)
    from an AMQP (advanced message queuing protocol)
    server. [Sebastian Dragomir]
  * [bitcoin-getaddr](https://nmap.org/nsedoc/scripts/bitcoin-getaddr.html) queries a Bitcoin server for a list of known
    Bitcoin nodes. [Patrik Karlsson]
  * [bitcoin-info](https://nmap.org/nsedoc/scripts/bitcoin-info.html) extracts version and node information from a Bitcoin
    server [Patrik Karlsson]
  * [bitcoinrpc-info](https://nmap.org/nsedoc/scripts/bitcoinrpc-info.html) obtains information from a Bitcoin server by
    calling getinfo on its JSON-RPC interface. [Toni
    Ruottu]
  * [broadcast-pc-anywhere](https://nmap.org/nsedoc/scripts/broadcast-pc-anywhere.html) sends a special broadcast probe to discover
    PC-Anywhere hosts running on a LAN. [Patrik Karlsson]
  * [broadcast-pc-duo](https://nmap.org/nsedoc/scripts/broadcast-pc-duo.html) discovers PC-DUO remote control hosts and
    gateways running on the LAN. [Patrik Karlsson]
  * [broadcast-rip-discover](https://nmap.org/nsedoc/scripts/broadcast-rip-discover.html) discovers hosts and routing information
  ...
  * [broadcast-sybase-asa-discover](https://nmap.org/nsedoc/scripts/broadcast-sybase-asa-discover.html) discovers Sybase Anywhere servers on
    the LAN by sending broadcast discovery messages. [Patrik Karlsson]
  * [broadcast-wake-on-lan](https://nmap.org/nsedoc/scripts/broadcast-wake-on-lan.html) wakes a remote system up from sleep by
    sending a Wake-On-Lan packet. [Patrik Karlsson]
  * [broadcast-wpad-discover](https://nmap.org/nsedoc/scripts/broadcast-wpad-discover.html) Retrieves a list of proxy servers on the
    LAN using the Web Proxy Autodiscovery Protocol (WPAD). [Patrik
    Karlsson]
  * [dns-blacklist](https://nmap.org/nsedoc/scripts/dns-blacklist.html) checks target IP addresses against multiple DNS
    anti-spam and open proxy blacklists and returns a list of services
    where the IP has been blacklisted. [Patrik Karlsson]
  * [dns-zeustracker](https://nmap.org/nsedoc/scripts/dns-zeustracker.html) checks if the target IP range is part of a Zeus
    botnet by querying ZTDNS @ abuse.ch. [Mikael Keri]
  * [ganglia-info](https://nmap.org/nsedoc/scripts/ganglia-info.html) retrieves system information (OS version, available
    memory, etc.) from a listening Ganglia Monitoring Daemon or
    Ganglia Meta Daemon. [Brendan Coles]
  * [hadoop-datanode-info](https://nmap.org/nsedoc/scripts/hadoop-datanode-info.html) discovers information such as log directories
    from an Apache Hadoop DataNode HTTP status page. [John R. Bond]
  * [hadoop-jobtracker-info](https://nmap.org/nsedoc/scripts/hadoop-jobtracker-info.html) retrieves information from an Apache Hadoop
    JobTracker HTTP status page. [John R. Bond]
  * [hadoop-namenode-info](https://nmap.org/nsedoc/scripts/hadoop-namenode-info.html) retrieves information from an Apache Hadoop
    NameNode HTTP status page. [John R. Bond]
  * [hadoop-secondary-namenode-info](https://nmap.org/nsedoc/scripts/hadoop-secondary-namenode-info.html) retrieves information from an
    Apache Hadoop secondary NameNode HTTP status page. [John R. Bond]
  * [hadoop-tasktracker-info](https://nmap.org/nsedoc/scripts/hadoop-tasktracker-info.html) retrieves information from an Apache
    Hadoop TaskTracker HTTP status page. [John R. Bond]
  * [hbase-master-info](https://nmap.org/nsedoc/scripts/hbase-master-info.html) retrieves information from an Apache HBase
    (Hadoop database) master HTTP status page. [John R. Bond]
  * [hbase-region-info](https://nmap.org/nsedoc/scripts/hbase-region-info.html) retrieves information from an Apache HBase
    (Hadoop database) region server HTTP status page. [John R. Bond]
  * [http-apache-negotiation](https://nmap.org/nsedoc/scripts/http-apache-negotiation.html) checks if the target http server has
    mod\_negotiation enabled. This feature can be leveraged to find
    hidden resources and spider a web site using fewer requests. [Hani
    Benhabiles]
  * [http-backup-finder](https://nmap.org/nsedoc/scripts/http-backup-finder.html) Spiders a website and attempts to identify
  ...
  * [http-cors](https://nmap.org/nsedoc/scripts/http-cors.html) tests an http server for Cross-Origin Resource Sharing
  ...
  * [http-grep](https://nmap.org/nsedoc/scripts/http-grep.html) spiders a website and attempts to match all pages and
    urls against a given string. Matches are counted and grouped per
    url under which they were discovered. [Patrik Karlsson]
  * [http-method-tamper](https://nmap.org/nsedoc/scripts/http-method-tamper.html) tests whether a JBoss target is vulnerable to
    jmx console authentication bypass (CVE-2010-0738). [Hani
    Benhabiles]
  * [http-open-redirect](https://nmap.org/nsedoc/scripts/http-open-redirect.html) spiders a website and attempts to identify open
  ...
  * [http-put](https://nmap.org/nsedoc/scripts/http-put.html) uploads a local file to a remote web server using the
    HTTP PUT method. You must specify the filename and URL path with
    NSE arguments. [Patrik Karlsson]
  * [http-robtex-reverse-ip](https://nmap.org/nsedoc/scripts/http-robtex-reverse-ip.html) Obtains up to 100 forward DNS names for a
    target IP address by querying the Robtex service
    ([http://www.robtex.com/ip/](http://www.robtex.com/ip/)). [riemann]
  * [http-unsafe-output-escaping](https://nmap.org/nsedoc/scripts/http-unsafe-output-escaping.html) spiders a website and attempts to
    identify output escaping problems where content is reflected back
    to the user. [Martin Holst Swende]
  * [http-vuln-cve2011-3368](https://nmap.org/nsedoc/scripts/http-vuln-cve2011-3368.html) tests for the CVE-2011-3368 (Reverse Proxy
    Bypass) vulnerability in Apache HTTP server's reverse proxy
    mode. [Ange Gutek, Patrik Karlsson]
  * [ipv6-node-info](https://nmap.org/nsedoc/scripts/ipv6-node-info.html) obtains hostnames, IPv4 and IPv6 addresses through
    IPv6 Node Information Queries. [David Fifield]
  * [irc-botnet-channels](https://nmap.org/nsedoc/scripts/irc-botnet-channels.html) checks an IRC server for channels that are
    commonly used by malicious botnets. [David Fifield, Ange Gutek]
  * [irc-brute](https://nmap.org/nsedoc/scripts/irc-brute.html) performs brute force password auditing against IRC
    (Internet Relay Chat) servers. [Patrik Karlsson]
  * [krb5-enum-users](https://nmap.org/nsedoc/scripts/krb5-enum-users.html) discovers valid usernames by brute force querying
    likely usernames against a Kerberos service. [Patrik Karlsson]
  * [maxdb-info](https://nmap.org/nsedoc/scripts/maxdb-info.html) retrieves version and database information from a SAP
    Max DB database. [Patrik Karlsson]
  * [metasploit-xmlrpc-brute](https://nmap.org/nsedoc/scripts/metasploit-xmlrpc-brute.html) performs brute force password auditing
    against a Metasploit RPC server using the XMLRPC protocol. [Vlatko
    Kosturjak]
  * [ms-sql-dump-hashes](https://nmap.org/nsedoc/scripts/ms-sql-dump-hashes.html) Dumps the password hashes from an MS-SQL server
  ...
  * [nessus-brute](https://nmap.org/nsedoc/scripts/nessus-brute.html) performs brute force password auditing against a
    Nessus vulnerability scanning daemon using the NTP 1.2
    protocol. [Patrik Karlsson]
  * [nexpose-brute](https://nmap.org/nsedoc/scripts/nexpose-brute.html) performs brute force password auditing against a
    Nexpose vulnerability scanner using the API 1.1. [Vlatko
    Kosturjak]
  * [openlookup-info](https://nmap.org/nsedoc/scripts/openlookup-info.html) parses and displays the [banner](https://nmap.org/nsedoc/scripts/banner.html) information of an
    OpenLookup (network key-value store) server. [Toni Ruottu]
  * [openvas-otp-brute](https://nmap.org/nsedoc/scripts/openvas-otp-brute.html) performs brute force password auditing against a
    OpenVAS vulnerability scanner daemon using the OTP 1.0
    protocol. [Vlatko Kosturjak]
  * [reverse-index](https://nmap.org/nsedoc/scripts/reverse-index.html) creates a reverse index at the end of scan output
    showing which hosts run a particular service. [Patrik Karlsson]
  * [rexec-brute](https://nmap.org/nsedoc/scripts/rexec-brute.html) performs brute force password auditing against the
    classic UNIX rexec (remote exec) service. [Patrik Karlsson]
  * [rlogin-brute](https://nmap.org/nsedoc/scripts/rlogin-brute.html) performs brute force password auditing against the
    classic UNIX rlogin (remote login) service. [Patrik Karlsson]
  * [rtsp-methods](https://nmap.org/nsedoc/scripts/rtsp-methods.html) determines which methods are supported by the RTSP
    (real time streaming protocol) server. [Patrik Karlsson]
  * [rtsp-url-brute](https://nmap.org/nsedoc/scripts/rtsp-url-brute.html) attempts to enumerate RTSP media URLS by testing
    for common paths on devices such as surveillance IP
    cameras. [Patrik Karlsson]
  * [telnet-encryption](https://nmap.org/nsedoc/scripts/telnet-encryption.html) determines whether the encryption option is
  ...
  * [unusual-port](https://nmap.org/nsedoc/scripts/unusual-port.html) compares the detected service on a port against the
  ...
  * [vuze-dht-info](https://nmap.org/nsedoc/scripts/vuze-dht-info.html) retrieves some basic information, including protocol
...
* [NSE]Added support for detecting whether a http connection was established
  using SSL or not to the [http.lua](https://nmap.org/nsedoc/lib/http.html) library [Patrik]
* [NSE]Added local port to BPF filter in [snmp-brute](https://nmap.org/nsedoc/scripts/snmp-brute.html) to fix bug that would
  prevent multiple scripts from receiving the correct responses. The bug was
  discovered by Brendan Bird. [Patrik]
* [NSE]Changed the [dhcp-discover](https://nmap.org/nsedoc/scripts/dhcp-discover.html) script to use the DHCPINFORM request
  to query dhcp servers instead of DHCPDISCOVER. Also removed DoS code
  from [dhcp-discover](https://nmap.org/nsedoc/scripts/dhcp-discover.html) and placed the script into the discovery and safe
  categories. Added support for adding options to DHCP requests and
  cleaned up some code in the [dhcp](https://nmap.org/nsedoc/lib/dhcp.html) library. [Patrik]
* [NSE]Applied patch to [snmp-brute](https://nmap.org/nsedoc/scripts/snmp-brute.html) that solves problems with handling
  errors that occur during community list file parsing. [Duarte
  Silva]
* [NSE]Added new fingerprints to [http-enum](https://nmap.org/nsedoc/scripts/http-enum.html) for:
  * Subversion, CVS and Apache Archiva [Duarte Silva]
  * DVCS systems Git, Mercurial and Bazaar [Hani Benhabiles].

* [NSE]Applied some code cleanup to the [snmp](https://nmap.org/nsedoc/lib/snmp.html) library. [Brendan Byrd]
* [NSE]Fixed an undeclared variable bug in [snmp-ios-config](https://nmap.org/nsedoc/scripts/snmp-ios-config.html) [Patrik]
* [NSE]Add additional version information to Mongodb scripts [Martin
  Swende]
* [NSE]Added path argument to the [http-auth](https://nmap.org/nsedoc/scripts/http-auth.html) script and update the
  script to use stdnse.format\_output. [Duarte Silva, Patrik]
* [NSE]Fixed bug in the [http](https://nmap.org/nsedoc/lib/http.html) library that would fail to parse
...
* [Nping]The --safe-payloads option is now the default. Added
  ...
  needed. [Colin Rice]
* [NSE]Added new functionality and fixed some bugs in the [brute](https://nmap.org/nsedoc/lib/brute.html) library:
  * Added support for restricting the number of guesses performed by the[brute](https://nmap.org/nsedoc/lib/brute.html) library against users, to prevent account lockouts.
...
* [NSE]Re-enabled support for guessing the username in addition to password
  that was incorrectly removed from the [metasploit-xmlrpc-brute](https://nmap.org/nsedoc/scripts/metasploit-xmlrpc-brute.html) in previous
  commit. [Patrik]
* [NSE]Fixed bug that would prevent brute scripts from running if no service
  field was present in the port table. [Patrik]
* [NSE]Turned on promiscuous mode in [targets-sniffer](https://nmap.org/nsedoc/scripts/targets-sniffer.html).nse so that it
...
* [NSE]Modified the [http](https://nmap.org/nsedoc/lib/http.html) library to support servers that don't return valid
  chunked encoded data, such as the Citrix XML service. [Patrik]
* [NSE]Fixed a bug where the [brute](https://nmap.org/nsedoc/lib/brute.html) library would not abort even after all
...
* Fixed a bug in the IPv6 OS probe called NI. The Node Information
  ...
  [David]
* [NSE]Fixed an error in the [mssql](https://nmap.org/nsedoc/lib/mssql.html) library that was causing the[broadcast-ms-sql-discover](https://nmap.org/nsedoc/scripts/broadcast-ms-sql-discover.html) script to fail when trying to update port version
  information. [Patrik]
* [NSE]Added the missing broadcast category to the [broadcast-listener](https://nmap.org/nsedoc/scripts/broadcast-listener.html) script.
  [Jasey DePriest]
* [NSE]Made changes to the categories of the following scripts (new
  categories shown) [Duarte Silva]:
  * [http-userdir-enum](https://nmap.org/nsedoc/scripts/http-userdir-enum.html).nse (auth,intrusive)
  * [mysql-users](https://nmap.org/nsedoc/scripts/mysql-users.html).nse (auth,intrusive)
  * [http-wordpress-enum](https://nmap.org/nsedoc/scripts/http-wordpress-enum.html).nse (auth,intrusive,vuln)
  * [krb5-enum-users](https://nmap.org/nsedoc/scripts/krb5-enum-users.html).nse (auth,intrusive)
  * [snmp-win32-users](https://nmap.org/nsedoc/scripts/snmp-win32-users.html).nse (default,auth,safe)
  * [smtp-enum-users](https://nmap.org/nsedoc/scripts/smtp-enum-users.html).nse (auth,external,intrusive)
  * [ncp-enum-users](https://nmap.org/nsedoc/scripts/ncp-enum-users.html).nse (auth,safe)
  * [smb-enum-users](https://nmap.org/nsedoc/scripts/smb-enum-users.html).nse (auth,intrusive)

* Made nbase compile with the clang compiler that is a part of Xcode
  4.2. [Daniel J. Luke]
* [NSE]Fix a nil table index bug discovered in the [mongodb](https://nmap.org/nsedoc/lib/mongodb.html)library. [Thomas Buchanan]
* [NSE]Added XMPP support to [ssl-cert](https://nmap.org/nsedoc/scripts/ssl-cert.html).nse.
* [NSE]Made [http-wordpress-enum](https://nmap.org/nsedoc/scripts/http-wordpress-enum.html).nse able to get names of users who
...
### Nmap 5.61TEST2 [2011-09-30] [§](https://nmap.org/changelog.html#5.61TEST2) ###
...
* Added IPv6 OS detection system! The new system utilizes many tests
  ...
  IPv4, but we will soon document the internal mechanisms at[https://nmap.org/book/osdetect.html](https://nmap.org/book/osdetect.html), just as we have for IPv4. For an
  example, try "nmap -6 -O scanme.nmap.org". [David, Luis]
* [NSE]Added 3 scripts, bringing the total to 246! You can learn
  more about them at [https://nmap.org/nsedoc/](https://nmap.org/nsedoc/). Here they are (authors
  listed in brackets):
  * [lltd-discovery](https://nmap.org/nsedoc/scripts/lltd-discovery.html) uses the Microsoft LLTD protocol to discover hosts
  ...
  * [quake3-info](https://nmap.org/nsedoc/scripts/quake3-info.html) extracts information from a Quake3-like game
    server. [Toni Ruottu]
...
* Improved AIX support for raw scans. This includes some patches
  ...
  involved various build fixes found necessary on AIX 6.1 and 7.1. See[https://nmap.org/book/inst-other-platforms.html](https://nmap.org/book/inst-other-platforms.html) . [David]
...
* [NSE]Moved our brute force authentication cracking scripts
  ...
  You can see all 32 of them at[https://nmap.org/nsedoc/categories/brute.html](https://nmap.org/nsedoc/categories/brute.html) . It isn't clear
  whether [dns-brute](https://nmap.org/nsedoc/scripts/dns-brute.html) should be in the brute category, so for now it
  isn't. [Fyodor]
* Made the interface gathering loop work on Linux when an interface
  index is more than two digits in /proc/sys/if\_inet6. Joe McEachern
  tracked down the problem and provided the fix.
* [NSE]Fixed a bug in [dns.lua](https://nmap.org/nsedoc/lib/dns.html): ensure that dns.query() always return two values
  (status, response) and replaced the workaround in [asn-query](https://nmap.org/nsedoc/scripts/asn-query.html).nse by the proper
  use. [Henri]
* [NSE]Made [irc-info](https://nmap.org/nsedoc/scripts/irc-info.html).nse handle the case where the MOTD is missing.
  Patch by Sebastian Dragomir.
* Updated nmap-mac-prefixes to include the latest IEEE assignments
  as of 2011-09-29.

### Nmap 5.61TEST1 [2011-09-19] [§](https://nmap.org/changelog.html#5.61TEST1) ###

* Added Common Platform Enumeration (CPE, [http://cpe.mitre.org/](http://cpe.mitre.org/))
...
* Integrated your latest (IPv4) OS detection submissions and
  ...
  3,308 fingerprints. See[http://seclists.org/nmap-dev/2011/q3/556](http://seclists.org/nmap-dev/2011/q3/556). Please keep those
...
* [NSE]Added 27 scripts, bringing the total to 243! You can learn
  more about any of them at [https://nmap.org/nsedoc/](https://nmap.org/nsedoc/). Here are the new
  ones (authors listed in brackets):
  * [address-info](https://nmap.org/nsedoc/scripts/address-info.html) shows extra information about IPv6 addresses, such as
    embedded MAC or IPv4 addresses when available. [David Fifield]
  * [bittorrent-discovery](https://nmap.org/nsedoc/scripts/bittorrent-discovery.html) discovers bittorrent peers sharing a file
    based on a user-supplied torrent file or magnet link. [Gorjan
    Petrovski]
  * [broadcast-db2-discover](https://nmap.org/nsedoc/scripts/broadcast-db2-discover.html) attempts to discover DB2 servers on the
    network by sending a broadcast request to port 523/udp. [Patrik
    Karlsson]
  * [broadcast-dhcp-discover](https://nmap.org/nsedoc/scripts/broadcast-dhcp-discover.html) sends a DHCP request to the broadcast
    address (255.255.255.255) and reports the results. [Patrik
    Karlsson]
  * [broadcast-listener](https://nmap.org/nsedoc/scripts/broadcast-listener.html) sniffs the network for incoming broadcast
  ...
  * [broadcast-ping](https://nmap.org/nsedoc/scripts/broadcast-ping.html) sends broadcast pings on a selected interface using
    raw ethernet packets and outputs the responding hosts' IP and MAC
    addresses or (if requested) adds them as targets. [Gorjan
    Petrovski]
  * [cvs-brute](https://nmap.org/nsedoc/scripts/cvs-brute.html) performs brute force password auditing against CVS
    pserver authentication. [Patrik Karlsson]
  * [cvs-brute-repository](https://nmap.org/nsedoc/scripts/cvs-brute-repository.html) attempts to guess the name of the CVS
  ...
  * [ftp-vsftpd-backdoor](https://nmap.org/nsedoc/scripts/ftp-vsftpd-backdoor.html) tests for the presence of the vsFTPd 2.3.4
    ...
    '[ftp-vsftpd-backdoor](https://nmap.org/nsedoc/scripts/ftp-vsftpd-backdoor.html).cmd' script arguments. [Daniel Miller]
  * [ftp-vuln-cve2010-4221](https://nmap.org/nsedoc/scripts/ftp-vuln-cve2010-4221.html) checks for a stack-based buffer overflow in
    the ProFTPD server, version between 1.3.2rc3 and 1.3.3b. [Djalal
    Harouni]
  * [http-awstatstotals-exec](https://nmap.org/nsedoc/scripts/http-awstatstotals-exec.html) exploits a remote code execution
    vulnerability in Awstats Totals 1.0 up to 1.14 and possibly other
    products based on it (CVE: 2008-3922). [Paulino Calderon]
  * [http-axis2-dir-traversal](https://nmap.org/nsedoc/scripts/http-axis2-dir-traversal.html) Exploits a directory traversal
    ...
    Calderon]
  * [http-default-accounts](https://nmap.org/nsedoc/scripts/http-default-accounts.html) tests for access with default credentials
    used by a variety of web applications and devices. [Paulino
    Calderon]
  * [http-google-malware](https://nmap.org/nsedoc/scripts/http-google-malware.html) checks if hosts are on Google's blacklist of
    ...
    Calderon]
  * [http-joomla-brute](https://nmap.org/nsedoc/scripts/http-joomla-brute.html) performs brute force password auditing against
    Joomla web CMS installations. [Paulino Calderon]
  * [http-litespeed-sourcecode-download](https://nmap.org/nsedoc/scripts/http-litespeed-sourcecode-download.html) exploits a null-byte poisoning
  ...
  * [http-vuln-cve2011-3192](https://nmap.org/nsedoc/scripts/http-vuln-cve2011-3192.html) detects a denial of service vulnerability
    in the way the Apache web server handles requests for multiple
    overlapping/simple ranges of a page. [Duarte Silva]
  * [http-waf-detect](https://nmap.org/nsedoc/scripts/http-waf-detect.html) attempts to determine whether a web server is
  ...
  * [http-wordpress-brute](https://nmap.org/nsedoc/scripts/http-wordpress-brute.html) performs brute force password auditing
    against Wordpress CMS/blog installations. [Paulino Calderon]
  * [http-wordpress-enum](https://nmap.org/nsedoc/scripts/http-wordpress-enum.html) enumerates usernames in Wordpress blog/CMS
  ...
  * [imap-brute](https://nmap.org/nsedoc/scripts/imap-brute.html) performs brute force password auditing against IMAP
    servers using either LOGIN, PLAIN, CRAM-MD5, DIGEST-MD5 or NTLM
    authentication. [Patrik Karlsson]
  * [smtp-brute](https://nmap.org/nsedoc/scripts/smtp-brute.html) performs brute force password auditing against SMTP
    servers using either LOGIN, PLAIN, CRAM-MD5, DIGEST-MD5 or NTLM
    authentication. [Patrik Karlsson]
  * [smtp-vuln-cve2011-1764](https://nmap.org/nsedoc/scripts/smtp-vuln-cve2011-1764.html) checks for a format string vulnerability in
    the Exim SMTP server (version 4.70 through 4.75) with DomainKeys
    Identified Mail (DKIM) support (CVE-2011-1764). [Djalal Harouni]
  * [targets-ipv6-multicast-echo](https://nmap.org/nsedoc/scripts/targets-ipv6-multicast-echo.html) sends an ICMPv6 echo request packet to
  ...
  * [targets-ipv6-multicast-invalid-dst](https://nmap.org/nsedoc/scripts/targets-ipv6-multicast-invalid-dst.html) sends an ICMPv6 packet with an
  ...
  * [targets-ipv6-multicast-slaac](https://nmap.org/nsedoc/scripts/targets-ipv6-multicast-slaac.html) performs IPv6 host discovery by
    triggering stateless address auto-configuration (SLAAC). [David
    Fifield, Xu Weilin]
  * [xmpp-brute](https://nmap.org/nsedoc/scripts/xmpp-brute.html) Performs brute force password auditing against XMPP
...
* [NSE]The script arguments which start with a script name
  (e.g. [http-brute](https://nmap.org/nsedoc/scripts/http-brute.html).hostname or [afp-ls](https://nmap.org/nsedoc/scripts/afp-ls.html).maxfiles) can now accept the
...
* [NSE]Added a new default credential list for Oracle databases and
  modified the [oracle-brute](https://nmap.org/nsedoc/scripts/oracle-brute.html) script to make use of it. [Patrik]
* [NSE]Our Packet library ([packet.lua](https://nmap.org/nsedoc/lib/packet.html)) now handles IPv6. This is used
  by the new multicast IPv6 host discovery scripts
  (targets-ipv6-\*). [Weilin]
* [NSE]Replaced xmpp.nse with an an overhauled version named[xmpp-info](https://nmap.org/nsedoc/scripts/xmpp-info.html).nse which brings many new features and fixes. [Vasiliy Kulikov]
* [NSE]Fixed SSL compressor names in [ssl-enum-ciphers](https://nmap.org/nsedoc/scripts/ssl-enum-ciphers.html).nse, and
  removed redundant multiple listings of the NULL compressor.
  [Matt Selsky]
* [NSE]Added cipher strength ratings to [ssl-enum-ciphers](https://nmap.org/nsedoc/scripts/ssl-enum-ciphers.html).nse.
  [Gabriel Lawrence]
* [NSE]Fixed a bug in the [ssh2-enum-algos](https://nmap.org/nsedoc/scripts/ssh2-enum-algos.html) script that would prevent it from
  displaying any output unless run in debug mode. [Patrik]
* [NSE]Added 4 more protocol libraries. You can learn more about any
  of them at [https://nmap.org/nsedoc/](https://nmap.org/nsedoc/). Here are the new ones (authors
  listed in brackets):
...
* [NSE]Moved some scripts into the default category: [giop-info](https://nmap.org/nsedoc/scripts/giop-info.html),[vnc-info](https://nmap.org/nsedoc/scripts/vnc-info.html), [ncp-serverinfo](https://nmap.org/nsedoc/scripts/ncp-serverinfo.html), [smb-security-mode](https://nmap.org/nsedoc/scripts/smb-security-mode.html), and and[afp-serverinfo](https://nmap.org/nsedoc/scripts/afp-serverinfo.html). [Djalal]
...
* Rearranged some characters classes in service matches to avoid any
  ...
  [Daniel Miller]
* [NSE]Added more than 100 new signatures to [http-enum](https://nmap.org/nsedoc/scripts/http-enum.html) (many for
...
* Nmap now includes the Liblinear library for large linear
  classification ([http://www.csie.ntu.edu.tw/](http://www.csie.ntu.edu.tw/)\~cjlin/liblinear/). We
...
* Fixed a bug that would make Nmap segfault if it failed to open an
  interface using pcap. The bug details and patch are posted at[http://seclists.org/nmap-dev/2011/q3/365](http://seclists.org/nmap-dev/2011/q3/365) [Patrik]
* Ncat SCTP mode now supports connection brokering
  (--sctp --broker). [Shinnok]
* Consolidated a bunch of duplicate code between Ncat's listen
  (ncat\_listen.c) and broker (ncat\_broker.c) modes to ease
  maintenance. [Shinnok]
* Added a 'nostore' nse argument to the brute force library which
  ...
  storing found credentials in the [creds](https://nmap.org/nsedoc/lib/creds.html) library (they will still be
  printed in script output).
* [NSE]Fixed the nsedebug print\_hex() function so it does not print an
...
* [NSE]Applied patch from Chris Woodbury that adds the following
  additional information to the output of [smb-os-discovery](https://nmap.org/nsedoc/scripts/smb-os-discovery.html): NetBIOS
  computer name, NetBIOS domain name, FQDN, and forest name.
* [NSE]Updated [smb-brute](https://nmap.org/nsedoc/scripts/smb-brute.html) to add detection for valid credentials where the
...
* Fixed broken XML output in the case of timed-out hosts; the
  ...
  Mollon.
* [NSE]Multiple [ldap-brute](https://nmap.org/nsedoc/scripts/ldap-brute.html) changes by Tom Sellers:
...
* [NSE][ldap-search](https://nmap.org/nsedoc/scripts/ldap-search.html).nse - Added support for saving search results to
...
* Handle an unconventional IPv6 internal link-local address convention
  used by Mac OS X. See[http://seclists.org/nmap-dev/2011/q3/906](http://seclists.org/nmap-dev/2011/q3/906). [David]
* [NSE]Optimized stdnse.format\_output (changing the data structures)
  to improve performance for scripts which produce a lot of output. See[http://seclists.org/nmap-dev/2011/q3/623](http://seclists.org/nmap-dev/2011/q3/623). [Djalal]
* [NSE]Fix [nping-brute](https://nmap.org/nsedoc/scripts/nping-brute.html) so that it again works on IPv6. [Toni Ruottu]
* [NSE]Added the make\_array and make\_object functions to our [json](https://nmap.org/nsedoc/lib/json.html)library, allowing LUA tables to be treated as JSON arrays or
  objects. See [http://seclists.org/nmap-dev/2011/q3/15](http://seclists.org/nmap-dev/2011/q3/15) [Daniel Miller]
* [NSE]The [ip-geolocation-ipinfodb](https://nmap.org/nsedoc/scripts/ip-geolocation-ipinfodb.html) now allows you to specify an
  IPInfoDB API key using the apikey NSE argument. [Gorjan]
* [NSE]Renamed http-wp-plugins to http-wordpress-plugins script for
  consistency with [http-wordpress-brute](https://nmap.org/nsedoc/scripts/http-wordpress-brute.html) and now[http-wordpress-enum](https://nmap.org/nsedoc/scripts/http-wordpress-enum.html). [Fyodor]

### Nmap 5.59BETA1 [2011-06-30] [§](https://nmap.org/changelog.html#5.59BETA1) ###

* [NSE]Added 40 scripts, bringing the total to 217! You can learn
  more about any of them at [https://nmap.org/nsedoc/](https://nmap.org/nsedoc/). Here are the new
  ones (authors listed in brackets):
  * [afp-ls](https://nmap.org/nsedoc/scripts/afp-ls.html): Lists files and their attributes from Apple Filing
    Protocol (AFP) volumes. [Patrik Karlsson]
  * [backorifice-brute](https://nmap.org/nsedoc/scripts/backorifice-brute.html): Performs brute force password auditing against
    the BackOrifice remote administration (trojan) service. [Gorjan
    Petrovski]
  * [backorifice-info](https://nmap.org/nsedoc/scripts/backorifice-info.html): Connects to a BackOrifice service and gathers
    information about the host and the BackOrifice service
    itself. [Gorjan Petrovski]
  * [broadcast-avahi-dos](https://nmap.org/nsedoc/scripts/broadcast-avahi-dos.html): Attempts to discover hosts in the local
  ...
  * [broadcast-netbios-master-browser](https://nmap.org/nsedoc/scripts/broadcast-netbios-master-browser.html): Attempts to discover master
    browsers and the Windows domains they manage. [Patrik Karlsson]
  * [broadcast-novell-locate](https://nmap.org/nsedoc/scripts/broadcast-novell-locate.html): Attempts to use the Service Location
    Protocol to discover Novell NetWare Core Protocol (NCP)
    servers. [Patrik Karlsson]
  * [creds-summary](https://nmap.org/nsedoc/scripts/creds-summary.html): Lists all discovered credentials (e.g. from brute
    force and default password checking scripts) at end of scan.
    [Patrik Karlsson]
  * [dns-brute](https://nmap.org/nsedoc/scripts/dns-brute.html): Attempts to enumerate DNS hostnames by brute force
    guessing of common subdomains. [Cirrus]
  * [dns-nsec-enum](https://nmap.org/nsedoc/scripts/dns-nsec-enum.html): Attempts to discover target hosts' services using
    the DNS Service Discovery protocol. [Patrik Karlsson]
  * [dpap-brute](https://nmap.org/nsedoc/scripts/dpap-brute.html): Performs brute force password auditing against an
    iPhoto Library. [Patrik Karlsson]
  * [epmd-info](https://nmap.org/nsedoc/scripts/epmd-info.html): Connects to Erlang Port Mapper Daemon (epmd) and
    retrieves a list of nodes with their respective port
    numbers. [Toni Ruottu]
  * [http-affiliate-id](https://nmap.org/nsedoc/scripts/http-affiliate-id.html): Grabs affiliate network IDs (e.g. Google
  ...
  * [http-barracuda-dir-traversal](https://nmap.org/nsedoc/scripts/http-barracuda-dir-traversal.html): Attempts to retrieve the
    configuration settings from a Barracuda Networks Spam & Virus
    Firewall device using the directory traversal vulnerability
    described at[http://seclists.org/fulldisclosure/2010/Oct/119](http://seclists.org/fulldisclosure/2010/Oct/119). [Brendan Coles]
  * [http-cakephp-version](https://nmap.org/nsedoc/scripts/http-cakephp-version.html): Obtains the CakePHP version of a web
    application built with the CakePHP framework by fingerprinting
    default files shipped with the CakePHP framework. [Paulino
    Calderon]
  * [http-majordomo2-dir-traversal](https://nmap.org/nsedoc/scripts/http-majordomo2-dir-traversal.html): Exploits a directory traversal
  ...
  * ip-geolocation-geobytes: Tries to identify the physical location
    ...
    ([http://www.geobytes.com/iplocator.htm](http://www.geobytes.com/iplocator.htm)). [Gorjan Petrovski]
  * [ip-geolocation-geoplugin](https://nmap.org/nsedoc/scripts/ip-geolocation-geoplugin.html): Tries to identify the physical location
    of an IP address using the Geoplugin geolocation web service
    ([http://www.geoplugin.com/](http://www.geoplugin.com/)). [Gorjan Petrovski]
  * [ip-geolocation-ipinfodb](https://nmap.org/nsedoc/scripts/ip-geolocation-ipinfodb.html): Tries to identify the physical location
    of an IP address using the IPInfoDB geolocation web service
    ([http://ipinfodb.com/ip\_location\_api.php](http://ipinfodb.com/ip_location_api.php)). [Gorjan Petrovski]
  * [ip-geolocation-maxmind](https://nmap.org/nsedoc/scripts/ip-geolocation-maxmind.html): Tries to identify the physical location of
    an IP address using a Geolocation Maxmind database file (available
    from [http://www.maxmind.com/app/ip-location](http://www.maxmind.com/app/ip-location)). [Gorjan Petrovski]
  * [ldap-novell-getpass](https://nmap.org/nsedoc/scripts/ldap-novell-getpass.html): Attempts to retrieve the Novell Universal
  ...
  * [mysql-audit](https://nmap.org/nsedoc/scripts/mysql-audit.html): Audit MySQL database server security configuration
  ...
  * [ncp-enum-users](https://nmap.org/nsedoc/scripts/ncp-enum-users.html): Retrieves a list of all eDirectory users from the
    Novell NetWare Core Protocol (NCP) service. [Patrik Karlsson]
  * [ncp-serverinfo](https://nmap.org/nsedoc/scripts/ncp-serverinfo.html): Retrieves eDirectory server information (OS
    version, server name, mounts, etc.) from the Novell NetWare Core
    Protocol (NCP) service. [Patrik Karlsson]
  * [nping-brute](https://nmap.org/nsedoc/scripts/nping-brute.html): Performs brute force password auditing against an
    Nping Echo service. [Toni Ruottu]
  * [omp2-brute](https://nmap.org/nsedoc/scripts/omp2-brute.html): Performs brute force password auditing against the
    OpenVAS manager using OMPv2. [Henri Doreau]
  * [omp2-enum-targets](https://nmap.org/nsedoc/scripts/omp2-enum-targets.html): Attempts to retrieve the list of target systems
    and networks from an OpenVAS Manager server. [Henri Doreau]
  * [ovs-agent-version](https://nmap.org/nsedoc/scripts/ovs-agent-version.html): Detects the version of an Oracle OVSAgentServer
    by fingerprinting responses to an HTTP GET request and an XML-RPC
    method call. [David Fifield]
  * [quake3-master-getservers](https://nmap.org/nsedoc/scripts/quake3-master-getservers.html): Queries Quake3-style master servers for
    game servers (many games other than Quake 3 use this same
    protocol). [Toni Ruottu]
  * [servicetags](https://nmap.org/nsedoc/scripts/servicetags.html): Attempts to extract system information (OS, hardware,
    etc.) from the Sun Service Tags service agent (UDP port
    6481). [Matthew Flanagan]
  * [sip-brute](https://nmap.org/nsedoc/scripts/sip-brute.html): Performs brute force password auditing against Session
    Initiation Protocol (SIP -[http://en.wikipedia.org/wiki/Session\_Initiation\_Protocol](http://en.wikipedia.org/wiki/Session_Initiation_Protocol))
    accounts. This protocol is most commonly associated with VoIP
    sessions. [Patrik Karlsson]
  * [sip-enum-users](https://nmap.org/nsedoc/scripts/sip-enum-users.html): Attempts to enumerate valid SIP user accounts.
    Currently only the SIP server Asterisk is supported. [Patrik
    Karlsson]
  * [smb-mbenum](https://nmap.org/nsedoc/scripts/smb-mbenum.html): Queries information managed by the Windows Master
    Browser. [Patrik Karlsson]
  * [smtp-vuln-cve2010-4344](https://nmap.org/nsedoc/scripts/smtp-vuln-cve2010-4344.html): Checks for and/or exploits a heap overflow
  ...
  * [smtp-vuln-cve2011-1720](https://nmap.org/nsedoc/scripts/smtp-vuln-cve2011-1720.html): Checks for a memory corruption in the
  ...
  * [snmp-ios-config](https://nmap.org/nsedoc/scripts/snmp-ios-config.html): Attempts to downloads Cisco router IOS
    configuration files using SNMP RW (v1) and display or save
    them. [Vikas Singhal, Patrik Karlsson]
  * [ssl-known-key](https://nmap.org/nsedoc/scripts/ssl-known-key.html): Checks whether the SSL certificate used by a host
    has a fingerprint that matches an included database of problematic
    keys. [Mak Kolybabi]
  * [targets-sniffer](https://nmap.org/nsedoc/scripts/targets-sniffer.html): Sniffs the local network for a configurable
...
* Nmap has long supported IPv6 for basic (connect) port scans, basic
  ...
  * IPv6 support to the wsdd, dnssd and [upnp](https://nmap.org/nsedoc/lib/upnp.html) NSE libraries. [Daniel
    Miller, Patrik]
...
* Scanme.Nmap.Org (the system anyone is allowed to scan for testing
  ...
  for ScanmeV6.nmap.org which is IPv6-only. See[http://seclists.org/nmap-dev/2011/q2/428](http://seclists.org/nmap-dev/2011/q2/428). [Fyodor]
...
* Nmap now determines the filesystem location it is being run from and
  ...
  Nmap installed on the system. For full details, see[https://nmap.org/book/data-files-replacing-data-files.html](https://nmap.org/book/data-files-replacing-data-files.html) . Thanks
...
* Created a page on our SecWiki for collecting Nmap script ideas! If
  ...
  come here for inspiration: [https://secwiki.org/w/Nmap\_Script\_Ideas](https://secwiki.org/w/Nmap_Script_Ideas).
* The development pace has greatly increased because Google (again)
  ...
  the team: [http://seclists.org/nmap-dev/2011/q2/312](http://seclists.org/nmap-dev/2011/q2/312)
* [NSE]Added 7 new protocol libraries, bringing the total to 66. You
  can read about them all at [https://nmap.org/nsedoc/](https://nmap.org/nsedoc/). Here are the new
  ones (authors listed in brackets):
  ...
  * srvloc: A relatively small implementation of the Service Location
    Protocol. [Patrik Karlsson]
  * tftp: Implements a minimal TFTP server. It is used in[snmp-ios-config](https://nmap.org/nsedoc/scripts/snmp-ios-config.html) to obtain router config files.[Patrik Karlsson]
...
* [NSE][ssh-hostkey](https://nmap.org/nsedoc/scripts/ssh-hostkey.html) now additionally has a postrule that prints hosts
  found during the scan which share the same hostkey. [Henri Doreau]
* [NSE]Added 300+ new signatures to [http-enum](https://nmap.org/nsedoc/scripts/http-enum.html) which look for admin
...
* [NSE]Replaced [http-trace](https://nmap.org/nsedoc/scripts/http-trace.html) with a new more effective version. [Paulino]
...
* [NSE]Banned scripts from being in both the "default" and
  "intrusive" categories. We did this by removing [dhcp-discover](https://nmap.org/nsedoc/scripts/dhcp-discover.html) and[dns-zone-transfer](https://nmap.org/nsedoc/scripts/dns-zone-transfer.html) from the set of scripts run by default (leaving
  them "intrusive"), and reclassifying [dns-recursion](https://nmap.org/nsedoc/scripts/dns-recursion.html), [ftp-bounce](https://nmap.org/nsedoc/scripts/ftp-bounce.html),[http-open-proxy](https://nmap.org/nsedoc/scripts/http-open-proxy.html), and [socks-open-proxy](https://nmap.org/nsedoc/scripts/socks-open-proxy.html) as "safe" rather than
  "intrusive" (keeping them in the "default" set).
* [NSE]Added a credential storage library ([creds.lua](https://nmap.org/nsedoc/lib/creds.html)) and modified
  the [brute](https://nmap.org/nsedoc/lib/brute.html) library and scripts to make use of it. [Patrik]
* [Ncat]Created a portable version of ncat.exe that you can just drop
  ...
  ([https://nmap.org/ncat/](https://nmap.org/ncat/)) for binary downloads and a link to build
...
* [NSE]The host.bin\_ip and host.bin\_ip\_src entries now also work with
...
* [NSE]Re-worked [http-form-brute](https://nmap.org/nsedoc/scripts/http-form-brute.html).nse to better autodetect form
...
* [Zenmap]Changed the "slow comprehensive scan" profile's NSE script
  ...
  rarely desirable.
* [NSE]Added the stdnse.silent\_require method which is used for
  ...
  called with silent\_require and fail to load, the script will cease
...
* [Zenmap]Fixed a bug in topology mapper which caused endpoints
  behind firewalls to sometimes show up in the wrong place (see[http://seclists.org/nmap-dev/2011/q2/733](http://seclists.org/nmap-dev/2011/q2/733)). [Colin Rice]
...
* [Ndiff]Added nmaprun element information (Nmap version, scan date,
  etc.) to the diff. Also, the Nmap [banner](https://nmap.org/nsedoc/scripts/banner.html) with version number and
  data is now only printed if there were other differences in the
  scan. [Daniel Miller, David, Dr. Jesus]
* [NSE]Added nmap.get\_interface and nmap.get\_interface\_info functions
  so scripts can access characteristics of the scanning interface.
  Removed nmap.get\_interface\_link. [Djalal]
...
* Removed the -sR (RPC scan) option--it is now an alias for -sV
  (version scan), which always does RPC scan when an [rpcinfo](https://nmap.org/nsedoc/scripts/rpcinfo.html) service
  is detected.
...
* [NSE]Fixed http.validate\_options when handling a cookie table.
  [Sebastian Prengel]
* Added a Service Tags UDP probe for port 6481/udp. [David]
* [NSE]Enabled [firewalk](https://nmap.org/nsedoc/scripts/firewalk.html).nse to automatically find the gateways at
...
* [Zenmap]Worked around a pycairo bug that prevented saving the
  ...
  Surface.write\_to\_png takes one argument which must be a filename
...
* We no longer support Nmap on versions of Windows earlier than XP
  ...
  But if you must use Nmap on such systems anyway, please see[https://secwiki.org/w/Nmap\_On\_Old\_Windows\_Releases](https://secwiki.org/w/Nmap_On_Old_Windows_Releases).
...
* [NSE]Fixed a bug which caused some NSE scripts to fail due to the
  absence of the NSE SCRIPT\_NAME environment variable when loaded.
...
* Fixed an obscure bug in Windows interface matching. If the MAC
  ...
  the problem. [David]
* [NSE]Fixed portrules in [dns-zone-transfer](https://nmap.org/nsedoc/scripts/dns-zone-transfer.html) and [ftp-proftpd-backdoor](https://nmap.org/nsedoc/scripts/ftp-proftpd-backdoor.html)that used shortport functions incorrectly and always returned
  true. [Jost Krieger]
...
* [Ndiff]Fixed the ordering of hostscript-related elements in XML
  output. [Daniel Miller]
* [NSE]Fixed a bug in the [nrpe-enum](https://nmap.org/nsedoc/scripts/nrpe-enum.html) script that would make it run for
...
* [Nping]Added echo mode, a novel technique for discovering how your
  ...
  Or learn more about echo mode at[https://nmap.org/book/nping-man-echo-mode.html](https://nmap.org/book/nping-man-echo-mode.html) . [Luis]
* [NSE]Added an amazing 46 scripts, bringing the total to 177! You
  can learn more about any of them at [https://nmap.org/nsedoc/](https://nmap.org/nsedoc/). Here
  are the new ones (authors listed in brackets):
  * [broadcast-dns-service-discovery](https://nmap.org/nsedoc/scripts/broadcast-dns-service-discovery.html): Attempts to discover hosts'
    services using the DNS Service Discovery protocol. It sends a
    multicast DNS-SD query and collects all the responses. [Patrik
    Karlsson]
  * [broadcast-dropbox-listener](https://nmap.org/nsedoc/scripts/broadcast-dropbox-listener.html): Listens for the LAN sync information
  ...
  * [broadcast-ms-sql-discover](https://nmap.org/nsedoc/scripts/broadcast-ms-sql-discover.html): Discovers Microsoft SQL servers in the
    same broadcast domain. [Patrik Karlsson]
  * [broadcast-upnp-info](https://nmap.org/nsedoc/scripts/broadcast-upnp-info.html): Attempts to extract system information from the
    UPnP service by sending a multicast query, then collecting,
    parsing, and displaying all responses. [Patrik Karlsson]
  * [broadcast-wsdd-discover](https://nmap.org/nsedoc/scripts/broadcast-wsdd-discover.html): Uses a multicast query to discover devices
  ...
  * db2-discover: Attempts to discover DB2 servers on the network by
    ...
    Karlsson]
  * [dns-update](https://nmap.org/nsedoc/scripts/dns-update.html).nse: Attempts to perform an unauthenticated dynamic DNS
    update. [Patrik Karlsson]
  * [domcon-brute](https://nmap.org/nsedoc/scripts/domcon-brute.html): Performs brute force password auditing against the
    Lotus Domino Console. [Patrik Karlsson]
  * [domcon-cmd](https://nmap.org/nsedoc/scripts/domcon-cmd.html): Runs a console command on the Lotus Domino Console with
    the given authentication credentials (see also: [domcon-brute](https://nmap.org/nsedoc/scripts/domcon-brute.html)).
    [Patrik Karlsson]
  * [domino-enum-users](https://nmap.org/nsedoc/scripts/domino-enum-users.html): Attempts to discover valid IBM Lotus Domino users
    and download their ID files by exploiting the CVE-2006-5835
    vulnerability. [Patrik Karlsson]
  * [firewalk](https://nmap.org/nsedoc/scripts/firewalk.html): Tries to discover firewall rules using an IP TTL
    expiration technique known as firewalking. [Henri Doreau]
  * [ftp-proftpd-backdoor](https://nmap.org/nsedoc/scripts/ftp-proftpd-backdoor.html): Tests for the presence of the ProFTPD 1.3.3c
  ...
  * [giop-info](https://nmap.org/nsedoc/scripts/giop-info.html): Queries a CORBA naming server for a list of
    objects. [Patrik Karlsson]
  * [gopher-ls](https://nmap.org/nsedoc/scripts/gopher-ls.html): Lists files and directories at the root of a gopher
    service. Remember those? [Toni Ruottu]
  * [hddtemp-info](https://nmap.org/nsedoc/scripts/hddtemp-info.html): Reads hard disk information (such as brand, model, and
  ...
  * hostmap: Tries to find hostnames that resolve to the target's IP
    address by querying the online database at[http://www.bfk.de/bfk\_dnslogger.html](http://www.bfk.de/bfk_dnslogger.html) . [Ange Gutek]
  * [http-brute](https://nmap.org/nsedoc/scripts/http-brute.html): Performs brute force password auditing against http
    basic authentication. [Patrik Karlsson]
  * [http-domino-enum-passwords](https://nmap.org/nsedoc/scripts/http-domino-enum-passwords.html): Attempts to enumerate the hashed Domino
  ...
  * [http-form-brute](https://nmap.org/nsedoc/scripts/http-form-brute.html): Performs brute force password auditing against http
    form-based authentication. [Patrik Karlsson]
  * [http-vhosts](https://nmap.org/nsedoc/scripts/http-vhosts.html): Searches for web virtual hostnames by making a large
    number of HEAD requests against http servers using common
    hostnames. [Carlos Pantelides]
  * [informix-brute](https://nmap.org/nsedoc/scripts/informix-brute.html): Performs brute force password auditing against
    IBM Informix Dynamic Server. [Patrik Karlsson]
  * [informix-query](https://nmap.org/nsedoc/scripts/informix-query.html): Runs a query against IBM Informix Dynamic Server
    using the given authentication credentials (see also:[informix-brute](https://nmap.org/nsedoc/scripts/informix-brute.html)). [Patrik Karlsson]
  * [informix-tables](https://nmap.org/nsedoc/scripts/informix-tables.html): Retrieves a list of tables and column definitions
    for each database on an Informix server. [Patrik Karlsson]
  * [iscsi-brute](https://nmap.org/nsedoc/scripts/iscsi-brute.html): Performs brute force password auditing against iSCSI
    targets. [Patrik Karlsson]
  * [iscsi-info](https://nmap.org/nsedoc/scripts/iscsi-info.html): Collects and displays information from remote iSCSI
    targets. [Patrik Karlsson]
  * [modbus-discover](https://nmap.org/nsedoc/scripts/modbus-discover.html): Enumerates SCADA Modbus slave ids (sids) and
    collects their device information. [Alexander Rudakov]
  * [nat-pmp-info](https://nmap.org/nsedoc/scripts/nat-pmp-info.html): Queries a NAT-PMP service for its external
    address. [Patrik Karlsson]
  * [netbus-auth-bypass](https://nmap.org/nsedoc/scripts/netbus-auth-bypass.html): Checks if a NetBus server is vulnerable to an
    authentication bypass vulnerability which allows full access
    without knowing the password. [Toni Ruottu]
  * [netbus-brute](https://nmap.org/nsedoc/scripts/netbus-brute.html): Performs brute force password auditing against the
    Netbus backdoor ("remote administration") service. [Toni Ruottu]
  * [netbus-info](https://nmap.org/nsedoc/scripts/netbus-info.html): Opens a connection to a NetBus server and extracts
    information about the host and the NetBus service itself. [Toni
    Ruottu]
  * [netbus-version](https://nmap.org/nsedoc/scripts/netbus-version.html): Extends version detection to detect NetBuster, a
    honeypot service that mimes NetBus. [Toni Ruottu]
  * [nrpe-enum](https://nmap.org/nsedoc/scripts/nrpe-enum.html): Queries Nagios Remote Plugin Executor (NRPE) daemons to
    obtain information such as load averages, process counts, logged in
    user information, etc. [Mak Kolybabi]
  * [oracle-brute](https://nmap.org/nsedoc/scripts/oracle-brute.html): Performs brute force password auditing against Oracle
    servers. [Patrik Karlsson]
  * [oracle-enum-users](https://nmap.org/nsedoc/scripts/oracle-enum-users.html): Attempts to enumerate valid Oracle user names
    against unpatched Oracle 11g servers (this bug was fixed in
    Oracle's October 2009 Critical Patch Update). [Patrik Karlsson]
  * [path-mtu](https://nmap.org/nsedoc/scripts/path-mtu.html): Performs simple Path MTU Discovery to target hosts. [Kris
    Katterjohn]
  * [resolveall](https://nmap.org/nsedoc/scripts/resolveall.html): Resolves hostnames and adds every address (IPv4 or IPv6,
    ...
    Katterjohn]
  * [rmi-dumpregistry](https://nmap.org/nsedoc/scripts/rmi-dumpregistry.html): Connects to a remote RMI registry and attempts to
    dump all of its objects. [Martin Holst Swende]
  * [smb-flood](https://nmap.org/nsedoc/scripts/smb-flood.html): Exhausts a remote SMB server's connection limit by by
  ...
  * [ssh2-enum-algos](https://nmap.org/nsedoc/scripts/ssh2-enum-algos.html): Reports the number of algorithms (for encryption,
  ...
  * [stuxnet-detect](https://nmap.org/nsedoc/scripts/stuxnet-detect.html): Detects whether a host is infected with the Stuxnet
    worm ([http://en.wikipedia.org/wiki/Stuxnet](http://en.wikipedia.org/wiki/Stuxnet)). [Mak Kolybabi]
  * [svn-brute](https://nmap.org/nsedoc/scripts/svn-brute.html): Performs brute force password auditing against Subversion
    source code control servers. [Patrik Karlsson]
  * [targets-traceroute](https://nmap.org/nsedoc/scripts/targets-traceroute.html): Inserts traceroute hops into the Nmap scanning
    queue. It only functions if Nmap's --traceroute option is used and
    the newtargets script argument is given. [Henri Doreau]
  * [vnc-brute](https://nmap.org/nsedoc/scripts/vnc-brute.html): Performs brute force password auditing against VNC
    servers. [Patrik Karlsson]
  * [vnc-info](https://nmap.org/nsedoc/scripts/vnc-info.html): Queries a VNC server for its protocol version and
    supported security types. [Patrik Karlsson]
  * [wdb-version](https://nmap.org/nsedoc/scripts/wdb-version.html): Detects vulnerabilities and gathers information (such
    as version numbers and hardware support) from VxWorks Wind DeBug
    agents. [Daniel Miller]
  * [wsdd-discover](https://nmap.org/nsedoc/scripts/wsdd-discover.html): Retrieves and displays information from devices
    supporting the Web Services Dynamic Discovery (WS-Discovery)
    protocol. It also attempts to locate any published Windows
    Communication Framework (WCF) web services (.NET 4.0 or
    later). [Patrik Karlsson]
...
* [NSE]Added 12 new protocol libraries:
  * [dhcp.lua](https://nmap.org/nsedoc/lib/dhcp.html) by Ron
  * [dnssd.lua](https://nmap.org/nsedoc/lib/dnssd.html) (DNS Service Discovery) by Patrik
  * [ftp.lua](https://nmap.org/nsedoc/lib/ftp.html) by David
  * [giop.lua](https://nmap.org/nsedoc/lib/giop.html) (CORBA naming service) by Patrik
  * [informix.lua](https://nmap.org/nsedoc/lib/informix.html) (Informix database) by Patrik
  * [iscsi.lua](https://nmap.org/nsedoc/lib/iscsi.html) (iSCSI - IP based SCSI data transfer) by Patrik
  * [nrpc.lua](https://nmap.org/nsedoc/lib/nrpc.html) (Lotus Domino RPC) by Patrik
  * [rmi.lua](https://nmap.org/nsedoc/lib/rmi.html) (Java Remote Method Invocation) by Martin Holst Swende
  * [tns.lua](https://nmap.org/nsedoc/lib/tns.html) (Oracle) by Patrik
  * [upnp.lua](https://nmap.org/nsedoc/lib/upnp.html) (UPnP support) by Thomas Buchanan and Patrik
  * [vnc.lua](https://nmap.org/nsedoc/lib/vnc.html) (Virtual Network Computing) by Patrik
  * [wsdd.lua](https://nmap.org/nsedoc/lib/wsdd.html) (Web Service Dynamic Discovery) by Patrik

* [NSE]Added a new [brute](https://nmap.org/nsedoc/lib/brute.html) library that provides a basic framework and logic
...
* Performed a major OS detection integration run. The database has
  ...
  David posted highlights of his integration work at[http://seclists.org/nmap-dev/2010/q4/651](http://seclists.org/nmap-dev/2010/q4/651)
* Performed a huge version detection integration run. The number of
  ...
  zeo, and zmodem. David posted highlights at[http://seclists.org/nmap-dev/2010/q4/761](http://seclists.org/nmap-dev/2010/q4/761).
* [NSE]Added the [target](https://nmap.org/nsedoc/lib/target.html) NSE library which allows scripts to add newly
  ...
  can now use this feature include [dns-zone-transfer](https://nmap.org/nsedoc/scripts/dns-zone-transfer.html), hostmap,[ms-sql-info](https://nmap.org/nsedoc/scripts/ms-sql-info.html), [snmp-interfaces](https://nmap.org/nsedoc/scripts/snmp-interfaces.html), [targets-traceroute](https://nmap.org/nsedoc/scripts/targets-traceroute.html), and several
  more. [Djalal]
* [NSE]Nmap has two new NSE script scanning phases. The new pre-scan
  ...
  found to be running each service. See[https://nmap.org/book/nse-usage.html#nse-script-types](https://nmap.org/book/nse-usage.html#nse-script-types). [Djalal]
...
* Dramatically improved nmap.xsl (used for converting Nmap XML output
  ...
  * Added a floating menu to the lower-right for toggling whether
  ...
  file at [https://nmap.org/svn/docs/nmap.xsl](https://nmap.org/svn/docs/nmap.xsl), and here is an example
  scan processed through it: [https://nmap.org/book/output-formats-output-to-html.html](https://nmap.org/book/output-formats-output-to-html.html) . [Tom]
...
* Integrated cracked passwords from the Gawker.com compromise
  ([http://seclists.org/nmap-dev/2010/q4/674](http://seclists.org/nmap-dev/2010/q4/674)) into Nmap's top-5000
...
* Updated the Windows build process to work with (and require) Visual
  ...
  need Python 2.7 (rather than 2.6) and GTK+ 2.22. See[https://nmap.org/book/inst-windows.html#inst-win-source](https://nmap.org/book/inst-windows.html#inst-win-source) [David, Rob
  Nicholls, KX]
* Merged port names in the nmap-services file with allocated names
  from the IANA ([http://www.iana.org/assignments/port-numbers](http://www.iana.org/assignments/port-numbers)). We
...
* Enabled the ASLR and DEP security technologies for Nmap.exe,
  ...
  implemented. See [http://seclists.org/nmap-dev/2010/q3/328](http://seclists.org/nmap-dev/2010/q3/328). [Robert]
* Investigated using the CPE (Common Platform Enumeration) standard
  ...
  Nmap OS and service detection. You can read David's reports at[http://seclists.org/nmap-dev/2010/q3/278](http://seclists.org/nmap-dev/2010/q3/278) and[http://seclists.org/nmap-dev/2010/q3/303](http://seclists.org/nmap-dev/2010/q3/303).
...
* [NSE]Added the ability to send and receive on unconnected sockets.
  ...
  * [upnp-info](https://nmap.org/nsedoc/scripts/upnp-info.html)
  * [dns-service-discovery](https://nmap.org/nsedoc/scripts/dns-service-discovery.html)

  The nmap.new\_socket function can now optionally take a default
...
* [Nping]Substantially improved the Nping man page. You can read it
  online at [https://nmap.org/book/nping-man.html](https://nmap.org/book/nping-man.html) . [Luis, David]
* Documented the licenses of the third-party software used by Nmap and
  its sibling tools:[https://svn.nmap.org/nmap/docs/3rd-party-licenses.txt](https://svn.nmap.org/nmap/docs/3rd-party-licenses.txt) . [David]
* [NSE]Improved the SMB scripts so that they can run in parallel
  ...
  the SMB scan speed in one large scale test. See[http://seclists.org/nmap-dev/2010/q3/819](http://seclists.org/nmap-dev/2010/q3/819). [Ron]
* Added a simple Nmap NSE script template to make writing new scripts
  easier: [https://nmap.org/svn/docs/sample-script.nse](https://nmap.org/svn/docs/sample-script.nse). [Ron]
...
* [NSE]Added the get\_script\_args NSE function for parsing script
  arguments in a clean and standardized way
  ([https://nmap.org/nsedoc/lib/stdnse.html#get\_script\_args](https://nmap.org/nsedoc/lib/stdnse.html#get_script_args)). [Djalal]
...
* Fix Nmap compilation on OpenSolaris (see[http://blogs.sun.com/sdaven/entry/nmap\_5\_35dc1\_compile\_on](http://blogs.sun.com/sdaven/entry/nmap_5_35dc1_compile_on)) [David]
* [NSE]The [http](https://nmap.org/nsedoc/lib/http.html) library's request functions now accept an additional
...
* [NSE]Made [dns-zone-transfer](https://nmap.org/nsedoc/scripts/dns-zone-transfer.html) script able to add new discovered DNS
  records to the Nmap scanning queue. [Djalal]
* [NSE]Enhance [ssl-cert](https://nmap.org/nsedoc/scripts/ssl-cert.html) to also report the type and bit size of SSL
...
* [Nping]Fixed a bug which caused Nping to fail when targeting
  broadcast addresses (see[http://seclists.org/nmap-dev/2010/q3/752](http://seclists.org/nmap-dev/2010/q3/752)). [Luis]
* [Nping]Nping now limits concurrent open file descriptors properly
  based on the resources available on the host (see[http://seclists.org/nmap-dev/2010/q4/2](http://seclists.org/nmap-dev/2010/q4/2)). [Luis]
* [NSE]Improved ssh2's kex\_init() parameters: all of the algorithm
...
* [NSE]Added prerule support to [snmp-interfaces](https://nmap.org/nsedoc/scripts/snmp-interfaces.html) and the ability to
...
* [NSE]Fixed a bug with worker threads calling the wrong destructors.
  Fixing this allows better parallelism in [http-brute](https://nmap.org/nsedoc/scripts/http-brute.html).nse. The problem
...
* [NSE]Added prerule support to the [dns-zone-transfer](https://nmap.org/nsedoc/scripts/dns-zone-transfer.html) script,
  ...
  arguments. [Djalal]
* Changed the name of libdnet's sctp\_chunkhdr to avoid a conflict with
...
* [NSE]Made the [ftp-anon](https://nmap.org/nsedoc/scripts/ftp-anon.html) script return a directory listing when
...
* [NSE]Added the nmap.address\_family() function which returns the address
...
* [Nsock]Added a new function, nsi\_set\_hostname, to set the intended
  hostname of the target. This allows the use of Server Name
  Indication in SSL connections. [David]
* [NSE]Limits the number of ports that [qscan](https://nmap.org/nsedoc/scripts/qscan.html) will scan (now up to 8
  open ports and up to 1 closed port by default). These limits can be
  controlled with the [qscan](https://nmap.org/nsedoc/scripts/qscan.html).numopen and [qscan](https://nmap.org/nsedoc/scripts/qscan.html).numclosed script
  arguments. [David]
* [NSE]Made [sslv2](https://nmap.org/nsedoc/scripts/sslv2.html).nse give special output when SSLv2 is supported,
...
* [NSE]Added a "times" table to the host table passed to scripts.
  ...
  as floating-point seconds. The [ipidseq](https://nmap.org/nsedoc/scripts/ipidseq.html) and [qscan](https://nmap.org/nsedoc/scripts/qscan.html) scripts were
...
* [NSE]When receiving raw packets from Pcap, the packet capture time
  ...
  pcap\_receive(). It is returned as the floating point number of
  seconds since the epoch. Also added the nmap.clock() function which
  returns the current time (and convenience functions clock\_ms() and
  clock\_us()). Qscan.nse was updated to use this more accurate timing
  data. [Kris]
* [Ncat,Nsock]Fixed some minor bugs discovered using the Smatch
  source code analyzer ([http://smatch.sourceforge.net/](http://smatch.sourceforge.net/)). [David]
...
* Added a new packet payload--a NAT-PMP external address request for
  ...
  payload goes well with our new [nat-pmp-info](https://nmap.org/nsedoc/scripts/nat-pmp-info.html) script. [David, Patrik]
...
* [NSE]There is now a limit of 1,000 concurrent running scripts,
  ...
  can be controlled with the variable CONCURRENCY\_LIMIT in
  nse\_main.lua. [David]
...
* [NSE]Added 17 scripts, bringing the total to 131! They are
  ...
  ones:[afp-serverinfo](https://nmap.org/nsedoc/scripts/afp-serverinfo.html), db2-brute, [dns-cache-snoop](https://nmap.org/nsedoc/scripts/dns-cache-snoop.html), [dns-fuzz](https://nmap.org/nsedoc/scripts/dns-fuzz.html), [ftp-libopie](https://nmap.org/nsedoc/scripts/ftp-libopie.html)[http-php-version](https://nmap.org/nsedoc/scripts/http-php-version.html), [irc-unrealircd-backdoor](https://nmap.org/nsedoc/scripts/irc-unrealircd-backdoor.html), [ms-sql-brute](https://nmap.org/nsedoc/scripts/ms-sql-brute.html),[ms-sql-config](https://nmap.org/nsedoc/scripts/ms-sql-config.html), [ms-sql-empty-password](https://nmap.org/nsedoc/scripts/ms-sql-empty-password.html), [ms-sql-hasdbaccess](https://nmap.org/nsedoc/scripts/ms-sql-hasdbaccess.html),[ms-sql-query](https://nmap.org/nsedoc/scripts/ms-sql-query.html), [ms-sql-tables](https://nmap.org/nsedoc/scripts/ms-sql-tables.html), [ms-sql-xp-cmdshell](https://nmap.org/nsedoc/scripts/ms-sql-xp-cmdshell.html), [nfs-ls](https://nmap.org/nsedoc/scripts/nfs-ls.html),[ntp-monlist](https://nmap.org/nsedoc/scripts/ntp-monlist.html) .
  Learn more about any of these at: [https://nmap.org/nsedoc/](https://nmap.org/nsedoc/)
* Performed a major OS detection integration run. The database has
  ...
  integration work at [http://seclists.org/nmap-dev/2010/q2/283](http://seclists.org/nmap-dev/2010/q2/283).
* Performed a large version detection integration run. The number of
  ...
  Frozen Bubble. You can read David's highlights at[http://seclists.org/nmap-dev/2010/q2/385](http://seclists.org/nmap-dev/2010/q2/385).
* [NSE]Added [nfs-ls](https://nmap.org/nsedoc/scripts/nfs-ls.html).nse, which lists NFS exported files and their
...
* [NSE]Add new DB2 library and two scripts
  * db2-brute.nse uses the [unpwdb](https://nmap.org/nsedoc/lib/unpwdb.html) library to guess credentials for DB2
...
* [NSE]Added a library for Microsoft SQL Server and 7 new scripts. The new
  scripts are:
  * [ms-sql-brute](https://nmap.org/nsedoc/scripts/ms-sql-brute.html).nse uses the [unpwdb](https://nmap.org/nsedoc/lib/unpwdb.html) library to guess credentials for MSSQL
  * [ms-sql-config](https://nmap.org/nsedoc/scripts/ms-sql-config.html) retrieves various configuration details from the server
  * [ms-sql-empty-password](https://nmap.org/nsedoc/scripts/ms-sql-empty-password.html) checks if the sa account has an empty password
  * [ms-sql-hasdbaccess](https://nmap.org/nsedoc/scripts/ms-sql-hasdbaccess.html) lists database access per user
  * [ms-sql-query](https://nmap.org/nsedoc/scripts/ms-sql-query.html) add support for running custom queries against the database
  * [ms-sql-tables](https://nmap.org/nsedoc/scripts/ms-sql-tables.html) lists databases, tables, columns and datatypes with optional
    keyword filtering
  * [ms-sql-xp-cmdshell](https://nmap.org/nsedoc/scripts/ms-sql-xp-cmdshell.html) adds support for OS command execution to privileged
    users

  [Patrik]
* [NSE]Added the [afp-serverinfo](https://nmap.org/nsedoc/scripts/afp-serverinfo.html) script that gets a hostname, IP
  addresses, and other configuration information from an AFP server.
  The script, and a patch to the [afp](https://nmap.org/nsedoc/lib/afp.html) library, were contributed by
...
* [NSE]Added additional vulnerability checks to smb-check-vulns.nse:
  ...
  ([http://www.microsoft.com/technet/security/bulletin/ms06-025.mspx](http://www.microsoft.com/technet/security/bulletin/ms06-025.mspx))
...
* [NSE]Added [dns-cache-snoop](https://nmap.org/nsedoc/scripts/dns-cache-snoop.html).nse by Eugene Alexeev. This script performs
...
* [NSE]Scripts which take an argument for a time duration can now
  ...
  function stdnse.parse\_timespec does the parsing of these
  formats. The [qscan](https://nmap.org/nsedoc/scripts/qscan.html).delay script argument, which formerly interpreted
  its argument as being in milliseconds, now defaults to seconds;
  append "ms" to continue using the same numbers. [David]
* [NSE]Added [irc-unrealircd-backdoor](https://nmap.org/nsedoc/scripts/irc-unrealircd-backdoor.html).nse, which detects a backdoor
  that was in UnrealIRCd source code distributions between November
  2009 and June 2010. See [http://seclists.org/nmap-dev/2010/q2/826](http://seclists.org/nmap-dev/2010/q2/826).
...
* Ports are now considered open during a SYN scan if a SYN packet
  ...
  handshake connection. see [http://bit.ly/tcp-sh](http://bit.ly/tcp-sh) and[http://seclists.org/nmap-dev/2010/q2/723](http://seclists.org/nmap-dev/2010/q2/723). [Jah]
...
* [NSE]Added [ftp-libopie](https://nmap.org/nsedoc/scripts/ftp-libopie.html).nse by Gutek. This script checks for an
  off-by-one stack overflow vulnerability in libopie by giving the FTP
  service an overly long name. See[http://security.freebsd.org/advisories/FreeBSD-SA-10:05.opie.asc](http://security.freebsd.org/advisories/FreeBSD-SA-10:05.opie.asc) for
  details.
* [NSE]Added [ntp-monlist](https://nmap.org/nsedoc/scripts/ntp-monlist.html).nse which discovers NTP server, peer and
  client hosts associated with a scanned target by sending NTPv2
  Private Mode 'monitor' and 'peers' commands to the target. [Jah]
* [NSE]Added [http-php-version](https://nmap.org/nsedoc/scripts/http-php-version.html).nse from Gutek. This script retrieves
  ...
  it.
* [NSE]New script [dns-fuzz](https://nmap.org/nsedoc/scripts/dns-fuzz.html) launches a fuzzing attack against DNS
...
* David made many improvements to the NSEDoc for individual scripts,
  ...
  and contract. See [https://nmap.org/nsedoc/](https://nmap.org/nsedoc/).
...
* The Windows executable installer now uses LZMA compression instead
  of zlib, making it about 15% smaller. See[http://seclists.org/nmap-dev/2010/q2/1011](http://seclists.org/nmap-dev/2010/q2/1011) for test results. [David]
...
* Fixed name resolution in environments where gethostbyname can return
  ...
  RES\_OPTIONS=inet6 in the environment. This was reported by Mats Erik
...
* Nmap now works if you specify several target host names which
  ...
  machine. [David]
* Made a list of current Nmap SVN committers:[https://svn.nmap.org/nmap/docs/committers.txt](https://svn.nmap.org/nmap/docs/committers.txt)
...
* [NSE][http-passwd](https://nmap.org/nsedoc/scripts/http-passwd.html).nse now also checks for boot.ini to support
...
* [NSE]Added UDP header parsing support to [packet.lua](https://nmap.org/nsedoc/lib/packet.html). [jah]
...
* [NSE]Fixed a bug in [qscan](https://nmap.org/nsedoc/scripts/qscan.html).nse which gave an error if a confidence
...
* [Nsock, Ncat]Nsock has a new function, nsp\_setbroadcast, that
  allows setting the SO\_BROADCAST option on sockets. Ncat now sets
...
* Moved the parse\_long function from ncat to nbase for better reuse,
...
* Added EPROTO to the list of known error codes in service scan. Daniel
  ...
  "Unexpected error in NSE\_TYPE\_READ callback. Error code: 71 (Protocol
  error)". We suspect this was caused by a forged ICMP packet sent by an
  active firewall. [David]
* [NSE]Improved [smtp-commands](https://nmap.org/nsedoc/scripts/smtp-commands.html).nse to work against more mail servers,
  made it take an [smtp-commands](https://nmap.org/nsedoc/scripts/smtp-commands.html).domain script argument, and rewrote it
  in the style of other smtp scripts. [Jasey DePriest]
* [NSE]Made [smtp-commands](https://nmap.org/nsedoc/scripts/smtp-commands.html) run for the services smtp, smtps,
  submission rather than just smtp. The other smtp scripts already do
  this. [David]
* [NSE]The [dns-recursion](https://nmap.org/nsedoc/scripts/dns-recursion.html) script now marks the port as open when it
...
* [NSE]Add some special-use IPv4 addresses to isPrivate which are
  ...
  performance of isPrivate for IPv4 addresses by using ip\_in\_range
...
* Fix compilation on OpenSolaris. We had to make the libdnet autoconf
  check for PF\_PACKET Linux-specific. Recent versions of OpenSolaris
  support PF\_PACKET, but not in a way which is entirely compatible
...
* [NSE]Added script arguments "username" and "password" to [ftp-bounce](https://nmap.org/nsedoc/scripts/ftp-bounce.html)to override the default anonymous:IEUser@ login combination. [Kris]
* [NSE]Added port number sorting to [dns-service-discovery](https://nmap.org/nsedoc/scripts/dns-service-discovery.html).nse. [Patrik]
* [NSE]Added an snmpWalk() function to the SNMP library and updated
  scripts to use it. [Patrik]
* [NSE]Fixed this [dns.lua](https://nmap.org/nsedoc/lib/dns.html) error reported by Eugene Alexeev:
...
* Created a new directory for storing todo lists for Nmap and related
  ...
  visiting [https://nmap.org/svn/todo/](https://nmap.org/svn/todo/).
* [NSE]Removed explicit time limit checking from [ms-sql-brute](https://nmap.org/nsedoc/scripts/ms-sql-brute.html),[pgsql-brute](https://nmap.org/nsedoc/scripts/pgsql-brute.html), [mysql-brute](https://nmap.org/nsedoc/scripts/mysql-brute.html), [ldap-brute](https://nmap.org/nsedoc/scripts/ldap-brute.html), and [afp-brute](https://nmap.org/nsedoc/scripts/afp-brute.html). The [unpwdb](https://nmap.org/nsedoc/lib/unpwdb.html)library does this automatically now. [David]
* [NSE]Correct global access errors in [afp.lua](https://nmap.org/nsedoc/lib/afp.html) reported by Patrick Donnelly
  [Patrik]
...
* Cleaned up our Winpcap header file directory, and also updated to
  ...
  (WpdPack\_4\_1\_1.zip). [Fyodor]
* [NSE]Fixed a bug which would prevent [rpcinfo](https://nmap.org/nsedoc/scripts/rpcinfo.html).nse from returning any
  results for RPC programs which could not be matched to a
  name. [Patrik]
* [NSE]The [ftp-anon](https://nmap.org/nsedoc/scripts/ftp-anon.html) script is now much smarter about parsing server
...
* [NSE]Fixed bug in [rpc.lua](https://nmap.org/nsedoc/lib/rpc.html) library that incorrectly required file handles
  to be 32 octets when calling the ReadDir function. The bug was reported by
  Djalal Harouni. [Patrik]

### Nmap 5.30BETA1 [2010-03-29] [§](https://nmap.org/changelog.html#5.30BETA1) ###

* [NSE]Added 37 scripts, bringing the total to 117! They are
  described individually in the CHANGELOG, but here is the list of new
  ones:[afp-brute](https://nmap.org/nsedoc/scripts/afp-brute.html) [afp-path-vuln](https://nmap.org/nsedoc/scripts/afp-path-vuln.html) [afp-showmount](https://nmap.org/nsedoc/scripts/afp-showmount.html) [couchdb-databases](https://nmap.org/nsedoc/scripts/couchdb-databases.html)[couchdb-stats](https://nmap.org/nsedoc/scripts/couchdb-stats.html) [daap-get-library](https://nmap.org/nsedoc/scripts/daap-get-library.html) [db2-das-info](https://nmap.org/nsedoc/scripts/db2-das-info.html) [dns-service-discovery](https://nmap.org/nsedoc/scripts/dns-service-discovery.html)[http-methods](https://nmap.org/nsedoc/scripts/http-methods.html) [http-vmware-path-vuln](https://nmap.org/nsedoc/scripts/http-vmware-path-vuln.html) [ipidseq](https://nmap.org/nsedoc/scripts/ipidseq.html) [jdwp-version](https://nmap.org/nsedoc/scripts/jdwp-version.html) [ldap-brute](https://nmap.org/nsedoc/scripts/ldap-brute.html)[ldap-rootdse](https://nmap.org/nsedoc/scripts/ldap-rootdse.html) [ldap-search](https://nmap.org/nsedoc/scripts/ldap-search.html) [lexmark-config](https://nmap.org/nsedoc/scripts/lexmark-config.html) [mongodb-databases](https://nmap.org/nsedoc/scripts/mongodb-databases.html)[mongodb-info](https://nmap.org/nsedoc/scripts/mongodb-info.html) [mysql-brute](https://nmap.org/nsedoc/scripts/mysql-brute.html) [mysql-databases](https://nmap.org/nsedoc/scripts/mysql-databases.html) [mysql-empty-password](https://nmap.org/nsedoc/scripts/mysql-empty-password.html)[mysql-users](https://nmap.org/nsedoc/scripts/mysql-users.html) [mysql-variables](https://nmap.org/nsedoc/scripts/mysql-variables.html) nfs-acls nfs-dirlist [nfs-statfs](https://nmap.org/nsedoc/scripts/nfs-statfs.html)[pgsql-brute](https://nmap.org/nsedoc/scripts/pgsql-brute.html) [qscan](https://nmap.org/nsedoc/scripts/qscan.html) [smtp-enum-users](https://nmap.org/nsedoc/scripts/smtp-enum-users.html) [snmp-interfaces](https://nmap.org/nsedoc/scripts/snmp-interfaces.html) [snmp-netstat](https://nmap.org/nsedoc/scripts/snmp-netstat.html)[snmp-processes](https://nmap.org/nsedoc/scripts/snmp-processes.html) [snmp-win32-services](https://nmap.org/nsedoc/scripts/snmp-win32-services.html) [snmp-win32-shares](https://nmap.org/nsedoc/scripts/snmp-win32-shares.html)[snmp-win32-software](https://nmap.org/nsedoc/scripts/snmp-win32-software.html) [snmp-win32-users](https://nmap.org/nsedoc/scripts/snmp-win32-users.html) [ssl-enum-ciphers](https://nmap.org/nsedoc/scripts/ssl-enum-ciphers.html).
  Learn more about any of these at: [https://nmap.org/nsedoc/](https://nmap.org/nsedoc/)
* [NSE]New script [afp-path-vuln](https://nmap.org/nsedoc/scripts/afp-path-vuln.html) detects and can exploit a major Mac
  OS X AFP directory traversal vulnerability (CVE-2010-0533)
  discovered by Nmap developer Patrik Karlsson. See[https://nmap.org/nsedoc/scripts/afp-path-vuln.html](https://nmap.org/nsedoc/scripts/afp-path-vuln.html) and[http://bit.ly/nmapafp](http://bit.ly/nmapafp).
* An ALPHA TEST VERSION of Nping, a packet generator written by Luis
  ...
  summer and then do an official release. See [https://nmap.org/nping/](https://nmap.org/nping/).
* [NSE]Added RPC library and three new NFS scripts. Modified the[rpcinfo](https://nmap.org/nsedoc/scripts/rpcinfo.html) and [nfs-showmount](https://nmap.org/nsedoc/scripts/nfs-showmount.html) scripts to use the new library. The new
  scripts are:
  * nfs-acls shows the owner and directory mode of NFS exports
    ([https://nmap.org/nsedoc/scripts/nfs-acls.html](https://nmap.org/nsedoc/scripts/nfs-acls.html)).
  * nfs-dirlist lists the contents of NFS exports
    ([https://nmap.org/nsedoc/scripts/nfs-dirlist.html](https://nmap.org/nsedoc/scripts/nfs-dirlist.html))
  * [nfs-statfs](https://nmap.org/nsedoc/scripts/nfs-statfs.html) shows file system statistics for NFS exports
    ([https://nmap.org/nsedoc/scripts/nfs-statfs.html](https://nmap.org/nsedoc/scripts/nfs-statfs.html)).

  [Patrik]
* [NSE]Added the new [dns-service-discovery](https://nmap.org/nsedoc/scripts/dns-service-discovery.html) script which uses DNS-SD
  ...
  port scan in some cases. See[https://nmap.org/nsedoc/scripts/dns-service-discovery.html](https://nmap.org/nsedoc/scripts/dns-service-discovery.html) . [Patrik
  Karlsson]
* [NSE]New script [afp-brute](https://nmap.org/nsedoc/scripts/afp-brute.html) for brute force authentication attempts
  against the Apple AFP filesharing protocol. See[https://nmap.org/nsedoc/scripts/afp-brute.html](https://nmap.org/nsedoc/scripts/afp-brute.html) . [Patrik]
* [NSE]Added a new script [afp-showmount](https://nmap.org/nsedoc/scripts/afp-showmount.html) which displays Apple AFP
  shares and their permissions. See[https://nmap.org/nsedoc/scripts/afp-showmount.html](https://nmap.org/nsedoc/scripts/afp-showmount.html) . [Patrik]
* [NSE]Added the [qscan](https://nmap.org/nsedoc/scripts/qscan.html) script to repeatedly probe ports on a host to
  ...
  functionality. See [https://nmap.org/nsedoc/scripts/qscan.html](https://nmap.org/nsedoc/scripts/qscan.html) . [Kris]
* [NSE]Added a new script, [db2-das-info](https://nmap.org/nsedoc/scripts/db2-das-info.html).nse, that connects to the IBM
  ...
  set the port product and version if a version scan is requested. See[https://nmap.org/nsedoc/scripts/db2-das-info.html](https://nmap.org/nsedoc/scripts/db2-das-info.html) . [Patrik Karlsson,
  Tom Sellers]
* [NSE]Added a new library for ASN.1 parsing and adapted the SNMP
  ...
  libraries:
  * [snmp-netstat](https://nmap.org/nsedoc/scripts/snmp-netstat.html) shows listening and connected
    sockets ([https://nmap.org/nsedoc/scripts/snmp-netstat.html](https://nmap.org/nsedoc/scripts/snmp-netstat.html)).
  * [snmp-processes](https://nmap.org/nsedoc/scripts/snmp-processes.html) shows process information including name, pid, path
    & parameters ([https://nmap.org/nsedoc/scripts/snmp-processes.html](https://nmap.org/nsedoc/scripts/snmp-processes.html)).
  * [snmp-win32-services](https://nmap.org/nsedoc/scripts/snmp-win32-services.html) shows the names of running Windows services
    ([https://nmap.org/nsedoc/scripts/snmp-win32-services.html](https://nmap.org/nsedoc/scripts/snmp-win32-services.html)).
  * [snmp-win32-shares](https://nmap.org/nsedoc/scripts/snmp-win32-shares.html) shows the names and path of Windows shares
    ([https://nmap.org/nsedoc/scripts/snmp-win32-shares.html](https://nmap.org/nsedoc/scripts/snmp-win32-shares.html)).
  * [snmp-win32-software](https://nmap.org/nsedoc/scripts/snmp-win32-software.html) shows a list of installed Windows software
    ([https://nmap.org/nsedoc/scripts/snmp-win32-software.html](https://nmap.org/nsedoc/scripts/snmp-win32-software.html)).
  * [snmp-win32-users](https://nmap.org/nsedoc/scripts/snmp-win32-users.html) shows a list of local Windows users
    ([https://nmap.org/nsedoc/scripts/snmp-win32-users.html](https://nmap.org/nsedoc/scripts/snmp-win32-users.html)).

  [Patrik]
* [NSE]Added the [snmp-interfaces](https://nmap.org/nsedoc/scripts/snmp-interfaces.html) script by Thomas Buchanan, which
  enumerates network interfaces over SNMP. See[https://nmap.org/nsedoc/scripts/snmp-interfaces.html](https://nmap.org/nsedoc/scripts/snmp-interfaces.html) .
* [NSE]Added [http-vmware-path-vuln](https://nmap.org/nsedoc/scripts/http-vmware-path-vuln.html).nse, which checks for a critical
  and easy to exploit path-traversal vulnerability in VMWare
  (CVE-2009-3733). See[https://nmap.org/nsedoc/scripts/http-vmware-path-vuln.html](https://nmap.org/nsedoc/scripts/http-vmware-path-vuln.html) . [Ron]
* [NSE]Added a new library for LDAP and three new scripts by Patrik:
  * [ldap-brute](https://nmap.org/nsedoc/scripts/ldap-brute.html) uses the [unpwdb](https://nmap.org/nsedoc/lib/unpwdb.html) library to guess credentials for LDAP
  ...
  * [ldap-search](https://nmap.org/nsedoc/scripts/ldap-search.html) queries a LDAP directory for either
    all, or a number of pre-defined object types
    ([https://nmap.org/nsedoc/scripts/ldap-search.html](https://nmap.org/nsedoc/scripts/ldap-search.html)).

* [NSE]Added a new library for PostgreSQL and the script [pgsql-brute](https://nmap.org/nsedoc/scripts/pgsql-brute.html)that uses it to guess credentials. See[https://nmap.org/nsedoc/scripts/pgsql-brute.html](https://nmap.org/nsedoc/scripts/pgsql-brute.html) . [Patrik]
* [NSE]Added 5 new MySQL NSE scripts and a MySQL library by Patrik Karlsson:
  * [mysql-brute](https://nmap.org/nsedoc/scripts/mysql-brute.html) uses the [unpwdb](https://nmap.org/nsedoc/lib/unpwdb.html) library to guess credentials for MySQL
    ([https://nmap.org/nsedoc/scripts/mysql-brute.html](https://nmap.org/nsedoc/scripts/mysql-brute.html)).
  * [mysql-databases](https://nmap.org/nsedoc/scripts/mysql-databases.html) queries MySQL for a list of databases
    ([https://nmap.org/nsedoc/scripts/mysql-databases.html](https://nmap.org/nsedoc/scripts/mysql-databases.html)).
  * [mysql-empty-password](https://nmap.org/nsedoc/scripts/mysql-empty-password.html) attempts to authenticate anonymously or as
    root with an empty password
    ([https://nmap.org/nsedoc/scripts/mysql-empty-password.html](https://nmap.org/nsedoc/scripts/mysql-empty-password.html)).
  * [mysql-users](https://nmap.org/nsedoc/scripts/mysql-users.html) queries MySQL for a list of database users
    ([https://nmap.org/nsedoc/scripts/mysql-users.html](https://nmap.org/nsedoc/scripts/mysql-users.html)).
  * [mysql-variables](https://nmap.org/nsedoc/scripts/mysql-variables.html) queries MySQL for its variables and their
    settings ([https://nmap.org/nsedoc/scripts/mysql-variables.html](https://nmap.org/nsedoc/scripts/mysql-variables.html)).
...
* Zenmap's "slow comprehensive scan profile" has been modified to use
  ...
  ([http://www.bamsoftware.com/wiki/nmap/EffectivenessOfPingProbes](http://www.bamsoftware.com/wiki/nmap/EffectivenessOfPingProbes)).
...
* Switched to -Pn and -sn and as the preferred syntax for skipping
  ...
  * -sn no port scan
  ...
  future.
* [NSE]Added the [ipidseq](https://nmap.org/nsedoc/scripts/ipidseq.html) script to classify a host's IP ID sequence
  ...
  functionality in NSE. See[https://nmap.org/nsedoc/scripts/ipidseq.html](https://nmap.org/nsedoc/scripts/ipidseq.html) . [Kris]
* [NSE]Added the [ssl-enum-ciphers](https://nmap.org/nsedoc/scripts/ssl-enum-ciphers.html) script by Mak Kolybabi. It lists
  the ciphers and compressors supported by SSL/TLS servers. See[https://nmap.org/nsedoc/scripts/ssl-enum-ciphers.html](https://nmap.org/nsedoc/scripts/ssl-enum-ciphers.html) .
* [NSE]Added two new scripts for the MongoDB database from Martin
  Holst Swende. [mongodb-info](https://nmap.org/nsedoc/scripts/mongodb-info.html)([https://nmap.org/nsedoc/scripts/mongodb-info.html](https://nmap.org/nsedoc/scripts/mongodb-info.html)) gets information
  like the version number, memory use, and operating system, while[mongodb-databases](https://nmap.org/nsedoc/scripts/mongodb-databases.html)([https://nmap.org/nsedoc/scripts/mongodb-databases.html](https://nmap.org/nsedoc/scripts/mongodb-databases.html)) lists the
  databases and their size on disk.
* [NSE]Added the scripts [couchdb-databases](https://nmap.org/nsedoc/scripts/couchdb-databases.html) and [couchdb-stats](https://nmap.org/nsedoc/scripts/couchdb-stats.html), which
  list CouchDB databases and show access statistics, and a new[json.lua](https://nmap.org/nsedoc/lib/json.html) library they depend on. See[https://nmap.org/nsedoc/scripts/couchdb-databases.html](https://nmap.org/nsedoc/scripts/couchdb-databases.html) and[https://nmap.org/nsedoc/scripts/couchdb-stats.html](https://nmap.org/nsedoc/scripts/couchdb-stats.html) [Martin Holst
  Swende]
* [NSE]Added the new [lexmark-config](https://nmap.org/nsedoc/scripts/lexmark-config.html) script that lists product
  information and configuration for Lexmark printers. See[https://nmap.org/nsedoc/scripts/lexmark-config.html](https://nmap.org/nsedoc/scripts/lexmark-config.html) . [Patrik
  Karlsson]
* [NSE]Added the new [daap-get-library](https://nmap.org/nsedoc/scripts/daap-get-library.html) script which uses the Digital
  Audio Access Protocol to enumerate the contents of a library. The
  contents contain the name of the artist, album and song. See[https://nmap.org/nsedoc/scripts/daap-get-library.html](https://nmap.org/nsedoc/scripts/daap-get-library.html) . [Patrik]
* [NSE]Added [jdwp-version](https://nmap.org/nsedoc/scripts/jdwp-version.html).nse, a script by Michael Schierl that finds
  ...
  bytecode into the debugged process. See[https://nmap.org/nsedoc/scripts/jdwp-version.html](https://nmap.org/nsedoc/scripts/jdwp-version.html) .
* [NSE]Added the [smtp-enum-users](https://nmap.org/nsedoc/scripts/smtp-enum-users.html) script from Duarte Silva, which
  attempts to find user account names over SMTP by brute force testing
  using RCPT, VRFY, and EXPN tests.
* [NSE]The [unpwdb](https://nmap.org/nsedoc/lib/unpwdb.html) library now has a default time limit on the
  ...
  * unpwdb.timelimit Time limit in seconds.
  ...
  Pass 0 for any of these limits to disable it. For more details, see[https://nmap.org/nsedoc/lib/unpwdb.html](https://nmap.org/nsedoc/lib/unpwdb.html) . [David]
* When --open is used, Nmap no longer prints output for hosts which
  ...
  XML output either.
* [NSE]Added the script [http-methods](https://nmap.org/nsedoc/scripts/http-methods.html) from Bernd Stroessenreuther.
  ...
  address or something similar. See[https://nmap.org/nsedoc/scripts/http-methods.html](https://nmap.org/nsedoc/scripts/http-methods.html) .
...
* [NSE]Raw packet sending at the IP layer is now supported, in
  ...
  hosts. For details, see[https://nmap.org/book/nse-api.html#nse-api-networkio-raw](https://nmap.org/book/nse-api.html#nse-api-networkio-raw) [Kris]
* Added version detection match line for the Arucer backdoor, which was
  ...
  (see [http://www.kb.cert.org/vuls/id/154421](http://www.kb.cert.org/vuls/id/154421)). [Ron]
...
* [Zenmap]Fixed an interface bug which could cause hostnames with
  underscores like "host\_a" to be rendered like "hosta" with the "a"
...
* ARP requests now work with libpcap Linux "cooked" encapsulation.
  According to [http://wiki.wireshark.org/SLL](http://wiki.wireshark.org/SLL), this encapsulation is
...
* Fixed an assertion failure which could occur when connecting to an
  ...
  This was observed when running the [http-enum](https://nmap.org/nsedoc/scripts/http-enum.html) script but could
  possibly have happened in other situations. Thanks to Brandon for
  reporting the bug and testing. [David]
* Added the function bignum\_add to the nse\_openssl library to support
  BIGNUM addition [Patrik]
* The redistributable Visual C++ runtime components installer
  (vcredist\_x86.exe) has been upgraded to version 9.0.30729.4148. Axel
...
* [NSE]Fixed [http-enum](https://nmap.org/nsedoc/scripts/http-enum.html) so it uses the full path name for the
...
* [NSE]Added a missing dirname function to [http-favicon](https://nmap.org/nsedoc/scripts/http-favicon.html). Its absence
...
* Fixed the parsing of libdnet DLPI interface names that contain more
  ...
  [David]
* [NSE]Added the function nmap.is\_privileged() to tell a script if,
...
* [NSE]Added the function nmap.get\_ports() so scripts can iterate
...
* [NSE][nbstat](https://nmap.org/nsedoc/scripts/nbstat.html).nse can now look up the MAC prefix vendor string. Other
  scripts can now do the same thing using the
  datafiles.parse\_mac\_prefixes function. [Thomas Buchanan]
...
* [NSE]Moved the [smtp-open-relay](https://nmap.org/nsedoc/scripts/smtp-open-relay.html).nse script out of the "demo"
  category after improvements by Duarte Silva. We have now met the
  goal of removing all scripts from that category.
* [NSE]Fixed a bug which prevented [smb-brute](https://nmap.org/nsedoc/scripts/smb-brute.html) from properly detecting
  account lockouts, which could lead to lockouts of many accounts on
  the target machine. Now [smb-brute](https://nmap.org/nsedoc/scripts/smb-brute.html) tries to check the lockout policy
  ...
  account. [Ron]
* [NSE]Rewrote [smb-enum-domains](https://nmap.org/nsedoc/scripts/smb-enum-domains.html) to be more generalized and rely on
  library functions which will eventually be shared with[smb-brute](https://nmap.org/nsedoc/scripts/smb-brute.html). [Ron]
...
* Added a mac\_addr\_next\_hop member to the host tables used in NSE for
  scripts which need to know the MAC address of the next hop router
  for reaching a target host. [Michael Pattrick, KX].
* Removed the nmap\_service.exe helper program for [smb-psexec](https://nmap.org/nsedoc/scripts/smb-psexec.html), as it
  ...
  and caused more false positives! You can now download it from[https://nmap.org/psexec/nmap\_service.exe](https://nmap.org/psexec/nmap_service.exe). (The script will remind you
...
* [NSE]Added a new library [afp.lua](https://nmap.org/nsedoc/lib/afp.html) which handles the Apple Filing
  Protocol (AFP) filesharing system. The library handles
  authentication and many other protocol features, and enables the new[afp-path-vuln](https://nmap.org/nsedoc/scripts/afp-path-vuln.html), [afp-brute](https://nmap.org/nsedoc/scripts/afp-brute.html), and [afp-showmount](https://nmap.org/nsedoc/scripts/afp-showmount.html) scripts. [Patrik]
...
* [NSE]Fixed [packet.lua](https://nmap.org/nsedoc/lib/packet.html) so that functions used to set packet header
  fields (e.g. ip\_set\_ttl) also set the appropriate variables used to
  access the data (e.g. ip\_ttl). [Kris]
...
* [NSE]Did some simple bit-flipping on the nmap\_service.exe program
  used by the [smb-psexec](https://nmap.org/nsedoc/scripts/smb-psexec.html) script, to avoid its being falsely detected
  as malware. [Ron]
* [NSE]Fixed a bug in [http.lua](https://nmap.org/nsedoc/lib/http.html) that could lead to an assertion
...
* [NSE]Restored the ability of http.head to return a body if the
  server returns one. This was lost in the [http.lua](https://nmap.org/nsedoc/lib/http.html) overhaul from
  5.20. [David]
* [NSE]Fixed the use of our [strict.lua](https://nmap.org/nsedoc/lib/strict.html) library on distributions that
  install their own [strict.lua](https://nmap.org/nsedoc/lib/strict.html). The error message was
...
* [NSE]Fixed the use of an undefined variable in [smb-enum-sessions](https://nmap.org/nsedoc/scripts/smb-enum-sessions.html),
  reported by Brandon. [Ron]
* Fixed a compiler error when --without-liblua is used. [Brandon]
* [NSE]Fixed an error with running [http-enum](https://nmap.org/nsedoc/scripts/http-enum.html).nse along with the
...
* Added a function that was missing from [http-favicon](https://nmap.org/nsedoc/scripts/http-favicon.html).nse. Its absence
...
* Dramatically improved the version detection database, integrating
  ...
  interpret.
* [NSE]Added a new script, [oracle-sid-brute](https://nmap.org/nsedoc/scripts/oracle-sid-brute.html), which queries the Oracle
  TNS-listener for default instance/sid names. The SID enumeration
  list was prepared by Red Database security. See[https://nmap.org/nsedoc/scripts/oracle-sid-brute.html](https://nmap.org/nsedoc/scripts/oracle-sid-brute.html) . [Patrik
  Karlsson]
...
* [NSE]Replaced our runlevel system for managing the order of script
  ...
  specify. See[https://nmap.org/book/nse-script-format.html#nse-format-dependencies](https://nmap.org/book/nse-script-format.html#nse-format-dependencies)[Patrick]
...
* A new script argument, http.useragent, lets you modify
  ...
  (compatible; Nmap Scripting Engine; [https://nmap.org/book/nse.html](https://nmap.org/book/nse.html))".
...
* [NSE]The [http-favicon](https://nmap.org/nsedoc/scripts/http-favicon.html) script is now better at finding "link
...
* [NSE][smb-psexec](https://nmap.org/nsedoc/scripts/smb-psexec.html) now works against Windows XP (as well as
  already-supported Win2K and Windows 2003). The solution involved
  changing the seemingly irrelevant PID field in the SMB packet. See[http://seclists.org/nmap-dev/2010/q1/13](http://seclists.org/nmap-dev/2010/q1/13). [Ron]
...
* [NSE]Overhauled our [http](https://nmap.org/nsedoc/lib/http.html) library to centralize HTTP parsing and
...
* [NSE]Our [http](https://nmap.org/nsedoc/lib/http.html) library no longer allows cached responses from a GET
  request to be returned for a HEAD request. This could cause problems
  with at least the [http-enum](https://nmap.org/nsedoc/scripts/http-enum.html) script. [David]
...
### Nmap 5.10BETA2 [2009-12-24] [§](https://nmap.org/changelog.html#5.10BETA2) ###

* Added 7 new NSE scripts for a grand total of 79! You can learn about
  them all at [https://nmap.org/nsedoc/](https://nmap.org/nsedoc/). Here are the new ones:
  * [nfs-showmount](https://nmap.org/nsedoc/scripts/nfs-showmount.html) displays NFS exports like "showmount -e" does. See[https://nmap.org/nsedoc/scripts/nfs-showmount.html](https://nmap.org/nsedoc/scripts/nfs-showmount.html) . [Patrik
    Karlsson]
  * [ntp-info](https://nmap.org/nsedoc/scripts/ntp-info.html) prints the time and configuration variables provided by
    ...
    address. See[https://nmap.org/nsedoc/scripts/ntp-info.html](https://nmap.org/nsedoc/scripts/ntp-info.html) . [Richard Sammet]
  * [citrix-brute-xml](https://nmap.org/nsedoc/scripts/citrix-brute-xml.html) uses the [unpwdb](https://nmap.org/nsedoc/lib/unpwdb.html) library to guess credentials for
    the Citrix PN Web Agent Service. See[https://nmap.org/nsedoc/scripts/citrix-brute-xml.html](https://nmap.org/nsedoc/scripts/citrix-brute-xml.html) . [Patrik Karlsson]
  * [citrix-enum-apps](https://nmap.org/nsedoc/scripts/citrix-enum-apps.html) and [citrix-enum-apps-xml](https://nmap.org/nsedoc/scripts/citrix-enum-apps-xml.html) print a list of published
    ...
    respectively. See[https://nmap.org/nsedoc/scripts/citrix-enum-apps.html](https://nmap.org/nsedoc/scripts/citrix-enum-apps.html) and[https://nmap.org/nsedoc/scripts/citrix-enum-apps-xml.html](https://nmap.org/nsedoc/scripts/citrix-enum-apps-xml.html) . [Patrik Karlsson]
  * [citrix-enum-servers](https://nmap.org/nsedoc/scripts/citrix-enum-servers.html) and [citrix-enum-servers-xml](https://nmap.org/nsedoc/scripts/citrix-enum-servers-xml.html) print a list
    of Citrix servers from the Citrix ICA Browser or XML service,
    respectively. See[https://nmap.org/nsedoc/scripts/citrix-enum-servers.html](https://nmap.org/nsedoc/scripts/citrix-enum-servers.html) and[https://nmap.org/nsedoc/scripts/citrix-enum-servers-xml.html](https://nmap.org/nsedoc/scripts/citrix-enum-servers-xml.html) . [Patrik
    Karlsson]
...
* We performed a memory consumption audit and made changes to
  ...
  changes at [http://seclists.org/nmap-dev/2009/q4/663](http://seclists.org/nmap-dev/2009/q4/663). Here are the
  highlights:
...
* David started a major service detection submission integration
  ...
  svnserve, vmware, domain, backdoor, [finger](https://nmap.org/nsedoc/scripts/finger.html), freeciv, hp, imaps, irc,
...
* Updated service detection signatures for Microsoft SQL Server 2005
  ...
  updated [ms-sql-info](https://nmap.org/nsedoc/scripts/ms-sql-info.html).nse to support MS SQL Server 2008
  detection. [Tom]
* Nmap now provides Christmas greetings and a reminder of Xmas scan
  (-sX) when run in verbose mode on December 25. [Fyodor]
* Removed a limitation of [snmp.lua](https://nmap.org/nsedoc/lib/snmp.html) which only allowed it to properly
...
* Nmap script output now uses two spaces of indention rather than
  ...
  the stdnse.format\_output function added in the last release. Output
  now looks like:
...
* [NSE]Use a looser match pattern in [auth-owners](https://nmap.org/nsedoc/scripts/auth-owners.html).nse for retrieving
  the owner out of an identd response. See[http://seclists.org/nmap-dev/2009/q4/549](http://seclists.org/nmap-dev/2009/q4/549). [Richard Sammet]
...
* [Ncat]In the Windows version of netrun, we weren't noticing when a
  ...
  client. [David]
* [NSE]Updated [http-iis-webdav-vuln](https://nmap.org/nsedoc/scripts/http-iis-webdav-vuln.html) to run against SSL-enabled
  servers [Ron]
...
### Nmap 5.10BETA1 [2009-11-23] [§](https://nmap.org/changelog.html#5.10BETA1) ###

* Added 14 new NSE scripts for a grand total of 72! You can learn
  about them all at [https://nmap.org/nsedoc/](https://nmap.org/nsedoc/). Here are the new ones:
  * [smb-psexec](https://nmap.org/nsedoc/scripts/smb-psexec.html) implements remote process execution similar to the
    ...
    installing a backdoor on a collection of computers. See[https://nmap.org/nsedoc/scripts/smb-psexec.html](https://nmap.org/nsedoc/scripts/smb-psexec.html) [Ron]
  * [dhcp-discover](https://nmap.org/nsedoc/scripts/dhcp-discover.html) sends out DHCP probes on UDP/67 and displays all
    ...
    and potentially create a denial of service condition. See[https://nmap.org/nsedoc/scripts/dhcp-discover.html](https://nmap.org/nsedoc/scripts/dhcp-discover.html) . [Ron]
  * [http-enum](https://nmap.org/nsedoc/scripts/http-enum.html) enumerates URLs used by popular web applications and
    servers and reports which ones exist on a target web server. See[https://nmap.org/nsedoc/scripts/http-enum.html](https://nmap.org/nsedoc/scripts/http-enum.html) . [Ron, Andrew Orr,
    Rob Nicholls]
  * [ssl-cert](https://nmap.org/nsedoc/scripts/ssl-cert.html) retrieves and prints a target server's SSL
    certificate. See[https://nmap.org/nsedoc/scripts/ssl-cert.html](https://nmap.org/nsedoc/scripts/ssl-cert.html) . [David]
  * [x11-access](https://nmap.org/nsedoc/scripts/x11-access.html) checks whether access to an X11 server is allowed (as
    with "xhost +" for example). See[https://nmap.org/nsedoc/scripts/x11-access.html](https://nmap.org/nsedoc/scripts/x11-access.html) . [jlanthea]
  ...
  * smbv2-enabled checks if the smbv2 protocol is enabled on target
    ...
    security vulnerability. See[https://nmap.org/nsedoc/scripts/smbv2-enabled.html](https://nmap.org/nsedoc/scripts/smbv2-enabled.html) . [Ron]
  * [http-favicon](https://nmap.org/nsedoc/scripts/http-favicon.html) obtains the favicon file (/favicon.ico or whatever is
    specified by the HTML link tag) and tries to identify its source
    (such as a certain web application) using a database lookup. See[https://nmap.org/nsedoc/scripts/http-favicon.html](https://nmap.org/nsedoc/scripts/http-favicon.html) . [Vladz]
  * [http-date](https://nmap.org/nsedoc/scripts/http-date.html) obtains the Date: header field value from an HTTP server
    then displays it along with how much it differs from local
    time. See [https://nmap.org/nsedoc/scripts/http-date.html](https://nmap.org/nsedoc/scripts/http-date.html) . [David]
  * [http-userdir-enum](https://nmap.org/nsedoc/scripts/http-userdir-enum.html) attempts to enumerate users on a system by
    trying URLs with common usernames in the Apache mod\_userdir format
    (e.g. [http://target-server.com/](http://target-server.com/)\~john). See[https://nmap.org/nsedoc/scripts/http-userdir-enum.html](https://nmap.org/nsedoc/scripts/http-userdir-enum.html) . [Jah]
  * [pjl-ready-message](https://nmap.org/nsedoc/scripts/pjl-ready-message.html) allows viewing and setting the status message on
    printers which support the Printer Job Language (many HP printers
    do). See [https://nmap.org/nsedoc/scripts/pjl-ready-message.html](https://nmap.org/nsedoc/scripts/pjl-ready-message.html) .
    [Aaron Leininger]
  * [http-headers](https://nmap.org/nsedoc/scripts/http-headers.html) performs a GET request for the root folder ("/") of a
    web server and displays the HTTP headers returned. See[https://nmap.org/nsedoc/scripts/http-headers.html](https://nmap.org/nsedoc/scripts/http-headers.html) . [Ron]
  * [http-malware-host](https://nmap.org/nsedoc/scripts/http-malware-host.html) is designed to discover hosts that are serving
    malware (perhaps because they were compromised), but so far it
    only checks for one specific attack. See[https://nmap.org/nsedoc/scripts/http-malware-host.html](https://nmap.org/nsedoc/scripts/http-malware-host.html) . [Ron]
  * [smb-enum-groups](https://nmap.org/nsedoc/scripts/smb-enum-groups.html) displays a list of groups on the remote system
    along with their membership (like enum.exe -G). See[https://nmap.org/nsedoc/scripts/smb-enum-users.html](https://nmap.org/nsedoc/scripts/smb-enum-users.html) [Ron]
...
* [Zenmap]After performing or loading a scan, you can now filter
  ...
  modify the filter or remove it to see the whole scan again. See[https://nmap.org/book/zenmap-filter.html](https://nmap.org/book/zenmap-filter.html) . [Josh Marlow]
...
* Integrated 1,349 fingerprints (and 81 corrections) submitted by Nmap
  ...
  routers, and other devices (40 new vendors). See[http://seclists.org/nmap-dev/2009/q4/416](http://seclists.org/nmap-dev/2009/q4/416) [David]
* [NSE]For all the services which are commonly tunneled over SSL
  ...
  was added for easy SSL detection. See[https://nmap.org/nsedoc/lib/comm.html](https://nmap.org/nsedoc/lib/comm.html) [Joao]
* Nmap now prefers to display the hostname supplied by the user instead
  ...
  Host latency is now printed more often. See[http://seclists.org/nmap-dev/2009/q4/199](http://seclists.org/nmap-dev/2009/q4/199) for a summary of other
...
* [NSE]Default socket parallelism has been doubled from 10 to 20,
  which doubles speed in some situations. See[http://seclists.org/nmap-dev/2009/q3/161](http://seclists.org/nmap-dev/2009/q3/161). [Patrick]
...
* [NSE]Added a function for scripts to format their output in a
  consistent way. See[https://nmap.org/nsedoc/lib/stdnse.html#format\_output](https://nmap.org/nsedoc/lib/stdnse.html#format_output). [Ron]
* [NSE]Now supports worker threads so that a single script can
  ...
  includes condition variables for synchronization. See[https://nmap.org/nsedoc/lib/stdnse.html#new\_thread](https://nmap.org/nsedoc/lib/stdnse.html#new_thread),[https://nmap.org/nsedoc/lib/nmap.html#condvar](https://nmap.org/nsedoc/lib/nmap.html#condvar), and[http://seclists.org/nmap-dev/2009/q4/294](http://seclists.org/nmap-dev/2009/q4/294).
* Fixed a problem in which the Nmap installer wrongly reported that
  ...
  failed to install. We had to update a registry key--see[http://seclists.org/nmap-dev/2009/q3/164](http://seclists.org/nmap-dev/2009/q3/164). [Jah]
...
* [NSE]Added HTTP pipelining support to the HTTP library and and to
  the [http-enum](https://nmap.org/nsedoc/scripts/http-enum.html), [http-userdir-enum](https://nmap.org/nsedoc/scripts/http-userdir-enum.html), and sql-injection.nse
...
* [NSE]The HTTP library now caches responses from http.get or
  ...
  the same Nmap run even if several scripts request them. See[http://seclists.org/nmap-dev/2009/q3/733](http://seclists.org/nmap-dev/2009/q3/733). [Patrick]
...
* [NSE][telnet-brute](https://nmap.org/nsedoc/scripts/telnet-brute.html).nse now uses the unpw database instead of a
  hard coded list. [Ron]
* [NSE][ssl-cert](https://nmap.org/nsedoc/scripts/ssl-cert.html).nse now supports TLS negotiation against SMTP ports
...
* Upgraded our Winpcap installer to use the new WinPcap version 4.1.1.
  ...
  for compatibility with the official Winpcap project installer (see[http://seclists.org/nmap-dev/2009/q4/237](http://seclists.org/nmap-dev/2009/q4/237)). [Rob Nicholls]
...
* The Ndiff man page was dramatically improved with examples and
  sample output. See [https://nmap.org/book/ndiff-man.html](https://nmap.org/book/ndiff-man.html) .
  [David]
...
* Fixed a bug that could cause an infinite loop ("Unable to find
  listening socket in get\_rpc\_results") in RPC scan. The loop would
  ...
  the problem. [David]
* [NSE]The [dns-zone-transfer](https://nmap.org/nsedoc/scripts/dns-zone-transfer.html) and whois script argument table syntax has been
  improved so you don't need curly braces.
* [NSE][smb-enum-shares](https://nmap.org/nsedoc/scripts/smb-enum-shares.html).nse now checks whether or not a share is
...
* The nselib/data directory is now installed. It was not installed
  ...
  files are [http-enum](https://nmap.org/nsedoc/scripts/http-enum.html).nse, [http-favicon](https://nmap.org/nsedoc/scripts/http-favicon.html).nse, [http-iis-webdav-vuln](https://nmap.org/nsedoc/scripts/http-iis-webdav-vuln.html).nse,[http-userdir-enum](https://nmap.org/nsedoc/scripts/http-userdir-enum.html).nse, smb-pwdump.nse, [pop3-brute](https://nmap.org/nsedoc/scripts/pop3-brute.html).nse,[smb-brute](https://nmap.org/nsedoc/scripts/smb-brute.html).nse, and [snmp-brute](https://nmap.org/nsedoc/scripts/snmp-brute.html).nse. [David]
...
* Fixed an error in the handling of exclude groups that used IPv4
  ...
  useful test cases in [http://seclists.org/nmap-dev/2009/q4/276](http://seclists.org/nmap-dev/2009/q4/276). The
...
* Removed IP ID matching in packet headers returned in ICMP errors.
  ...
  occasionally cause valid replies to be ignored. See[http://seclists.org/nmap-dev/2009/q2/580](http://seclists.org/nmap-dev/2009/q2/580) for an example of host
  order affecting scan results due to this phenomenon. [David]
* [NSE]The HTTP library now handles chunked transfer decoding more
  robustly. See [http://seclists.org/nmap-dev/2009/q3/13](http://seclists.org/nmap-dev/2009/q3/13) [David]
...
* [NSE]Fixed many libraries which were inappropriately using global
  ...
  (check\_globals) available as well. See this whole thread[http://seclists.org/nmap-dev/2009/q3/70](http://seclists.org/nmap-dev/2009/q3/70). [Patrick]
...
* [NSE]Added the reconnect\_ssl method for sockets. We sometimes need
  to reconnect a socket with SSL because the initial communication on
  the socket is done without SSL. See this thread for more details:[http://seclists.org/nmap-dev/2009/q4/3](http://seclists.org/nmap-dev/2009/q4/3) [Patrick, Tom Sellers]
* [Zenmap]Fixed a crash that could occur when entering certain
  ...
  For more details on this curious problem, see[http://seclists.org/nmap-dev/2009/q4/82](http://seclists.org/nmap-dev/2009/q4/82) [David]
...
* [Nsock]Made it a fatal error instead of silent memory corruption
  ...
  less than FD\_SETSIZE. This applies only on non-Windows platforms
  where FD\_SETSIZE is a limit on the value of file descriptors as well
...
* Nmap now generates IP addresses without [duplicates](https://nmap.org/nsedoc/scripts/duplicates.html) (until you cycle
  through all the allowed IPs) thanks to a new collision-free 32-bit
  number generator in nbase\_rnd.c. See[http://seclists.org/nmap-dev/2009/q3/695](http://seclists.org/nmap-dev/2009/q3/695) [Brandon]
...
* Canonicalized the list of OS detection device types to a smaller set
  with descriptions: [https://svn.nmap.org/nmap/docs/device-types.txt](https://svn.nmap.org/nmap/docs/device-types.txt) .
  [David, Fyodor, Doug]
...
* Nmap's Nbase library now has a new hexdump() function which produces
  output similar to Wireshark. nmap\_hexdump() is a wrapper which
  prints the output using Nmap's log\_write facility. The old hdump()
  and lamont\_dump() functions have been removed. [Luis]
...
* [Ncat]The --[ssl-cert](https://nmap.org/nsedoc/scripts/ssl-cert.html), --ssl-key, and --ssl-trustfile options now
...
* Zenmap's UI performance has improved significantly thanks to
  optimization of the update\_ui() function. In particular, this speeds
  up the new host filter system. [Josh]
* Add a service probe for DNS-based service discovery (DNS-SD). See[http://seclists.org/nmap-dev/2009/q3/0610.html](http://seclists.org/nmap-dev/2009/q3/0610.html) . [David]
...
* Fixed a log\_write call and a pfatal call to use a syntax which is
...
* [NSE]socket garbage collection was rewritten for better performance
  ...
  after a socket is closed. See[http://seclists.org/nmap-dev/2009/q2/0624.html](http://seclists.org/nmap-dev/2009/q2/0624.html) . [Patrick]
...
* [Ncat]Using --send-only in conjunction with the plain listen or
  ...
  received. [Kris]
* [Nsock]Added a socket\_count abstraction that counts the number of
  read or write events pending on a socket, for the purpose of
  maintaining an fd\_set. The bit is set in the fd\_set whenever the
  ...
  server. See the thread at[http://seclists.org/nmap-dev/2009/q2/0413.html](http://seclists.org/nmap-dev/2009/q2/0413.html) . This change will
...
* Fixed a logic error in getinterfaces\_siocgifconf. The check for
...
* Fixed two memory leaks in ncat\_posix.c and a bug where an open file was not
...
* Fixed a bug in --data-length parsing which in some cases could
  ...
  lengths. See [http://seclists.org/nmap-dev/2009/q2/0763.html](http://seclists.org/nmap-dev/2009/q2/0763.html) [Luis]
...
* [NSE][http-open-proxy](https://nmap.org/nsedoc/scripts/http-open-proxy.html) script fixed to avoid false positives from bad
  pattern matching and to properly declare some formerly-global
  variables as local. [Joao]

### Nmap 4.90RC1 [2009-06-25] [§](https://nmap.org/changelog.html#4.90RC1) ###

* [Zenmap]Fixed a display hanging problem on Mac OS X reported by
  Christopher Caldwell at[http://seclists.org/nmap-dev/2009/q2/0721.html](http://seclists.org/nmap-dev/2009/q2/0721.html) . This was done by
...
### Nmap 4.85BETA10 [2009-06-12] [§](https://nmap.org/changelog.html#4.85BETA10) ###
...
* Added SCTP port scanning support to Nmap. SCTP is a layer 4 protocol
  ...
  * The server scanme.csnc.ch has been set up for your SCTP scan
    ...
    NAT devices. See [http://seclists.org/nmap-dev/2009/q2/0669.html](http://seclists.org/nmap-dev/2009/q2/0669.html) .

  Part of the work on SCTP support was kindly sponsored by
  Compass Security AG, Switzerland. [Daniel Roethlisberger]
* [NSE]Added [http-iis-webdav-vuln](https://nmap.org/nsedoc/scripts/http-iis-webdav-vuln.html).nse, which detects the recently
  ...
  authentication. See[https://nmap.org/svn/scripts/http-iis-webdav-vuln.nse](https://nmap.org/svn/scripts/http-iis-webdav-vuln.nse). [Ron]
* The Nmap Reference Guide has been translated to German by Open
  ...
  in 16 languages at [https://nmap.org/docs.html](https://nmap.org/docs.html) . We're always looking
  for more translations of Nmap and its documentation--if you'd like
  to help, see [http://seclists.org/nmap-dev/2009/q2/0667.html](http://seclists.org/nmap-dev/2009/q2/0667.html) .
* Open Source Press completed and released the German translation of
  the official Nmap book (Nmap Network Scanning). Learn more at[https://nmap.org/book/#translations](https://nmap.org/book/#translations).
* [NSE]Added [socks-open-proxy](https://nmap.org/nsedoc/scripts/socks-open-proxy.html).nse for scanning networks for open
  SOCKS proxy servers. See[https://nmap.org/nsedoc/scripts/socks-open-proxy.html](https://nmap.org/nsedoc/scripts/socks-open-proxy.html) . [Joao Correa]
* [NSE][http-open-proxy](https://nmap.org/nsedoc/scripts/http-open-proxy.html).nse has been updated to attempt HEAD and
  CONNECT methods as well as previously supported GET method. It
  still tries to reach [http://www.google.com](http://www.google.com/) through the proxy by
...
* [Ncat]There is a backwards-incompatible change in the way that
  ...
  processing the last bit of data. See[http://seclists.org/nmap-dev/2009/q2/0528.html](http://seclists.org/nmap-dev/2009/q2/0528.html) for more information.
...
* [NSE]Added the [imap-capabilities](https://nmap.org/nsedoc/scripts/imap-capabilities.html) script, which uses the CAPABILITY
  command to determine the capabilities of a target IMAP mail server.
  A simple supporting IMAP library was added as well. See[https://nmap.org/nsedoc/scripts/imap-capabilities.html](https://nmap.org/nsedoc/scripts/imap-capabilities.html) . [Brandon]
* [NSE]Brandon Enright from UCSD reports that, thanks to all the NSE
  ...
  large scale scans. See[http://seclists.org/nmap-dev/2009/q2/0639.html](http://seclists.org/nmap-dev/2009/q2/0639.html) .
...
* Ncat can now send SSL certificates in connect mode for client
  authentication by using the --[ssl-cert](https://nmap.org/nsedoc/scripts/ssl-cert.html) and --ssl-key options. The
...
* The GPG detached signatures for Nmap releases now use the more
  ...
  found at [https://nmap.org/dist/sigs/](https://nmap.org/dist/sigs/) and the .gpg.txt versions for
  previous releases are still available for compatibility reasons. For
  instructions on verifying Nmap package integrity, see[https://nmap.org/book/install.html#inst-integrity](https://nmap.org/book/install.html#inst-integrity). [Fyodor]
...
* [NSE]Clean up output (generally reducing default verbosity) for the[p2p-conficker](https://nmap.org/nsedoc/scripts/p2p-conficker.html), smb-check-vulns, and [http-iis-webdav-vuln](https://nmap.org/nsedoc/scripts/http-iis-webdav-vuln.html) scripts. In
...
* Fixed a bug with the --defeat-rst-ratelimit option which prevented
  it from working properly. See this thread:[http://seclists.org/nmap-dev/2009/q2/0476.html](http://seclists.org/nmap-dev/2009/q2/0476.html) . [Josh]
...
* [Ncat]Fixed Ncat compilation with versions of OpenSSL before 0.9.7.
  Previously it would fail in ncat\_openssl.c with the message
...
* [NSE]Fixed the parsing of --script-args, which was only accepting
  ...
  backslash. See[http://seclists.org/nmap-dev/2009/q2/0211.html](http://seclists.org/nmap-dev/2009/q2/0211.html) . [Patrick]
* [NSE]When a script ends for any reason, all of its mutexes are now
  ...
  when a script crashes without unlocking a mutex. See[http://seclists.org/nmap-dev/2009/q2/0533.html](http://seclists.org/nmap-dev/2009/q2/0533.html) . [Patrick]
...
* Optimized some Nmap version detection match lines for slightly
  better performance. See[http://seclists.org/nmap-dev/2009/q2/0328.html](http://seclists.org/nmap-dev/2009/q2/0328.html) . [Brandon]
...
* [NSE]Corrected a bug in nse\_nsock.cc that could result in a crash
...
* Improved the host expression parser to better handle a few cases
  ...
  hosts. See [http://seclists.org/nmap-dev/2009/q2/0319.html](http://seclists.org/nmap-dev/2009/q2/0319.html) . [Jah]
* [Zenmap]Fixed a crash, introduced in 4.85BETA4, that happened when
  ...
  set\_date TypeError: argument must be sequence of length 9, not 3
...
* Improved nsock's fselect() to be a more complete replacement for
  ...
  ("nsock\_loop error 10022") which would occur when you ran ncat
...
* Fixed an assertion failure which could occur on at least SPARC Linux
  The error looked like "nsock\_core.c:294: handle\_connect\_result:
...
* [NSE]Remove the old nse\_macros.h header file. This involved
  removing the SCRIPT\_ENGINE\_\* status defines, moving the likes of
  SCRIPT\_ENGINE\_LUA\_DIR to nse\_main.h, removing the last remaining use
  of SCRIPT\_ENGINE\_TRY, and moving the FILES and DIRS defines to
  nse\_fs.h. [Patrick]
* Cleaned up the libpcre build system a bit by removing Makefile.am
  ...
  pcre\_chartables.cc in some instances. [Fyodor]
...
* Updated nmap-mac-prefixes with the latest MAC address prefix data
  from [http://standards.ieee.org/regauth/oui/oui.txt](http://standards.ieee.org/regauth/oui/oui.txt) as of
  5/20/09. [Fyodor]
...
### Nmap 4.85BETA9 [2009-05-12] [§](https://nmap.org/changelog.html#4.85BETA9) ###
...
* Integrated all of your 1,156 of your OS detection submissions and
  ...
  2.6.28, and much more. See[http://seclists.org/nmap-dev/2009/q2/0335.html](http://seclists.org/nmap-dev/2009/q2/0335.html) . [David]
* [Ncat]A whole lot of work was done by David to improve SSL
  ...
  * Ncat now automatically generates a temporary keypair and
    ...
    but you don't specify your own key using --ssl-key and --[ssl-cert](https://nmap.org/nsedoc/scripts/ssl-cert.html)options. [David]
...
* [NSE]Added Boolean Operators for --script. You may now use ("and",
  ...
  For more details, see[https://nmap.org/book/nse-usage.html#nse-args](https://nmap.org/book/nse-usage.html#nse-args). [Patrick]
...
* Regenerate script.db to remove references to non-existent
  ...
  people used the --script=all option: "nse\_main.lua:319:
...
* Fixed --script-updatedb on Windows--it was adding bogus backslashes
  ...
  Michael Patrick at [http://seclists.org/nmap-dev/2009/q2/0192.html](http://seclists.org/nmap-dev/2009/q2/0192.html),
...
* The official Windows binaries are now compiled with MS Visual C++
  ...
  (vcredist\_x86.exe). A number of compiler warnings were fixed
  too. [Fyodor,David]
* Fixed a bug in the new NSE Lua core which caused it to round
  ...
  floating point runlevel values (e.g. that [smb-brute](https://nmap.org/nsedoc/scripts/smb-brute.html) at runlevel 0.5
  will run before [smb-system-info](https://nmap.org/nsedoc/scripts/smb-system-info.html) at the default runlevel of 1).
...
* [Ncat]Fix hostname resolution on BSD systems where a recently
...
* [NSE]Fixed bug in the DNS library which caused the error message
  "nselib/dns.lua:54: 'for' limit must be a number". [Jah]
* Fixed Solaris 10 compilation by renaming a yield structure which
  conflicted with a yield function declared in unistd.h on that
  platform. [Pieter Bowman, Patrick]
* [Ncat]Minor code cleanup of Ncat memory allocation and string
  duplication calls. [Ithilgore]
* Fixed a bug which could cause -iR to only scan the first host group
  and then terminate prematurely. The problem related to the way
  hosts are counted by o.numhosts\_scanned. [David]
* Fixed a bug in the su-to-zenmap.sh script so that, in the cases
  where it calls su, it uses the proper -c option rather than
  -C. [Michal Januszewski, Henry Gebhardt]
* Overhaul the NSE documentation "Usage and Examples" section and add
  many more examples: [https://nmap.org/book/nse-usage.html](https://nmap.org/book/nse-usage.html) [David]
* [NSE]Made hexify in nse\_nsock.cc take an unsigned char \* to work
  ...
  thing that was reported in[http://seclists.org/nmap-dev/2007/q2/0257.html](http://seclists.org/nmap-dev/2007/q2/0257.html), in regard to
...
* Updated IANA assignment IP list for random IP (-iR)
  generation. [Kris]
* [NSE]Fixed http.table\_argument so that user-supplied HTTP headers
  are now properly sent in HTTP requests. [Jah]

### Nmap 4.85BETA8 [2009-04-21] [§](https://nmap.org/changelog.html#4.85BETA8) ###
...
* The new versions of the Conficker Internet worm ban infected systems
  ...
  nmap.org due to infection, I've mirrored this release at[http://sectools.org/nmap/](http://sectools.org/nmap/). [Fyodor]
* New Conficker versions eliminate the loophole we were using to
  ...
  * Added new [p2p-conficker](https://nmap.org/nsedoc/scripts/p2p-conficker.html) script which detects Conficker using its
    P2P update ports rather than MSRPC. This is based on some new
    research by Symantec. See[https://nmap.org/nsedoc/scripts/p2p-conficker.html](https://nmap.org/nsedoc/scripts/p2p-conficker.html) [Ron]
  ...
  * Recommended command for a fast Conficker scan (combine into 1 line):
    nmap -p139,445 --script [p2p-conficker](https://nmap.org/nsedoc/scripts/p2p-conficker.html),[smb-os-discovery](https://nmap.org/nsedoc/scripts/smb-os-discovery.html),smb-check-vulns
    --script-args checkconficker=1,safe=1 -T4 [target networks]
  * Recommended command for a more comprehensive (but slower) scan:
    nmap --script [p2p-conficker](https://nmap.org/nsedoc/scripts/p2p-conficker.html),[smb-os-discovery](https://nmap.org/nsedoc/scripts/smb-os-discovery.html),smb-check-vulns -p-
    --script-args checkall=1,safe=1 -T4 [target networks]

* [NSE]The Nmap Script Engine core (C++) was rewritten in Lua for
  code simplicity and extensibility. See[http://seclists.org/nmap-dev/2009/q2/0090.html](http://seclists.org/nmap-dev/2009/q2/0090.html) and[http://seclists.org/nmap-dev/2009/q1/0047.html](http://seclists.org/nmap-dev/2009/q1/0047.html) . [Patrick]
...
* [Nbase]The checksum functions now have an nbase\_ prefix. This
...
* Fixed [banner](https://nmap.org/nsedoc/scripts/banner.html).nse to remove surrounding whitespace from banners. For
...
* Expanded and tweaked the product/version/info of service scans in an
  ...
  failed to fill info\_template...". Parts of this change include:
...
* Improved the service scan DB to remove certain problematic regex
  patterns which could lead to PCRE\_MATCHLIMIT errors. For example,
...
* Changed some error() calls (which were more informational than error
  messages) to use log\_write() instead, and changed a few f?printf()
  calls into error() or log\_write(). [Brandon]
* [Ncat]Fixed a bug in the resolve() function which could cause Ncat
  to resolve names using the wrong address family (such as AF\_INET
  rather than AF\_INET6) in some rare cases. [Daniel Roethlisberger]
...
* Rewrote the debugging error message "Found whacked packet protocol
  17 in get\_ping\_pcap\_result" because we decided that receiving a UDP
  packet during TCP ping scan is not egregious enough to qualify as
  "whacked". [David]

### Nmap 4.85BETA7 [2009-04-1] [§](https://nmap.org/changelog.html#4.85BETA7) ###
...
* Improvements to the Conficker detection script (smb-check-vulns):
  ...
  * Add workaround for crash in older versions of OpenSSL which would
    ...
    from the server. The error looked like: evp\_enc.c(282): OpenSSL
  ...
  * Add helpful text for the two most common errors seen in the
    ...
    things like "Error: NT\_STATUS\_ACCESS\_DENIED", output is like:
    ...
    | |\_ smbdomain=zzz if you know the domain. (Error NT\_STATUS\_ACCESS\_DENIED)
    The other improved message is for
    NT\_STATUS\_OBJECT\_NAME\_NOT\_FOUND. [David]

* The NSEDoc portal at [https://nmap.org/nsedoc/](https://nmap.org/nsedoc/) now provides download
  ...
  svn directly, but may be more convenient. For an example, see[https://nmap.org/nsedoc/scripts/ssl-enum-ciphers.html](https://nmap.org/nsedoc/scripts/ssl-enum-ciphers.html) . [David, Fyodor]
* A copy of the Nmap public svn repository (/nmap, plus its zenmap,
  nsock, nbase, and ncat externals) is now available at[https://nmap.org/svn/](https://nmap.org/svn/). We'll be updating this regularly, but it may
...
* Declare a couple [msrpc.lua](https://nmap.org/nsedoc/lib/msrpc.html) variables as local to avoid a potential
  deadlock between [smb-server-stats](https://nmap.org/nsedoc/scripts/smb-server-stats.html).nse instances. [Ron]

### Nmap 4.85BETA6 [2009-03-31] [§](https://nmap.org/changelog.html#4.85BETA6) ###
...
* [Zenmap]A typo that led to a crash if the ndiff subprocess
  ...
  UnboundLocalError: local variable 'error\_test' referenced before assignment
...
### Nmap 4.85BETA5 [2009-03-30] [§](https://nmap.org/changelog.html#4.85BETA5) ###
...
* [Ncat]The -v option (used alone) no longer floods the screen with
  ...
  important status messages such as "Connected to ...", a startup[banner](https://nmap.org/nsedoc/scripts/banner.html), and error messages. At -vv, minor debugging messages are
...
* Fixed a strtok issue between load\_exclude and
  TargetGroup::parse\_expr that caused only the first exclude on
  a line to be loaded as well as an invalid read into free()'d
  memory in load\_exclude(). [Brandon, David]
* NSE's garbage collection system (for cleaning up sockets from
  completed threads, etc.) has been improved. [Patrick]

### Nmap 4.85BETA4 [2009-3-15] [§](https://nmap.org/changelog.html#4.85BETA4) ###

* Added two new SMB/MSRPC NSE scripts by Ron Bowes:
  * [smb-brute](https://nmap.org/nsedoc/scripts/smb-brute.html).nse: Bruteforce to discover SMB accounts. Has advanced
...
* Doug performed one of the largest version detection integration runs
  ...
  application protocols. Doug posted his notes on the integration at[http://hcsw.org/blog.pl/37](http://hcsw.org/blog.pl/37). We now have 1,868 http server
...
* Released the new Ncat guide which contains practical real-life Ncat
  ...
  option-centric man page. Read it here: [https://nmap.org/ncat/guide/](https://nmap.org/ncat/guide/)[David, Fyodor]
...
* Refactored SMB and MSRPC NSE scripts significantly, moving much of
  the code into the [smb.lua](https://nmap.org/nsedoc/lib/smb.html) and [msrpc.lua](https://nmap.org/nsedoc/lib/msrpc.html) modules where it can be
  leveraged by other scripts. For example, the user enumeration
  functions are used by [smb-brute](https://nmap.org/nsedoc/scripts/smb-brute.html).nse. [Ron Bowes]
...
* Nmap was discovered in another movie! In the Russian film
  ...
  him out. More details and screenshots: [https://nmap.org/movies/#khottabych](https://nmap.org/movies/#khottabych) .
* Improved operating system support for the [smb-enum-sessions](https://nmap.org/nsedoc/scripts/smb-enum-sessions.html) NSE
...
* A bug was fixed in route finding on BSD Unix. The libdnet function
  addr\_stob didn't handle the special case of the sa\_len member of
...
* Refactored SMB authentication code into its own module, [smbauth.lua](https://nmap.org/nsedoc/lib/smbauth.html).
  Improved scripts' ability to store and retrieve login information
  discovered by modules such as [smb-brute](https://nmap.org/nsedoc/scripts/smb-brute.html).nse. [Ron Bowes]
* Added message signing to SMB. Connections will no longer fail if the
  ...
  on occasion. If a server allows but doesn't require message signing,[smb.lua](https://nmap.org/nsedoc/lib/smb.html) will negotiate signing. This improves security by preventing
  man in the middle attacks. [Ron Bowes]
* Fixed the [daytime](https://nmap.org/nsedoc/scripts/daytime.html).nse script to work for UDP again (it was checking
...
* Nmap wins LinuxQuestions.Org Network Security Application of the
  Year for the sixth year in a row! See[http://seclists.org/nmap-dev/2009/q1/0395.html](http://seclists.org/nmap-dev/2009/q1/0395.html) .
...
* Fixed a DNS decoding bug in [dns-zone-transfer](https://nmap.org/nsedoc/scripts/dns-zone-transfer.html).nse that created
...
* [NSEDoc]Scripts that use modules automatically have the script
  ...
  yet, check out [https://nmap.org/nsedoc/](https://nmap.org/nsedoc/). [David]
...
* [Zenmap]The network topology feature (Radialnet) has been
  ...
  out, see [https://nmap.org/book/zenmap-lang.html](https://nmap.org/book/zenmap-lang.html) . Some remaining search
  interface elements were internationalized as well. [David]
* Improved the efficiency of the xml\_convert() routine which handles
...
* Fixed an NSE crash (assertion error) which looked like
  "nsock\_core.c:293: handle\_connect\_result: Assertion `0'
  failed". Brandon reported the bug, which was fixed by Doug and
  David. See [http://seclists.org/nmap-dev/2009/q1/0546.html](http://seclists.org/nmap-dev/2009/q1/0546.html) .

### Nmap 4.85BETA3 [2009-2-2] [§](https://nmap.org/changelog.html#4.85BETA3) ###
...
* Fixed an NSE [pop3](https://nmap.org/nsedoc/lib/pop3.html) library error which gave a message such as:
...
### Nmap 4.85BETA2 [2009-1-29] [§](https://nmap.org/changelog.html#4.85BETA2) ###

* Added some duplicate GTK DLLs to Windows installer, as a temporary
  fix for this issue: [http://seclists.org/nmap-dev/2009/q1/0207.html](http://seclists.org/nmap-dev/2009/q1/0207.html)The problem caused a warning message complaining of problems finding
  librsvg-2-2.dll to pop up 32 times before Zenmap would start. We're
  still looking for a better fix. [Fyodor, Rob, Jah]
* Made a few improvements to nmap.xsl (details:[http://seclists.org/nmap-dev/2009/q1/0210.html](http://seclists.org/nmap-dev/2009/q1/0210.html)) [Tom Sellers]
* [Zenmap]New translation: French (contributed by Gutek)
* Updated the mswin32 installer build guide and posted it to[https://svn.nmap.org/nmap/docs/win32-installer-zenmap-buildguide.txt](https://svn.nmap.org/nmap/docs/win32-installer-zenmap-buildguide.txt) [Fyodor]
* The xampp-default-auth.nse script was renamed to [ftp-brute](https://nmap.org/nsedoc/scripts/ftp-brute.html).nse since
  it has become more general.

### Nmap 4.85BETA1 [2009-1-23] [§](https://nmap.org/changelog.html#4.85BETA1) ###
...
* Added Ncat, a much-improved reimplementation of the venerable Netcat
  ...
  as standard IPv4. See [https://nmap.org/ncat/](https://nmap.org/ncat/) for details. It is now
...
* Added the Ndiff utility, which compares the results of two Nmap
  ...
  on all the changes. See [https://nmap.org/ndiff/](https://nmap.org/ndiff/) and ndiff/README for
...
* Released Nmap Network Scanning: The Official Nmap Project Guide to
  ...
  free online. For more, see [https://nmap.org/book/](https://nmap.org/book/).
* David spent more than a month working on algorithms to improve port
  ...
  are described at [http://seclists.org/nmap-dev/2009/q1/0054.html](http://seclists.org/nmap-dev/2009/q1/0054.html) . He
...
* Introduced the NSE documentation portal, which documents every NSE
  script and library included with Nmap. See [https://nmap.org/nsedoc/](https://nmap.org/nsedoc/).
  ...
  described at [https://nmap.org/book/nsedoc.html](https://nmap.org/book/nsedoc.html) . Thanks to Patrick
...
* Ron Bowes embarked on a massive MSRPC/NETBIOS project to allow Nmap
  ...
  * [nbstat](https://nmap.org/nsedoc/scripts/nbstat.html).nse: get NetBIOS names and MAC address.
  * [smb-enum-domains](https://nmap.org/nsedoc/scripts/smb-enum-domains.html).nse: enumerate domains and policies.
  * [smb-enum-processes](https://nmap.org/nsedoc/scripts/smb-enum-processes.html).nse: allows a user with administrator
    credentials to view a tree of the processes running on the
    remote system (uses HKEY\_PERFORMANCE\_DATA hive).
  * [smb-enum-sessions](https://nmap.org/nsedoc/scripts/smb-enum-sessions.html).nse: enumerate logins and SMB sessions.
  * [smb-enum-shares](https://nmap.org/nsedoc/scripts/smb-enum-shares.html).nse: enumerate network shares.
  * [smb-enum-users](https://nmap.org/nsedoc/scripts/smb-enum-users.html).nse: enumerate users and information about them.
  * [smb-os-discovery](https://nmap.org/nsedoc/scripts/smb-os-discovery.html).nse: get operating system over SMB (replaces
    netbios-[smb-os-discovery](https://nmap.org/nsedoc/scripts/smb-os-discovery.html).nse).
  * [smb-security-mode](https://nmap.org/nsedoc/scripts/smb-security-mode.html).nse: determine if a host uses user-level or
    share-level security, and what other security features it
    supports.
  * [smb-server-stats](https://nmap.org/nsedoc/scripts/smb-server-stats.html).nse: grab statistics such as network traffic
    counts.
  * [smb-system-info](https://nmap.org/nsedoc/scripts/smb-system-info.html).nse: get lots of information from the registry.
...
* Added a Russian translation of the Nmap Reference Guide by Guz
  Alexander. We now have translations in 15 languages available from[https://nmap.org/docs.html](https://nmap.org/docs.html) . More volunteer translators are welcome,
...
* [NSE]Added [banner](https://nmap.org/nsedoc/scripts/banner.html).nse, a simple script which connects to open TCP
...
* [Zenmap]Internationalization has been fixed [David]. Currently
  ...
  * Brazilian Portuguese by Adriano Monteiro Marques (partial)
  ...
  into your own native language, see[https://nmap.org/book/zenmap-lang.html](https://nmap.org/book/zenmap-lang.html) . [David]
...
* Reduced memory consumption for some longer-running scans by removing
  ...
  See [http://seclists.org/nmap-dev/2008/q3/0902.html](http://seclists.org/nmap-dev/2008/q3/0902.html) for more. [Kris]
...
* [NSE]We now have a canonical way for scripts to check for
  ...
  before. See [https://nmap.org/nsedoc/lib/openssl.html](https://nmap.org/nsedoc/lib/openssl.html) . [Pattrick,
  David, Fyodor]
...
* Nmap now builds with the \_FORTIFY\_SOURCE=2 define. With modern
  versions of GCC, this adds extra buffer overflow protection and
  other security checks. It is described at[http://gcc.gnu.org/ml/gcc-patches/2004-09/msg02055.html](http://gcc.gnu.org/ml/gcc-patches/2004-09/msg02055.html) . [David,
  Doug]
* The --excludefile option correctly handles files with no terminating
  ...
  read." [Henri Doreau]
* [NSE]Changed the [datafiles](https://nmap.org/nsedoc/lib/datafiles.html) library to remove constraining input
  checks, move nmap.fetch\_file() to read\_from\_file(), and make
  get\_array() and get\_assoc\_array() into normal functions. [Sven]
* [NSE]Fixed some bugs and typos in the [datafiles](https://nmap.org/nsedoc/lib/datafiles.html) library. [Jah]
...
* Substantially updated the Nmap Scripting Engine guide/chapter
  ([https://nmap.org/book/nse.html](https://nmap.org/book/nse.html)) so that it is up-to-date with all
...
* [http-auth](https://nmap.org/nsedoc/scripts/http-auth.html).nse now properly checks for default authentication
  credentials. A bug prevented it from working before. [Vlatko
  Kosturjak]
* Renamed irc-zombie.nse to [auth-spoof](https://nmap.org/nsedoc/scripts/auth-spoof.html) and improved its description
...
* Removed some unnecessary "demo" category NSE scripts: echoTest,
  ...
  "default" and "safe" categories. This leaves just [smtp-open-relay](https://nmap.org/nsedoc/scripts/smtp-open-relay.html) in
...
* [NSE]Removed showSSHVersion.nse. Its only real claim to fame was
  ...
  detection or the upcoming [banner](https://nmap.org/nsedoc/scripts/banner.html) grabbing script. [Fyodor]
...
* [NSE]The [smtp-commands](https://nmap.org/nsedoc/scripts/smtp-commands.html) script output is now more compact. [Jasey
  DePriest, David]
...
* [NSE]Enhanced the tohex() function in the [stdnse](https://nmap.org/nsedoc/lib/stdnse.html) library to support
...
* [NSE]Fixed a number of small bugs in the Nmap library
  (nse\_nmaplib.cc), as described at[http://seclists.org/nmap-dev/2008/q4/0663.html](http://seclists.org/nmap-dev/2008/q4/0663.html) [Patrick]
* The HTTP\_open\_proxy.nse script was updated to match Google Web
...
* Nsock now uses fselect() to work around problems with select() not
  ...
  needed for Ncat to work properly on that platform. See[http://seclists.org/nmap-dev/2008/q3/0766.html](http://seclists.org/nmap-dev/2008/q3/0766.html) . [Kris]
* Removed trailing null bytes from Ncat's responses in HTTP proxy
  mode. [David]
* [NSE][daytime](https://nmap.org/nsedoc/scripts/daytime.html).nse now runs against TCP ports in addition to the UDP
...
* Fix compilation w/IPv6 support on Solaris by checking for inet\_addr
  in -lnsr before using APR\_CHECK\_WORKING\_GETNAMEINFO in
  configure. [David]
* Removed the nbase\_md5.\* and nbase\_sha1.\* files because our
  new nse\_openssl library includes that functionality. [David]
...
* Use TIMEVAL\_AFTER(...) instead of TIMEVAL\_SUBTRACT(...) \> 0 when
...
* [Zenmap]Fixed a crash related to the use of NmapOptions in
  ScanNotebook.py using the old interface (ops.num\_random\_targes,
  ops.input\_filename) rather than the newer dict-style
  interface. [Jah]
* Split parallel DNS resolution and system DNS resolution into
  ...
  call. [David]
* [NSE]Remove "\\r\\r" in script output. If you print "\\r\\n", the
  Windows C library will transform it to "\\r\\r\\n". So we just print
  "\\n" with no special case for Windows. Also fixed
  showSMTPversion.nse so that it doesn't print "\\r\\r" in the first
  place. [David]
* Updated IANA assignment IP list for random IP (-iR)
  generation. [Kris]
...
* There is a new "external" script category, for NSE scripts which
  ...
  dns-safe-recursion-txid.nse, ripeQuery.nse, HTTP\_open\_proxy.nse, and
  whois.nse [David]
...
* Improved [rpcinfo](https://nmap.org/nsedoc/scripts/rpcinfo.html).nse to correctly parse a wider variety of server
...
* Fixed an assertion failure where raw TCP timing ping probes were
  ...
  nmap: scan\_engine.cc:2843: UltraProbe\* sendIPScanProbe(UltraScanInfo\*,
...
* Update the NSE bit library to replace deprecated use of
  luaL\_openlib() with luaL\_register(). This fixes a build error which
  occurred on systems which have Lua libraries installed but
  LUA\_COMPAT\_OPENLIB not defined [Sven]
...
* [Zenmap]Added a new Scan Topology system. The idea is that if we
  ...
  visualization tool ([http://www.dca.ufrn.br/](http://www.dca.ufrn.br/)\~joaomedeiros/radialnet),
  ...
  Zenmap screen shots ever, visit[https://nmap.org/book/zenmap-topology.html](https://nmap.org/book/zenmap-topology.html) . The integration work was
...
* [Zenmap]Another exciting new Zenmap feature is Scan Aggregation.
  ...
  at [https://nmap.org/book/zenmap-scanning.html#aggregation](https://nmap.org/book/zenmap-scanning.html#aggregation). [David,
  Vladimir]
...
* David integrated all of your OS detection fingerprint and correction
  ...
  application developed by Nmap SoC student Michael Pattrick. See[http://seclists.org/nmap-dev/2008/q3/0089.html](http://seclists.org/nmap-dev/2008/q3/0089.html) and[http://seclists.org/nmap-dev/2008/q3/0139.html](http://seclists.org/nmap-dev/2008/q3/0139.html) for more details.
* Nmap now works with Windows 2000 again, after being broken by our
  ...
  are required to run on Win2K, as described at[https://nmap.org/book/inst-windows.html#inst-win2k](https://nmap.org/book/inst-windows.html#inst-win2k) .
...
* When Nmap finds a probe during ping scan which elicits a response,
  ...
  full details, see [http://seclists.org/nmap-dev/2008/q3/0647.html](http://seclists.org/nmap-dev/2008/q3/0647.html)[David, Michael, Fyodor]
...
* Added a new NSE binlib library, which offers bin.pack() and
  ...
  extracting them from binary strings. For details, see[https://nmap.org/book/nse-library.html#nse-binlib](https://nmap.org/book/nse-library.html#nse-binlib) . [Philip
  Pickering]
* Added a new NSE DNS library. See this thread:[http://seclists.org/nmap-dev/2008/q3/0310.html](http://seclists.org/nmap-dev/2008/q3/0310.html) [Philip Pickering]
* Added new NSE libraries for base64 encoding, SNMP, and POP3 mail
  operations. They are described at[http://seclists.org/nmap-dev/2008/q3/0233.html](http://seclists.org/nmap-dev/2008/q3/0233.html) . [Philip Pickering]
...
* Nsock now supports binding to a local address and setting IPv4
  options with nsi\_set\_localaddr() and nsi\_set\_ipoptions(),
  respectively. [Kris]
...
* Improve the netbios-[smb-os-discovery](https://nmap.org/nsedoc/scripts/smb-os-discovery.html) NSE script to improve target
...
* Nmap now avoids collapsing large numbers of ports in open|filtered
  ...
  greater than two. See this thread:[http://seclists.org/nmap-dev/2008/q3/0312.html](http://seclists.org/nmap-dev/2008/q3/0312.html) . [Fyodor]
* The NSE [http](https://nmap.org/nsedoc/lib/http.html) library now supports chunked encoding. [Sven Klemm]
* The NSE [datafiles](https://nmap.org/nsedoc/lib/datafiles.html) library now has generic file parsing routines, and
...
* Passed the big revision 10,000 milestone in the Nmap project SVN
  server: [http://seclists.org/nmap-dev/2008/q3/0682.html](http://seclists.org/nmap-dev/2008/q3/0682.html)
* Added some Windows and MinGW compatibility patches submitted by
  Gisle Vanem.
* Improved nse\_init so that compilation/runtime errors in NSE scripts
...
* Updated [rpcinfo](https://nmap.org/nsedoc/scripts/rpcinfo.html) NSE script to use the new pack/unpack (binlib)
  functions, use the new [tab](https://nmap.org/nsedoc/lib/tab.html) library, include better documentation, and
...
* Fix a bug in the NSE [http](https://nmap.org/nsedoc/lib/http.html) library which would cause some scripts to
...
* Added new addrow() function to NSE [tab](https://nmap.org/nsedoc/lib/tab.html) library. It allows
...
* Fixed a number of NSE scripts which used print\_debug()
  incorrectly. See[http://seclists.org/nmap-dev/2008/q3/0470.html](http://seclists.org/nmap-dev/2008/q3/0470.html) . [Sven Klemm]
...
* [NSE]Each thread for a script now gets its own action closure (and
  upvalues). See: [http://seclists.org/nmap-dev/2008/q2/0549.html](http://seclists.org/nmap-dev/2008/q2/0549.html)[Patrick]
* [NSE]The script\_scan\_result structure has been changed to a class,
  ...
  A similar change was made to the run\_record structure. [Patrick]
...
* Fixed a segmentation fault in Nsock which occurred when calling
  nsock\_write() with a data length of -1 (which means the data is a
...
* Added an extra layer of validity checking to received packets
  (readip\_pcap), just to be extra safe. See[http://seclists.org/nmap-dev/2008/q3/0644.html](http://seclists.org/nmap-dev/2008/q3/0644.html) . [Kris]
* Zenmap defaults to showing files matching both \*.xml and \*.usr in
  ...
  See [http://seclists.org/nmap-dev/2008/q3/0093.html](http://seclists.org/nmap-dev/2008/q3/0093.html) .
...
* Nmap --reason output no longer falsely reports a localhost-response
  during -PN scans. See[http://seclists.org/nmap-dev/2008/q3/0188.html](http://seclists.org/nmap-dev/2008/q3/0188.html) . [Michael]
...
* The shtool build helper script has been updated to version 2.0.8. An
  ...
  was set to et\_EE. Thanks to Michal Januszewski for the bug
  report. [David]
* [Zenmap]Removed services.dmp and os\_dmp.dmp and all the files that
...
* Unprintable characters in NSE script output (which really shouldn't
  ...
  hexadecimal representation of the character. See[http://seclists.org/nmap-dev/2008/q3/0180.html](http://seclists.org/nmap-dev/2008/q3/0180.html) . [Patrick]
...
* Nmap only prints an uptime guess in verbose mode now, because in
  some situations it can be very inaccurate. See the discussion at[http://seclists.org/nmap-dev/2008/q3/0392.html](http://seclists.org/nmap-dev/2008/q3/0392.html) . [David]
...
* Nmap compilation on Windows is now done with Visual C++ Express 2008
  ...
  updated at [https://nmap.org/book/inst-windows.html#inst-win-source](https://nmap.org/book/inst-windows.html#inst-win-source) .
  [Kris]
...
* Added a new NSE Comm (common communication) library for common
  network discovery tasks such as banner-grabbing (get\_banner()) and
...
* The Nmap Scripting Engine now supports mutexes for gracefully
  handling concurrency issues. Mutexes are documented at[https://nmap.org/book/nse-api.html#nse-mutex](https://nmap.org/book/nse-api.html#nse-mutex) . [Patrick]
...
* Added a new timing\_level() function to NSE which reports the Nmap
  timing level from 0 to 5, as set by the Nmap -T option. The default
  is 3. [Thomas Buchanan]
* Update the HTTP library to use the new timing\_level functionality to
  set connection and response timeouts. An error preventing the new
  timing\_level feature from working was also fixed. [Jah]
...
* The Nmap NSE scripts have been re-categorized in a more logical
  fashion. The new categories are described at[https://nmap.org/book/nse-usage.html#nse-categories](https://nmap.org/book/nse-usage.html#nse-categories) . [Kris]
...
* Improved the mapping from dnet device names (like eth0) and WinPcap
  names (like \\Device\\NPF\_{28700713...}). You can see this mapping
...
* Some laptops report the IP Family as NULL for disabled WiFi cards.
  This could lead to a crash with the "sin-\>sin\_family == AF\_INET6"
  assertion failure. Nmap no longer quits when this is
  encountered. [Michael]
* On systems without the GNU getopt\_long\_only() function, Nmap has its
  ...
  own internal getopt() now from its getopt\_long\_only()
  replacement. [David]
...
* Zenmap now executes the proper Nmap command by honoring the
  nmap\_command\_path variable in zenmap.conf. [Jurand Nogiec]
...
* Migrated some stray malloc()/realloc() calls to the Nbase
  safe\_malloc()/safe\_realloc() versions which guard against certain
  errors.
...
* The NSE [http](https://nmap.org/nsedoc/lib/http.html) library was updated to gracefully handle certain bogus
...
* Increase write buffer length for Nmap output on Windows. This should
  prevent error messages like: "log\_vwrite: vsnprintf failed. Even
...
* Fixed the --script-updatedb command, which was claiming to be
  ...
  perfectly. See [http://seclists.org/nmap-dev/2008/q2/0623.html](http://seclists.org/nmap-dev/2008/q2/0623.html) .
...
* A Mac OS X Nmap/Zenmap installer is now available from the Nmap
  ...
  instructions are available anyway at[https://nmap.org/book/inst-macosx.html](https://nmap.org/book/inst-macosx.html) . As a universal installer,
...
* We now compile in IPv6 support on Windows. In order to use this,
  you need to have IPv6 set up. It is installed by default on Vista,
  but must be downloaded from Microsoft for XP. See[http://www.microsoft.com/technet/network/ipv6/ipv6faq.mspx](http://www.microsoft.com/technet/network/ipv6/ipv6faq.mspx) . [Kris]
* Seven Google-sponsored Summer of Code students began working on
  exciting Nmap projects full times. The winning students and their
  Nmap development projects are described at[http://seclists.org/nmap-dev/2008/q2/0132.html](http://seclists.org/nmap-dev/2008/q2/0132.html) .
...
* The nmap-dev and nmap-hackers mailing list RSS feeds at seclists.org
  ...
  have been similarly augmented. For details, see[http://seclists.org/nmap-dev/2008/q2/0333.html](http://seclists.org/nmap-dev/2008/q2/0333.html) . [David]
...
* Reorganized the way ping probes are handled internally. Rather than
  ...
  the individual scan\_lists structures. This is a cleaner
...
* Add NSE [stdnse](https://nmap.org/nsedoc/lib/stdnse.html) library to include tobinary, tooctal, and tohex
  functions. [Patrick]
* Fixed a bug which caused the Zenmap crash reporter to, uh,
  crash. [David]
* NSE engine was cleaned up significantly. nse\_auxiliar was removed,
  and file system manipulation functions were moved from nse\_init.cc
  into a new nse\_fs.cc file. Numerous interfaces between Nmap and Lua
...
* Made a number of updates and improvements to the Zenmap Users' Guide
  at [https://nmap.org/book/zenmap.html](https://nmap.org/book/zenmap.html) . [David]
...
* A bug was fixed that could cause Zenmap to crash when loading a
  ...
  (\_gtk\_char\_segment\_new): assertion failed:
  (gtk\_text\_byte\_begins\_utf8\_char (text))
  [David]
...
* Fixed the nmap\_command\_path Zenmap configuration variable so that it
...
* "make uninstall" now uninstalls Zenmap as well as Nmap. The
  uninstall\_zenmap script now deletes directories that were
  installed. [David]
...
* Fixed a minor memory leak in getpts\_simple which occurs when no
...
* Added a new --min-rate option that allows specifying a minimum rate
  ...
  ([https://nmap.org/book/man-performance.html](https://nmap.org/book/man-performance.html)) [David]
* Create /nmap/macosx directory in SVN with files necessary to build
  ...
  Fifield's posts at [http://seclists.org/nmap-dev/2008/q2/author.html](http://seclists.org/nmap-dev/2008/q2/author.html) .
...
* Nmap 2008 Summer of Code students have began working (though full
  ...
  their projects at [http://seclists.org/nmap-dev/2008/q2/0132.html](http://seclists.org/nmap-dev/2008/q2/0132.html) .
...
* Added NSE Datafiles library which reads and parses Nmap's nmap-\*
  data files for scripts. The functions (parse\_protocols(),
  parse\_rpc() and parse\_services()) return tables with numbers
  (e.g. port numbers) indexing names (e.g. service names). The[rpcinfo](https://nmap.org/nsedoc/scripts/rpcinfo.html).nse script was also updated to use this library. [Kris]
* Fixed a bug in the nbase random number generator (and the way it
  interacted with Nmap and MS Windows) which caused [duplicates](https://nmap.org/nsedoc/scripts/duplicates.html) in some
...
* Fixed an assertion failure ("Target.cc:396: void
  ...
  'htn.toclock\_running == true' failed.") caused when a host had NSE
...
* Added TIMEVAL\_BEFORE and TIMEVAL\_AFTER macros to test whether one
...
* Changed the NSE function nmap.set\_port\_state() so that it checks to
...
* Canonicalize NSE script license text--more than half did not even
  ...
  and now a link to Nmap legal page at[https://nmap.org/book/man-legal.html](https://nmap.org/book/man-legal.html) .
...
* Nmap has moved. Everything at [http://insecure.org/nmap/](http://insecure.org/nmap/) can now be
  found at [Home page](https://nmap.org/) . That should save your fingers from a
...
* All of your OS detection fingerprints up until March 10, 2008 have
  ...
  not as many corrections. Please remember to visit[https://nmap.org/submit/](https://nmap.org/submit/) if Nmap gives you bad results, whether they
...
* All of your service fingerprints and corrections submitted until
  ...
  documented his adventures at [http://hcsw.org/blog.pl/33](http://hcsw.org/blog.pl/33) . More than
  ...
  detection too -- visit [https://nmap.org/submit/](https://nmap.org/submit/) if you get incorrect results.
...
* Added NSE HTTP library which allows scripts to easily fetch URLs
  with http.get\_url() or create more complex requests with
...
* A new NSE table library ([tab.lua](https://nmap.org/nsedoc/lib/tab.html)) allows scripts to deliver better
...
* Added the UDP Scan (-sU) and IPProto Ping (-PO) to Zenmap's Profile
...
* Add "Connection: Close" header to requests from HTTP NSE scripts so
  that they finish faster. [Sven Klemm]
* Update SSLv2-support NSE script to run against more services which
...
* Updated to latest (as of 3/15) autoconf config.sub/config.guess
  files from [http://cvs.savannah.gnu.org/viewvc/config/?root=config](http://cvs.savannah.gnu.org/viewvc/config/?root=config).
  [Fyodor]
...
* Fixed a man page bug related to our DocBook to Nroff translation
...
* Updated IANA assignment IP list for random IP (-iR)
  generation. [Kris]
* The DocBook XML source code to the Nmap Scripting Engine docs
  ([https://nmap.org/book/nse.html](https://nmap.org/book/nse.html)) is now in SVN under docs/scripting.xml .
...
* Fix a problem which prevented proper port number matching in
  NSE scripts (port\_or\_service function) due to a variable
  shadowing bug. [Sven Klemm]
* Improved [rpcinfo](https://nmap.org/nsedoc/scripts/rpcinfo.html).nse to better sort and display available RPC
  services. [Sven Klemm]
...
* Updated [rpcinfo](https://nmap.org/nsedoc/scripts/rpcinfo.html).nse to use nmap.fetchfile() to read from nmap-rpc
...
### Nmap 4.51BETA [2007-12-21] [§](https://nmap.org/changelog.html#4.51BETA) ###

* David wrote a detailed Zenmap guide: [https://nmap.org/book/zenmap.html](https://nmap.org/book/zenmap.html)
* Added [rpcinfo](https://nmap.org/nsedoc/scripts/rpcinfo.html).nse script, which contacts a listening RPC portmapper
  and reports the listening services and port information (like[rpcinfo](https://nmap.org/nsedoc/scripts/rpcinfo.html) -p does). The script was written by Sven Klemm. Fyodor
...
* Zenmap's new web page ([https://nmap.org/zenmap/](https://nmap.org/zenmap/)) is now shown in the
  Zenmap about dialogue.
* On Windows, paths beginning with \\ are now considered absolute when
  used with the --script option. jah (jah(a)zadkiel.plus.com) suggested
  this. [David]
* Zenmap no longer double-spaces its output (by inadvertently
...
* Fixed Zenmap crash that occurred when selecting Help from the Compare
  Results window. [Kris]
* Updated robots.nse to prevent printing robots.txt comments. [Kris]
* Many version detection match lines were improved to match even when
  newlines appear in binary data returned by the service. [Fixed by
  Doug, suggested by Lionel Cons]

### Nmap 4.50 [2007-12-13] [§](https://nmap.org/changelog.html#4.50) ###

* Bumped up the version number to the big 10th anniversary 4.50
  release! See [http://insecure.org/stf/Nmap-4.50-Release.html](http://insecure.org/stf/Nmap-4.50-Release.html) .

### Nmap 4.49RC7 [2007-12-10] [§](https://nmap.org/changelog.html#4.49RC7) ###
...
### Nmap 4.49RC6 [2007-12-8] [§](https://nmap.org/changelog.html#4.49RC6) ###

* NSE scripts can now be specified by absolute path to the --script
  option. This was supposed to work before, but didn't. [David]
* Insert a path separator in returned paths in init\_scandir on
...
* Nsock msevent\_new and msevent\_delete calls fixed to handle NULL I/O
...
### Nmap 4.49RC5 [2007-12-8] [§](https://nmap.org/changelog.html#4.49RC5) ###
...
### Nmap 4.49RC4 [2007-12-7] [§](https://nmap.org/changelog.html#4.49RC4) ###
...
* Doug integrated all of your version detection fingerprints and
  ...
  and nntp (44).
* Included the netbios-[smb-os-discovery](https://nmap.org/nsedoc/scripts/smb-os-discovery.html).nse script which uses NetBIOS
...
* Canonicalized the interface type numbers used internally by
  ...
  INTF\_TYPE\_IEEE80211 as Ethernet devices. This ought to make
  wireless network scanning work on Windows Vista. For more background
  see [http://seclists.org/nmap-dev/2007/q4/0391.html](http://seclists.org/nmap-dev/2007/q4/0391.html) . [David]
...
* Fixed a crash which occurred when an NSE script called
  set\_port\_version() at times that version scanning was not
  enabled. [Diman]
...
### Nmap 4.23RC3 [2007-11-27] [§](https://nmap.org/changelog.html#4.23RC3) ###
...
* Nmap can now handle IP aliases on Windows. A given device such as
  ...
  one. [David]
* An exception (rather than luaL\_argerror) is now thrown when an SSL
  connection is attempted but OpenSSL isn't available. [David]
* There is now an nmap.have\_ssl NSE function so you can avoid doing
...
* configure.ac now uses literal directory names rather than variable
  references in calls to AC\_CONFIG\_SUBDIRS. This removes an annoying
...
### Nmap 4.23RC2 [2007-11-18] [§](https://nmap.org/changelog.html#4.23RC2) ###
...
* We no longer strip the Nmap binary before installing it, as that was
  ...
  Symbol not found: \_luaL\_openlib". Unfortunately, the unstripped
...
* Regenerate configure scripts with Autoconf 2.61 and update
  config.guess and config.sub files with the latest versions from[http://cvs.savannah.gnu.org/viewvc/config/?root=config](http://cvs.savannah.gnu.org/viewvc/config/?root=config) . [David]

### Nmap 4.23RC1 [2007-11-10] [§](https://nmap.org/changelog.html#4.23RC1) ###
...
* Zenmap is now available packaged in RPM format. Since Zenmap is
  written in Python, we no longer have to have separate x86 and x86\_64
...
* Updated IANA assignment IP list for random IP (-iR)
  generation. [Kris]
* Fixed a number of spelling errors in the Reference Guide (man page)
  [Doug]

### Nmap 4.22SOC8 [2007-10-28] [§](https://nmap.org/changelog.html#4.22SOC8) ###

* Removed the old massping() system, since the functionality has now
  been migrated into the existing ultra\_scan() system (which is used
...
* Integrated all of your Q3 service detection submissions! We have
  ...
  are at [http://hcsw.org/blog.pl/31](http://hcsw.org/blog.pl/31) .
...
* Change PCRE from an NSELib module back to statically linked code due
  to OpenBSD compilation problems. See[http://seclists.org/nmap-dev/2007/q4/0085.html](http://seclists.org/nmap-dev/2007/q4/0085.html) [David]
...
### Nmap 4.22SOC7 [2007-10-11] [§](https://nmap.org/changelog.html#4.22SOC7) ###
...
* UMIT no longer crashes just because documentation files are
  missing. [Adriano]
* Removed unnecessary recent\_scans.txt and target\_list.txt files from
...
* UMIT now sorts port numbers numerically rather than alphabetically
  [Adriano]
* Three UMIT data files (options.xml, profile\_editor.xml, and
...
* Disabled auto-generation of libpcre/pcre\_chartables.c because that
  was useless for our purposes and could also cause some version
  control related problems. [David]
* Updated IANA assignment IP list for random IP (-iR)
  generation. [Kris]

### Nmap 4.22SOC6 [2007-8-29] [§](https://nmap.org/changelog.html#4.22SOC6) ###
...
* Included David's major massping migration project. The same
  ...
  and report your results to nmap-dev! For more details, see[http://seclists.org/nmap-dev/2007/q3/0277.html](http://seclists.org/nmap-dev/2007/q3/0277.html)
...
* Fixed an error related to version scans against SSL services on
  UNIX. The error said "nsock\_connect\_ssl called - but nsock was
  built w/o SSL support. QUITTING". Thanks to Jasey DePriest for
  tracking down the problem and David Fifield for fixing it.
* Removed win\_dependencies cruft from UMIT directory. [Kris]
...
* Fixed (I hope) a problem with running Nmap on Mac OS X machines with
  ...
  devices ...." For more details, see[http://seclists.org/nmap-dev/2007/q3/0254.html](http://seclists.org/nmap-dev/2007/q3/0254.html) .
...
* Fixed (we hope) a UMIT problem which resulted in the error message:
  "NameError: global name 'S\_IRUSR' is not defined". [Adriano]
...
### Nmap 4.22SOC5 [2007-8-18] [§](https://nmap.org/changelog.html#4.22SOC5) ###
...
### Nmap 4.22SOC3 [2007-8-16] [§](https://nmap.org/changelog.html#4.22SOC3) ###
...
* All of your 2nd Quarter 2007 Nmap version detection fingerprints
  ...
  services found) in his integration report at[http://hcsw.org/blog.pl/29](http://hcsw.org/blog.pl/29) .
...
* Many hard coded function names and instances of \_\_FUNCTION\_\_ were
  changed to \_\_func\_\_ [Kris]
...
### Nmap 4.22SOC2 [2007-7-11] [§](https://nmap.org/changelog.html#4.22SOC2) ###

* NSE compilation fixes by Stoiko and Kris

### Nmap 4.22SOC1 [2007-7-8] [§](https://nmap.org/changelog.html#4.22SOC1) ###
...
* Added more Nmap Scripting Engine scripts, bringing the total to 31.
  ...
  DePriest), iax2Detect (Jasey), [nbstat](https://nmap.org/nsedoc/scripts/nbstat.html) (Brandon Enright),
  SNMPsysdescr (Thomas Buchanan), HTTPAuth (Thomas), [finger](https://nmap.org/nsedoc/scripts/finger.html) (Eddie),
...
* Integrated version detection submissions. The database has grown by
  ...
  credit for the integration marathon, which he describes at[http://hcsw.org/blog.pl](http://hcsw.org/blog.pl) .
...
### Nmap 4.21ALPHA4 [2007-3-20] [§](https://nmap.org/changelog.html#4.21ALPHA4) ###
...
* Fixed XML output so that the opening \<os\> tag is printed again. The
...
### Nmap 4.21ALPHA3 [2007-3-16] [§](https://nmap.org/changelog.html#4.21ALPHA3) ###

* Just fixed a packaging problem with the 4.21ALPHA2 release (thanks
  to Alan Jones for reporting it).

### Nmap 4.21ALPHA2 [2007-3-15] [§](https://nmap.org/changelog.html#4.21ALPHA2) ###
...
* Integrated all of your Q32006 service fingerprint submissions. The
  ...
  changes are described at [http://hcsw.org/blog.pl?a=20&b=20](http://hcsw.org/blog.pl?a=20&b=20) .
...
* Nmap now has a public Subversion (SVN) source code repository. See
  the announcement at [http://seclists.org/nmap-dev/2006/q4/0253.html](http://seclists.org/nmap-dev/2006/q4/0253.html)and then the updated usage instructions at[http://seclists.org/nmap-dev/2006/q4/0281.html](http://seclists.org/nmap-dev/2006/q4/0281.html) .
...
* Improved the algorithm for classifying the TCP timestamp frequency
  for OS detection. The new algorithm is described at[https://nmap.org/book/osdetect-methods.html#osdetect-ts](https://nmap.org/book/osdetect-methods.html#osdetect-ts) .
...
### Nmap 4.21ALPHA1 [2006-12-10] [§](https://nmap.org/changelog.html#4.21ALPHA1) ###
...
* Integrated the Nmap Scripting Engine (NSE) into mainline Nmap.
  ...
  specific to your environment. The system is documented at[https://nmap.org/book/nse.html](https://nmap.org/book/nse.html) .
* Updated nmap-mac-prefixes to reflect the latest OUI DB from the IEEE
  ([http://standards.ieee.org/regauth/oui/oui.txt](http://standards.ieee.org/regauth/oui/oui.txt)) as of December 7.
...
### Nmap 4.20RC2 [2006-12-2] [§](https://nmap.org/changelog.html#4.20RC2) ###
...
* Fixed (I hope) the "getinterfaces: intf\_loop() failed" error which
  was seen on Windows Vista. The problem was apparently in
  intf-win32.c of libdnet (need to define MIB\_IF\_TYPE\_MAX to
  MAX\_IF\_TYPE rather than 32). Thanks to Dan Griffin
...
### Nmap 4.20RC1 [2006-11-20] [§](https://nmap.org/changelog.html#4.20RC1) ###
...
### Nmap 4.20ALPHA11 [2006-11-2] [§](https://nmap.org/changelog.html#4.20ALPHA11) ###
...
### Nmap 4.20ALPHA10 [2006-10-23] [§](https://nmap.org/changelog.html#4.20ALPHA10) ###
...
### Nmap 4.20ALPHA9 [2006-10-13] [§](https://nmap.org/changelog.html#4.20ALPHA9) ###
...
### Nmap 4.20ALPHA8 [2006-9-30] [§](https://nmap.org/changelog.html#4.20ALPHA8) ###
...
* Nmap 2nd generation OS detection now has a more sophisticated
  ...
  database (see [https://nmap.org/book/osdetect-guess.html](https://nmap.org/book/osdetect-guess.html) )
...
### Nmap 4.20ALPHA7 [2006-9-12] [§](https://nmap.org/changelog.html#4.20ALPHA7) ###
...
* Updated nmap-mac-prefixes to reflect the latest OUI DB from the IEEE
  ([http://standards.ieee.org/regauth/oui/oui.txt](http://standards.ieee.org/regauth/oui/oui.txt)) as of September 6, 2006.
...
### Nmap 4.20ALPHA6 [2006-9-2] [§](https://nmap.org/changelog.html#4.20ALPHA6) ###
...
### Nmap 4.20ALPHA5 [2006-8-31] [§](https://nmap.org/changelog.html#4.20ALPHA5) ###
...
* Worked with Zhao to improve the new OS detection system with
  ...
  extremely small. The new system is extensively documented at[https://nmap.org/book/osdetect.html](https://nmap.org/book/osdetect.html) .
* Nmap now supports IP options with the new --ip-options flag. You
  ...
  information and examples, see [https://nmap.org/book/man.html](https://nmap.org/book/man.html) and[http://seclists.org/nmap-dev/2006/q3/0052.html](http://seclists.org/nmap-dev/2006/q3/0052.html) . Thanks to Marek
...
* Nmap now uses the (relatively) new libpcap pcap\_get\_selectable\_fd
...
* Updated the included libpcap from 0.9.3 to 0.9.4. The changes I
  made are in libpcap/NMAP\_MODIFICATIONS . By default, Nmap will now
...
* Fixed a bug which would occasionally cause Nmap to crash with the
  message "log\_vwrite: write buffer not large enough". I thought I
...
### Nmap 4.20ALPHA4 [2006-7-4] [§](https://nmap.org/changelog.html#4.20ALPHA4) ###
...
* Nmap now provides progress statistics in the XML output in verbose
  ...
  until completion) and times are in UNIX time\_t (seconds since 1970) format.
...
### Nmap 4.20ALPHA3 [2006-6-29] [§](https://nmap.org/changelog.html#4.20ALPHA3) ###
...
### Nmap 4.20ALPHA2 [2006-6-24] [§](https://nmap.org/changelog.html#4.20ALPHA2) ###
...
### Nmap 4.20ALPHA1 [2006-6-24] [§](https://nmap.org/changelog.html#4.20ALPHA1) ###

* Integrated initial 2nd generation OS detection patch! The system is
  documented at [https://nmap.org/book/osdetect.html](https://nmap.org/book/osdetect.html) . Thanks to Zhao Lei
...
* Added a dozens of more detailed SSH version detection signatures, thanks
  ...
  results of his large-scale SSH scan are posted at[http://seclists.org/nmap-dev/2006/Apr-Jun/0393.html](http://seclists.org/nmap-dev/2006/Apr-Jun/0393.html) .
...
* Fixed a compilation problem on solaris and possibly other platforms.
  The error message looked like "No rule to make target `inet\_aton.o',
...
* Updated nmap-mac-prefixes to reflect the latest OUI DB from the IEEE
  ([http://standards.ieee.org/regauth/oui/oui.txt](http://standards.ieee.org/regauth/oui/oui.txt)) as of May 31, 2006.
...
* When you do a UDP+TCP scan, the TCP ports are now shown first (in
  ...
  reasons to nmap-dev.
* Changed mass\_dns system to print a warning if it can't find any
  available DNS servers, but not quit like it used to. Thanks to Doug
  Hoyte for the patch.

### Nmap 4.04BETA1 [2006-5-31] [§](https://nmap.org/changelog.html#4.04BETA1) ###
...
* Nmap now ignores certain ICMP error message rate limiting (rather
  ...
  new option at [https://nmap.org/book/man.html](https://nmap.org/book/man.html) . Thanks to Martin
...
* Moved my Nmap development environment to Visual C++ 2005 Express
  ...
  instructions at [https://nmap.org/book/inst-windows.html](https://nmap.org/book/inst-windows.html) have been
  upgraded.
...
* Changed all instances of inet\_aton() into calls to inet\_pton()
  instead. This allowed us to remove inet\_aton.c from nbase. Thanks to
...
* The write buffer length increased in 4.03 was increased even further
  ...
  "log\_vwrite: write buffer not large enough -- need to increase"
...
* Increased a write buffer length to keep Nmap from quitting with the
  message "log\_vwrite: write buffer not large enough -- need to
  increase". Thanks to Dave (dmarcher(a)pobox.com) for reporting the
  issue.

### Nmap 4.02ALPHA2 [2006-3-8] [§](https://nmap.org/changelog.html#4.02ALPHA2) ###
...
* Changed Nmap to cache interface information rather than opening and
  closing it (with dnet's eth\_open and eth\_close functions) all the
  time.
...
### Nmap 4.02ALPHA1 [2006-3-13] [§](https://nmap.org/changelog.html#4.02ALPHA1) ###
...
* Fixed --system-dns option so that --system\_dns works too. Error
...
* Fixed a minor bug in an error message starting with "eth\_send of ARP
...
* See the announcement at[http://www.insecure.org/stf/Nmap-4.00-Release.html](http://www.insecure.org/stf/Nmap-4.00-Release.html) for high-level
  changes since 3.50.
...
* Updated nmap-protocols with the latest IEEE internet protocols
  assignments ([http://www.iana.org/assignments/protocol-numbers](http://www.iana.org/assignments/protocol-numbers)).
...
* Fixed a backward compatibility bug in which Nmap didn't recognize
  the --min\_rtt\_timeout option (it only recognized the newly
...
### Nmap 3.98BETA1 [2006-1-22] [§](https://nmap.org/changelog.html#3.98BETA1) ###

* Added run time interaction as documented at[https://nmap.org/book/man-runtime-interaction.html](https://nmap.org/book/man-runtime-interaction.html) .
...
* Reverse DNS resolution is now done in parallel rather than one at a
  ...
  --system\_dns option was added so you can use the (slow) system
  ...
  the new --dns\_servers option. Otherwise, Nmap looks in
...
* Added the --badsum option, which causes Nmap to use invalid TCP or
  ...
  verify the checksum. For more details on this technique, see[http://www.phrack.org/phrack/60/p60-0x0c.txt](http://www.phrack.org/phrack/60/p60-0x0c.txt) . The author of that
...
* The 26 Nmap commands that previously included an underscore
  (--max\_rtt\_timeout, --send\_eth, --host\_timeout, etc.) have been
...
* Changed the way the \_\_attribute\_\_ compiler extension is detected so
  ...
  to `\_\_gthrw\_pthread\_cancel(unsigned long)"
* Added some exception handling code to mswin32/winfix.cc to prevent
  ...
  (\_\_try/\_\_except(), everything worked fine. Shrug.
...
### Nmap 3.96BETA1 [2005-12-29] [§](https://nmap.org/changelog.html#3.96BETA1) ###

* Added --max\_retries option for capping the maximum number of
...
* Many of the Nmap low-level timing options take a value in
  ...
  45 minute host timeout with --host\_timeout 45m rather than specifying
  --host\_timeout 2700000 and hoping you did the math right and have the
  correct number of zeros. This also now works for the
  --min\_rtt\_timeout, --max\_rtt\_timeout, --initial\_rtt\_timeout,
  --scan\_delay, and --max\_scan\_delay options.
...
* Tried to update to the latest autoconf only to find that there
  ...
  find new config.sub and config.guess files at[http://cvs.savannah.gnu.org/viewcvs/config/config/](http://cvs.savannah.gnu.org/viewcvs/config/config/) , so I updated to
  those.
* Fixed a problem with the -e option when run on Windows (or UNIX with
  --send\_eth) when run on an ethernet network against an external
...
* Made some changes to allow source port zero scans (-g0). Nmap used
  ...
  to Bill Dale (bill\_dale(a)bellsouth.net) for suggesting this feature.
...
* Ceased including foreign translations in the Nmap tarball as they
  take up too much space. HTML versions can be found at[https://nmap.org/docs.html](https://nmap.org/docs.html) , while XML and NROFF versions
  are available from [https://svn.nmap.org/nmap/docs/man-xlate/](https://svn.nmap.org/nmap/docs/man-xlate/) .
* Changed INSTALL and README-WIN32 files to mostly just reference the
  new Nmap Install Guide at [https://nmap.org/book/install.html](https://nmap.org/book/install.html) .
...
* Fixed Nmap so it doesn't crash when you ask it to resume a previous
  ...
  to Piotr Sobolewski (piotr\_sobolewski(a)o2.pl) for the fix.
...
* Fixed an inefficiency in RPC scan that could slow things down and
  ...
  find listening socket in get\_rpc\_results"
...
### Nmap 3.94ALPHA3 [2005-12-6] [§](https://nmap.org/changelog.html#3.94ALPHA3) ###
...
* Fixed a compilation problem on Mac OS X and perhaps other platforms
  with a one-line fix to scan\_engine.cc. Thanks to Felix Gröbert
...
* Define INET\_ADDRSTRLEN in tcpip.h if the system doesn't define it
...
### Nmap 3.94ALPHA2 [2005-12-4] [§](https://nmap.org/changelog.html#3.94ALPHA2) ###

* Put Nmap on a diet, with changes to the core port scanning routine
  (ultra\_scan) to substantially reduce memory consumption, particularly
...
* Applied some small fixes so that Nmap compiles with Visual C++
  2005 Express, which is free from Microsoft at[http://msdn.microsoft.com/vstudio/express/visualc/](http://msdn.microsoft.com/vstudio/express/visualc/) . Thanks to KX
...
* Removed foreign translations of the old man page from the
  ...
  * Portuguese (Portugal) by José Domingos (jd\_pt(a)yahoo.com) and
...
### Nmap 3.94ALPHA1 [2005-11-27] [§](https://nmap.org/changelog.html#3.94ALPHA1) ###
...
* Wrote a new man page from scratch. It is much more comprehensive
  ...
  previous one. Read it online at [https://nmap.org/book/man.html](https://nmap.org/book/man.html)or docs/nmap.1 from the Nmap distribution. Let me know if you have
  any ideas for improving it.
* Wrote a new "help screen", which you get when running Nmap without
  arguments. It is also reproduced in the man page and at[https://svn.nmap.org/nmap/docs/nmap.usage.txt](https://svn.nmap.org/nmap/docs/nmap.usage.txt) . I gave up trying
...
* Added the --webxml option, which does the same thing as
  --stylesheet [https://svn.nmap.org/nmap/docs/nmap.xsl](https://svn.nmap.org/nmap/docs/nmap.xsl) , without
...
* Fixed a crash which could occur when a ridiculously short
  --host\_timeout was specified on Windows (or on UNIX if --send\_eth was
  specified). Nmap now also prints a warning if you specify a
  host\_timeout of less than 1 second. Thanks to Ole Morten Grodaas
...
* Fixed a crash on Windows when you -P0 scan an unused IP on a local
  ...
  happen on UNIX if you specified the new --send\_eth option. Thanks
...
* Updated the included libpcap from 0.8.3 to 0.9.3. I also changed
  ...
  NMAP\_MODIFICATIONS in that directory.
...
* Added the ability for Nmap to send and properly route raw ethernet
  ...
  platform, though you can override it with the new --send\_eth and
  --send\_ip options.
* Added ARP scanning (-PR). Nmap can now send raw ethernet ARP requests to
  ...
  unless --send\_ip was specified. Example usage: nmap -sP -PR
  192.168.0.0/16 .
* Added the --spoof\_mac option, which asks Nmap to use the given MAC
  ...
  remaining 3 bytes randomly. Valid --spoof\_mac argument examples are
...
* Nmap on Windows now compiles/links with the new WinPcap 3.1
  header/lib files. So please upgrade to 3.1 from[http://www.winpcap.org](http://www.winpcap.org/) before installing this version of Nmap.
...
* The official Nmap RPM files are now compiled statically for better
  compatibility with other systems. X86\_64 (AMD Athlon64/Opteron)
...
* Nmap distribution signing has changed. Release files are now signed
  ...
  at [https://svn.nmap.org/nmap/docs/nmap\_gpgkeys.txt](https://svn.nmap.org/nmap/docs/nmap_gpgkeys.txt) , as
  docs/nmap\_gpgkeys.txt in the Nmap source tarball, and on the public
...
* Added "rarity" feature to Nmap version detection. This causes
  ...
  --version\_intensity option. Alternatively, you can just use
  --version\_light or --version\_all which set the intensity to 2 (only
  try the most important probes and ones registered to the port
  number) and 9 (try all probes), respectively. --version\_light is
...
* Fixed an Nmap version detection crash on Windows which led to the
  error message "Unexpected error in NSE\_TYPE\_READ callback. Error
...
* Changed the --no-stylesheet option to --no\_stylesheet to be
...
* Added a stripped-down and heavily modified version of Dug Song's
  ...
  libdnet-stripped/NMAP\_MODIFICATIONS
* Removed WinIP library (and all Windows raw sockets code) since MS
  ...
  Windows-specific --win\_help, --win\_list\_interfaces, --win\_norawsock,
  --win\_forcerawsock, --win\_nopcap, --win\_nt4route, --win\_noiphlpapi,
  and --win\_trace options have been removed.
...
* Added new --privileged command-line option and NMAP\_PRIVILEGED
...
* ultra\_scan() now sets pseudo-random ACK values (rather than 0) for
...
* Nmap now ships with and installs (in the same directory as other
  ...
  Benjamin Erb ( see [http://www.benjamin-erb.de/nmap/](http://www.benjamin-erb.de/nmap/) for examples).
  ...
  rendering, specify --stylesheet [https://svn.nmap.org/nmap/docs/nmap.xsl](https://svn.nmap.org/nmap/docs/nmap.xsl) .
...
* Fixed (I hope) an error which would cause the Windows version of
  ...
  "Unexpected error in NSE\_TYPE\_READ callback. Error code: 10053
...
* Changed IP protocol scan (-sO) so that it sends valid ICMP, TCP, and
  ...
  prevent the error messages such as "sendto in send\_ip\_packet:
...
* The XML nmaprun element now has a startstr attribute which gives the
  ...
  in UNIX time\_t notation. This should help in development of
...
* Fixed a memory leak that would generally consume several hundred
  ...
  to Valgrind ( [http://valgrind.kde.org](http://valgrind.kde.org/) ) for making it easy to debug.
...
* Applied Martin Macok's (martin.macok(a)underground.cz) "cosmetics
...
* Fixed Windows service scan crashes that occur with the error message
  "Unexpected nsock\_loop error. Error code 10022 (Unknown error)". It
...
* Added --max\_scan\_delay parameter. Nmap will sometimes increase the
...
* Fixed a bug that prevented RPC scan (-sR) from working for UDP ports
  ...
  sending a patch.
* Fixed nmap\_fetchfile() to better find custom versions of data files
...
* Changed XML output so that the MAC address \<address\> element comes
  ...
  needed to comply with the DTD ( [https://svn.nmap.org/nmap/docs/nmap.dtd](https://svn.nmap.org/nmap/docs/nmap.dtd) ).
...
* Fixed a timing problem in which a specified large --send\_delay would
...
* Fixed a bug in the build system that caused most Nmap subdirectories
  ...
  subdirs from $subdirs to $nmap\_cfg\_subdirs resolved the problem --
...
* Made a trivial change to nsock/src/nsock\_event.c to work around a "a
...
* Fixed ping scan subsystem to work a little bit better when
  --scan\_delay (or some of the slower -T templates which include a scan
...
* Rewrote core port scanning engine, which is now named ultra\_scan().
  ...
  ultra\_scan() can scan many hosts (sometimes hundreds) in parallel.
  ...
  cases where ultra\_scan is slower or less accurate, please send a
  report (including exact command-lines, versions used, and output, if
  possible) to Fyodor.
* Added --max\_hostgroup option which specifies the maximum number of
  hosts that Nmap is allowed to scan in parallel.
* Added --min\_hostgroup option which specifies the minimum number of
...
* Rewrote TCP SYN, ACK, Window, and Connect() scans to use
  ultra\_scan() framework, rather than the old pos\_scan().
* Rewrote FIN, Xmas, NULL, Maimon, UDP, and IP Protocol scans to use
  ultra\_scan(), rather than the old super\_scan().
...
* Nmap now estimates completion times for almost all port scan types
  (any that use ultra\_scan()) as well as service scan (version
...
* Host timeout system (--host\_timeout) overhauled to support host
...
* Removed Ident scan (-I). It was rarely useful, and the
  implementation would have to be rewritten for the new ultra\_scan()
  system. If there is significant demand, perhaps I'll put it back in
  sometime.
* Documented the --osscan\_limit option, which saves time by skipping
...
* Fixed various crashes and assertion failures related to the new
  ultra\_scan() system, that were found by Arturo "Buanzo" Busleiman
...
* Fixed some minor memory leaks relating to ping and list scanning as
  well as the Nmap output table. These were found with Valgrind ([http://valgrind.kde.org/](http://valgrind.kde.org/) ).
* Provide limited --packet\_trace support for TCP connect() (-sT)
  scans.
...
* Normalized many of the OS names in nmap-os-fingerprints (fixed
  ...
  sending patches.
* Modified the mswine32/nmap\_performance.reg Windows registry file to
  ...
  now available in the data directory at[https://svn.nmap.org/nmap/docs/nmap\_performance.reg](https://svn.nmap.org/nmap/docs/nmap_performance.reg)
...
* Fixed a ping scanning bug that would cause this error message: "nmap:
  ...
  timeout\_info \*, timeval \*, timeval \*, pingtune \*, tcpqueryinfo \*,
  pingstyle): Assertion `pt-\>down\_this\_block \> 0' failed." Thanks to
...
* Applied a couple patches (with minor changes) from Oliver Eikemeier
  ...
  returned by the FreeBSD firewall system. The patches are from[http://cvsweb.freebsd.org/ports/security/nmap/files/](http://cvsweb.freebsd.org/ports/security/nmap/files/) .
...
* Removed the notice that Nmap is reading target specifications from a
  ...
  (ath(a)algonet.se).
* Added --source\_port as a longer, but hopefully easier to remember,
...
* Modified the configure/build system to fix library ordering problems
  ...
  (saravanan\_kovai(a)HotPop.com) for the suggestions.
...
* Removed unnecessary [banner](https://nmap.org/nsedoc/scripts/banner.html) printing in the non-root connect() ping
...
* Applied patch from Rob Foehl (rwf(a)loonybin.net) which fixes the
  --with\_openssl=DIR configure argument.
...
* Added SUBST() helper function, which replaces strings in matched
  ...
  VanDyke Vshell gives a [banner](https://nmap.org/nsedoc/scripts/banner.html) that includes
  "SSH-2\\.0-VShell\_2\_2\_0\_528". A substring match is used to pick out
  the string "2\_2\_0\_528", and then SUB21ST(1,"\_",".") is called on that
...
* If responses to a probe fail to match any of the registered match
  ...
  initially times out (perhaps because of initial DNS lookup) but the[banner](https://nmap.org/nsedoc/scripts/banner.html) appears in later responses.
...
* Fixed the problem several people reported where Nmap would quit with
  ...
  message was "Unexpected error in NSE\_TYPE\_READ callback. Error
  code: 32 (Broken pipe)"
...
* Applied some patches from the NetBSD ports tree that Hubert Feyrer
  ...
  Nmap ports page is at [http://www.NetBSD.org/packages/net/nmap/](http://www.netbsd.org/packages/net/nmap/) .
* Applied some Makefile patches from the FreeBSD ports tree that I
  found at [http://www.freebsd.org/cgi/cvsweb.cgi/ports/security/nmap/files/](http://www.freebsd.org/cgi/cvsweb.cgi/ports/security/nmap/files/)
...
* Integrated more service signatures from MadHat
  ...
  (netw3\_security(a)hushmail.com). We now have 378 signatures
...
### Nmap 3.40PVT17 [2003-9-12] [§](https://nmap.org/changelog.html#3.40PVT17) ###

* Wrote and posted a new paper on version scanning to[https://nmap.org/book/vscan.html](https://nmap.org/book/vscan.html) . Updated nmap-service-probes and
...
* Applied a patch from Dmitry V. Levin (ldv(a)altlinux.org) which
  ...
  them out at [http://www.openwall.com/Owl/](http://www.openwall.com/Owl/) and[http://www.altlinux.com/](http://www.altlinux.com/)
...
* Added a new --version\_trace option which causes Nmap to print out extensive
  debugging info about what version scanning is doing (this is a subset
  of what you would get with --packet\_trace). You should usually use
...
### Nmap 3.40PVT16 [2003-9-6] [§](https://nmap.org/changelog.html#3.40PVT16) ###
...
### Nmap 3.40PVT15 [2003-9-5] [§](https://nmap.org/changelog.html#3.40PVT15) ###
...
* Fixed a compilation bug found by Solar Designer on machines that
  don't have struct sockaddr\_storage. Nsock now just uses "struct
...
* Changed a bunch of large stack arrays (e.g. int portlookup[65536])
  ...
  reported by osamah abuoun (osamah\_abuoun(a)hotmail.com).

### Nmap 3.40PVT14 [2003-9-4] [§](https://nmap.org/changelog.html#3.40PVT14) ###
...
### Nmap 3.40PVT13 [2003-9-1] [§](https://nmap.org/changelog.html#3.40PVT13) ###
...
* Added SSL-scan-through support. If service detection finds a port to be
  ...
  0.9.7-beta2 contained serious vulnerabilities described at[http://www.openssl.org/news/secadv\_20020730.txt](http://www.openssl.org/news/secadv_20020730.txt) . Note that these
...
### Nmap 3.40PVT12 [2003-8-24] [§](https://nmap.org/changelog.html#3.40PVT12) ###
...
### Nmap 3.40PVT11 [2003-8-23] [§](https://nmap.org/changelog.html#3.40PVT11) ###
...
### Nmap 3.40PVT10 [2003-8-18] [§](https://nmap.org/changelog.html#3.40PVT10) ###
...
* Removed the SERVICEMATCH\_STATIC match type from
...
### Nmap 3.40PVT9 [2003-8-16] [§](https://nmap.org/changelog.html#3.40PVT9) ###
...
### Nmap 3.40PVT8 [2003-8-12] [§](https://nmap.org/changelog.html#3.40PVT8) ###
...
### Nmap 3.40PVT7 [2003-8-10] [§](https://nmap.org/changelog.html#3.40PVT7) ###
...
### Nmap 3.40PVT6 [2003-8-8] [§](https://nmap.org/changelog.html#3.40PVT6) ###

* Banner-scanned hundreds of thousands of machines for ports
  21,23,25,110,3306 to collect default banners. Where the [banner](https://nmap.org/nsedoc/scripts/banner.html) made
  the service name/version obvious, I integrated them into
  nmap-service-probes. This increased the number of 'match' lines from
  27 to more than 100.
* Created the service fingerprint submission page at[http://www.insecure.org/cgi-bin/servicefp-submit.cgi](http://www.insecure.org/cgi-bin/servicefp-submit.cgi)
...
### Nmap 3.40PVT4 [2003-7-28] [§](https://nmap.org/changelog.html#3.40PVT4) ###
...
* Fixed a segmentation fault that could occur when ping-scanning large
  networks.
* Fixed service scan to gracefully handle host\_timeout occurrences when
  they happen during a service scan.
* Fixed a service\_scan bug that would cause an error when hosts send
...
### Nmap 3.40PVT3 [2003-7-28] [§](https://nmap.org/changelog.html#3.40PVT3) ###
...
* Fixed a bug that would cause Nmap to quit with an Nsock error when
  --host\_timeout was used (or when -T5 was used, which sets it
  implicitly).
...
### Nmap 3.40PVT2 [2003-7-26] [§](https://nmap.org/changelog.html#3.40PVT2) ###
...
### Nmap 3.40PVT1 [2003-7-17] [§](https://nmap.org/changelog.html#3.40PVT1) ###
...
* Nmap now uses the excellent libpcre (Perl Compatible Regular
  Expressions) library from [http://www.pcre.org/](http://www.pcre.org/) . Many systems
...
* Nmap will now sometimes guess in the "no exact matches" case, even
  if you don't use the secret --osscan\_guess or -fuzzy options.
...
* Fixed (I hope) an issue that would cause Nmap to print "Serious time
  computation problem in adjust\_timeout ..." and quit. The ultimate
  cause was demonstrated by this --packet\_trace snippet that Russel
...
* Fixed (I hope) a problem that led to the error message "Assertion
  `tqi-\>sockets[probe\_port\_num][seq] == -1' failed".
...
* Applied some changes from Solar Designer (solar(a)openwall.com)
  ...
  ([http://www.openwall.com/Owl/](http://www.openwall.com/Owl/))
* For Solaris, I now define NET\_SIZE\_T to size\_t rather than socklen\_t
...
* Fixed a problem with small --max\_parallelism values when non-root ping
...
* Changed many single-quotes (') into double quotes (") in the man
  ...
  (\\') in nroff.
* Included --packet\_trace support for Explicit Congestion Notification
  (RFC 2481/3168) flags thanks to a patch sent in by Maik Pfeil
  (root(a)bundesspionageministerium.de)
* Included --packet\_trace support for a few (unusual) ICMP types in
...
* Applied patch from Marius Strobl (marius(a)alchemy.franken.de) which improves
  the definition of NET\_SIZE\_T on FreeBSD so that it compiles on
  64-bit platforms.
...
* Fixed (I hope) problem where Nmap would abort, complaining that
  "Assertion `pt-\>down\_this\_block \> 0' failed". Thanks to
...
* Fixed an "assertion failure" which would cause Nmap to exit when you
  specify a --max\_rtt\_timeout below 3000. Thanks to Tammy Rathbun
...
* Added --packet\_trace support to Windows
...
### Nmap 3.15BETA3 [2003-3-16] [§](https://nmap.org/changelog.html#3.15BETA3) ###
...
* Nmap now comes by default in .tar.bz2 format, which compresses about
  20% further. You can still find .tgz in the dist directory at[http://download.insecure.org/nmap/dist/?M=D](http://download.insecure.org/nmap/dist/?M=D) .
* Various other minor bug fixes, new services, fingerprints, etc.

### Nmap 3.15BETA2 [2003-2-26] [§](https://nmap.org/changelog.html#3.15BETA2) ###
...
* Applied patch by Gabriel L. Somlo ( somlo(a)acns.colostate.edu ) which
...
* Fixed Windows (VC++ 6) compilation, thanks to patches from Kevin
...
### Nmap 3.15BETA1 [2003-2-19] [§](https://nmap.org/changelog.html#3.15BETA1) ###
...
### Nmap 3.10ALPHA9 [2002-12-25] [§](https://nmap.org/changelog.html#3.10ALPHA9) ###
...
* Fixed a libpcap compilation issue noted by Josef 'Jupp' Schugt
  ...
  lack thereof) of ARPHRD\_HDLC (used for Cisco HDLC frames).
* Tweaked the version number (-V) output slightly.

### Nmap 3.10ALPHA7 [2002-12-18] [§](https://nmap.org/changelog.html#3.10ALPHA7) ###

* Upgraded libpcap from version 0.6.2 to 0.7.1. Updated the
  libpcap-possiblymodified/NMAP\_MODIFICATIONS file to give a much
...
* Added a warning that some hosts may be skipped and/or repeated
  when someone tries to --resume a --randomize\_hosts scan. This
...
### Nmap 3.10ALPHA4 [2002-11-11] [§](https://nmap.org/changelog.html#3.10ALPHA4) ###
...
* Added German translation of Nmap man page by Marc Ruef
  (marc.ruef(a)computec.ch). It is also available at[https://nmap.org/man/de/](https://nmap.org/man/de/)
* Includes a brand new French translation of the man page by Sebastien
  Blanchet. You could probably guess that it is available at[https://nmap.org/man/fr/](https://nmap.org/man/fr/)
...
* Fixed a compile problem on machines without PF\_INET6. Thanks to
  Josef 'Jupp' Schugt (deusxmachina(a)webmail.co.za) for noting this.

### Nmap 3.10ALPHA3 [2002-9-15] [§](https://nmap.org/changelog.html#3.10ALPHA3) ###

* Added --min\_parallelism option, which makes scans more aggressive
  and MUCH faster in certain situations -- especially against
  firewalled hosts. It is basically the opposite of --max\_parallelism
  (-M). Note that reliability can be lost if you push it too far.
* Added --packet\_trace option, which tells Nmap to display all of the
...
### Nmap 3.10ALPHA2 [2002-8-31] [§](https://nmap.org/changelog.html#3.10ALPHA2) ###
...
### Nmap 3.10ALPHA1 [2002-8-28] [§](https://nmap.org/changelog.html#3.10ALPHA1) ###
...
* IPv6 is now supported for TCP scan (-sT), connect()-style ping
  ...
  Sebastien Peterson's patch a try at [http://nmap6.sourceforge.net/](http://nmap6.sourceforge.net/) .
...
* Removed arbitrary max\_parallelism (-M) limitations, as suggested by
...
### Nmap 2.99RC2 [2002-07-27] [§](https://nmap.org/changelog.html#2.99RC2) ###
...
### Nmap 2.99RC1 [2002-07-20] [§](https://nmap.org/changelog.html#2.99RC1) ###
...
### Nmap 2.54BETA37 [2002-07-10] [§](https://nmap.org/changelog.html#2.54BETA37) ###
...
* Adjusted random IP generator (for -iR) to account for newly
  allocated ip space from[http://www.iana.org/assignments/ipv4-address-space](http://www.iana.org/assignments/ipv4-address-space) as noted by Chad
...
### Nmap 2.54BETA36 [2002-06-13] [§](https://nmap.org/changelog.html#2.54BETA36) ###
...
### Nmap 2.54BETA35 [2002-06-13] [§](https://nmap.org/changelog.html#2.54BETA35) ###

* Fixed an issue that could cause the abort message "Serious time
  computation problem in adjust\_timeout ...". If you still see this,
  please let me know.
...
### Nmap 2.54BETA34 [2002-05-02] [§](https://nmap.org/changelog.html#2.54BETA34) ###
...
### Nmap 2.54BETA33 [2002-04-26] [§](https://nmap.org/changelog.html#2.54BETA33) ###
...
### Nmap 2.54BETA32 [2002-04-01] [§](https://nmap.org/changelog.html#2.54BETA32) ###
...
### Nmap 2.54BETA31 [2002-03-20] [§](https://nmap.org/changelog.html#2.54BETA31) ###
...
* Documented the --data\_length option and made it work with all the
...
### Nmap 2.54BETA30 [2001-10-14] [§](https://nmap.org/changelog.html#2.54BETA30) ###
...
* Added a Document Type Definition (DTD) for the Nmap XML output
  ...
  Consulting Services ( [http://www.cisco.com/go/securityconsulting](http://www.cisco.com/go/securityconsulting) ).
...
* Documented the --append\_output option which tells Nmap to append
  scan results to any output files you have specified rather than
  overwriting the files.
* Integrate TIMEVAL\_SEC\_SUBTRACT() fix by Scott Renfro (scott(a)renfro.org)
  which improves timing accuracy.

### Nmap 2.54BETA29 [2001-08-10] [§](https://nmap.org/changelog.html#2.54BETA29) ###
...
* Applied patch from Chad Loder (chad\_loder(a)rapid7.com) which improves
...
* Fixed portscan timing bug found by H D Moore (hdm(a)secureaustin.com).
  This bug can occur when you specify a --max\_rtt\_timeout but not
  --initial\_rtt\_timeout and then scan certain firewalled hosts.
* Fixed port number printing bug found by "Stephen Leavitt"
  (stephen\_j\_leavitt(a)hotmail.com)
...
### Nmap 2.54BETA28 [2001-07-28] [§](https://nmap.org/changelog.html#2.54BETA28) ###
...
### Nmap 2.54BETA27 [2001-07-20] [§](https://nmap.org/changelog.html#2.54BETA27) ###
...
### Nmap 2.54BETA26 [2001-07-09] [§](https://nmap.org/changelog.html#2.54BETA26) ###
...
### Nmap 2.54BETA25 [2001-06-04] [§](https://nmap.org/changelog.html#2.54BETA25) ###
...
### Nmap 2.54BETA24 [2001-06-02] [§](https://nmap.org/changelog.html#2.54BETA24) ###
...
* On the suggestion of the ever-helpful LaMont Jones (lamont(a)hp.com),
  I obtained the newest config.guess/config.sub from[http://subversions.gnu.org/cgi-bin/cvsweb/config](http://subversions.gnu.org/cgi-bin/cvsweb/config) and made
...
### Nmap 2.54BETA22 [2001-03-10] [§](https://nmap.org/changelog.html#2.54BETA22) ###

* Eliminated usage of u\_int32\_t (was causing compilation errors on
...
### Nmap 2.54BETA21 [2001-03-09] [§](https://nmap.org/changelog.html#2.54BETA21) ###
...
### Nmap 2.54BETA20 [2001-03-05] [§](https://nmap.org/changelog.html#2.54BETA20) ###
...
### Nmap 2.54BETA19 [2001-01-02] [§](https://nmap.org/changelog.html#2.54BETA19) ###
...
* Applied patch from Andy Lutomirski (Luto(a)mailandnews.com) which
  enhances some of the Win\* error messages and adds the --win\_trace
  debugging option.
* Applied some patches from Jay Freeman (saurik(a)saurik.com)
  * New --data\_length option adds indicated number of random data
...
### Nmap 2.54BETA16 [2000-12-07] [§](https://nmap.org/changelog.html#2.54BETA16) ###
...
* Moved a bunch of the scanning engine related functions to new files
  (scan\_engine.c and scan\_engine.h ). Timing functions were moved to
...
### Nmap 2.54BETA6 [2000-10-08] [§](https://nmap.org/changelog.html#2.54BETA6) ###
...
### Nmap 2.54BETA5 [2000-09-17] [§](https://nmap.org/changelog.html#2.54BETA5) ###
...
### Nmap 2.54BETA4 [2000-09-04] [§](https://nmap.org/changelog.html#2.54BETA4) ###
...
* Upgraded to the very latest Libpcap version ( the 9/3/00 CVS
  ...
  message about Nmap using the obsolete SOCK\_PACKET interface).
...
### Nmap 2.54BETA3 [2000-08-14] [§](https://nmap.org/changelog.html#2.54BETA3) ###
...
### Nmap 2.54BETA2 [2000-08-01] [§](https://nmap.org/changelog.html#2.54BETA2) ###
...
### Nmap 2.54BETA1 [2000-05-29] [§](https://nmap.org/changelog.html#2.54BETA1) ###
...
### Nmap 2.3BETA21 [2000-04-24] [§](https://nmap.org/changelog.html#2.3BETA21) ###
...
* Applied NetBSD compatibility patch provided by Mipam (reinoud at
  ...
  getopt\_long\_only instead of getopt\_long.
...
* Changed all nmapfe calls to gdk\_font\_load into gdk\_fontset\_load .
  Bennett Feitell (bfeitell at panix.com) suggested that this fixed
  some nmapfe font problems.

### Nmap 2.3BETA20 [2000-04-10] [§](https://nmap.org/changelog.html#2.3BETA20) ###
...
* Fixed a compilation problem on machines that do not have MAP\_FAILED
  defined (as a return value to mmap). Problem noted by Phil
  Stracchino (alaric(a)babcom.com).

### Nmap 2.3BETA19 [2000-04-10] [§](https://nmap.org/changelog.html#2.3BETA19) ###
...
* Merged in a patch sent in by Mipam (reinoud(a)ibbnet.org) which is
  ...
  complained of problems. Hopefully this will help (it adds DLT\_LOOP
  and DLT\_ENC offset cases when reading from libpcap).
* A few really minor bugfixes.

### Nmap 2.3BETA18 [2000-04-06] [§](https://nmap.org/changelog.html#2.3BETA18) ###
...
* Changed the NmapFE version to 0.[nmap\_version] rather than always
...
### Nmap 2.3BETA17 [2000-03-26] [§](https://nmap.org/changelog.html#2.3BETA17) ###
...
* Added --resume option to continue a large network scan where you
  ...
  file.
* Added --append\_output option which causes -oN/-oM/-oS to APPEND to
...
### Nmap 2.3BETA14 [2000-01-28] [§](https://nmap.org/changelog.html#2.3BETA14) ###
...
* Fixed integer overflow that was limiting the max --host\_timeout
...
### Nmap 2.3BETA13 [2000-01-17] [§](https://nmap.org/changelog.html#2.3BETA13) ###
...
### Nmap 2.3BETA12 [2000-01-01] [§](https://nmap.org/changelog.html#2.3BETA12) ###
...
* Added --randomize\_hosts option, which causes hosts be be scanned in
...
### Nmap 2.3BETA10 [1999-12-12] [§](https://nmap.org/changelog.html#2.3BETA10) ###
...
### Nmap 2.3BETA9 [1999-12-07] [§](https://nmap.org/changelog.html#2.3BETA9) ###
...
### Nmap 2.3BETA8 [1999-11-21] [§](https://nmap.org/changelog.html#2.3BETA8) ###
...
* Added "firewall mode" timing optimizations which can decrease the
  ...
  filtered hosts.
* Added min\_rtt\_timeout timing option (see man page for details)
...
### Nmap 2.3BETA6 [1999-09-19] [§](https://nmap.org/changelog.html#2.3BETA6) ###
...
* Added various long options people expect to see like --version ,
  ...
  I had to add getopt\_long C files since most non-Linux boxes don't
  support getopt\_long in libc.
* Human readable (-o) output changed to include the time/date of the
  scan. Suggested by van Hauser.

### Nmap 2.3BETA5 [1999-09-07] [§](https://nmap.org/changelog.html#2.3BETA5) ###
...
### Nmap 2.3BETA4 [1999-08-30] [§](https://nmap.org/changelog.html#2.3BETA4) ###
...
* The HTML translation of the Man page at[https://nmap.org/book/man.html](https://nmap.org/book/man.html) should now be
...
### Nmap 2.2-Beta4 [1999-05-07] [§](https://nmap.org/changelog.html#2.2-Beta4) ###
...
### Nmap 2.2-Beta3 [1999-05-02] [§](https://nmap.org/changelog.html#2.2-Beta3) ###
...
### Nmap 2.2-Beta2 [§](https://nmap.org/changelog.html#2.2-Beta2) ###
...
### Nmap 2.2-BETA1 [§](https://nmap.org/changelog.html#2.2-BETA1) ###
...
* Added my nmap-fingerprintinting-article.txt to the distribution in
  the docs directory.
* Fixed problem where nmap -sS (my\_ethernet\_or\_ppp\_ip\_address) would
